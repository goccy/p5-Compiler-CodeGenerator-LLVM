...
entrypoint:
  ...
  store i64 -4222124650659830, i64* %union_to_int_ptr
  %"$a" = alloca %Object
  ...
  store i64 -4222124650659838, i64* %union_to_int_ptr5
  ...
  %binary_op = add i64 %i32_to_i64_cast, %i32_to_i64_cast10
  ...
  %xor15 = xor i64 %load_ivalue14, -2533274790395904
  %int_to_ptr16 = inttoptr i64 %xor15 to %Object*
  %object_body17 = getelementptr inbounds %Object* %int_to_ptr16, i32 0, i32 1
  %load_value18 = load %union.UnionType* %int_ptr
  store %union.UnionType %load_value18, %union.UnionType* %object_body17
  %args = alloca %union.UnionType*
  %load_ivalue19 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor20 = xor i64 %load_ivalue19, -2533274790395904
  %int_to_ptr21 = inttoptr i64 %xor20 to %Object*
  %object_body22 = getelementptr inbounds %Object* %int_to_ptr21, i32 0, i32 1
  %get_idx140 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body22, %union.UnionType** %get_idx140
  %array = alloca %ArrayObject
  %array_type141 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr142 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr142 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %load_ivalue23 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor24 = xor i64 %load_ivalue23, -2533274790395904
  %int_to_ptr25 = inttoptr i64 %xor24 to %Object*
  %object_body26 = getelementptr inbounds %Object* %int_to_ptr25, i32 0, i32 1
  ...
  %union_to_int_ptr29 = bitcast %union.UnionType* %object_body26 to i64*
  ...
  %union_to_int_ptr33 = bitcast %union.UnionType* %ivalue27 to i64*
  %dereference34 = load i64* %union_to_int_ptr33
  %trunc_int_cast35 = trunc i64 %dereference34 to i32
  %i32_to_i64_cast36 = sext i32 %trunc_int_cast35 to i64
  %binary_op37 = sub i64 %i32_to_i64_cast32, %i32_to_i64_cast36
  %int_ptr38 = alloca %union.UnionType
  %and39 = and i64 %binary_op37, 4294967295
  %or40 = or i64 %and39, -4503599627370496
  %or41 = or i64 %or40, 281474976710656
  %union_to_int_ptr42 = bitcast %union.UnionType* %int_ptr38 to i64*
  store i64 %or41, i64* %union_to_int_ptr42
  %load_ivalue43 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  ...
  %load_value47 = load %union.UnionType* %int_ptr38
  store %union.UnionType %load_value47, %union.UnionType* %object_body46
  %args48 = alloca %union.UnionType*
  %load_ivalue49 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor50 = xor i64 %load_ivalue49, -2533274790395904
  %int_to_ptr51 = inttoptr i64 %xor50 to %Object*
  %object_body52 = getelementptr inbounds %Object* %int_to_ptr51, i32 0, i32 1
  %get_idx53143 = bitcast %union.UnionType** %args48 to %union.UnionType**
  store %union.UnionType* %object_body52, %union.UnionType** %get_idx53143
  %array54 = alloca %ArrayObject
  %array_type55144 = bitcast %ArrayObject* %array54 to i32*
  ...
  store i32 3, i32* %array_type55144
  store %union.UnionType** %args48, %union.UnionType*** %array_list56
  ...
  %cast_to_double_ptr60145 = bitcast %union.UnionType* %union_storage59 to double*
  %cast_to_int_ptr61 = bitcast double* %cast_to_double_ptr60145 to i64*
  store i64 %result58, i64* %cast_to_int_ptr61
  %load_ivalue62 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor63 = xor i64 %load_ivalue62, -2533274790395904
  %int_to_ptr64 = inttoptr i64 %xor63 to %Object*
  %object_body65 = getelementptr inbounds %Object* %int_to_ptr64, i32 0, i32 1
  %ivalue66 = alloca %union.UnionType
  %union_to_int_ptr67 = bitcast %union.UnionType* %ivalue66 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr67
  %union_to_int_ptr68 = bitcast %union.UnionType* %object_body65 to i64*
  %dereference69 = load i64* %union_to_int_ptr68
  %trunc_int_cast70 = trunc i64 %dereference69 to i32
  %i32_to_i64_cast71 = sext i32 %trunc_int_cast70 to i64
  %union_to_int_ptr72 = bitcast %union.UnionType* %ivalue66 to i64*
  %dereference73 = load i64* %union_to_int_ptr72
  %trunc_int_cast74 = trunc i64 %dereference73 to i32
  %i32_to_i64_cast75 = sext i32 %trunc_int_cast74 to i64
  %binary_op76 = mul i64 %i32_to_i64_cast71, %i32_to_i64_cast75
  %int_ptr77 = alloca %union.UnionType
  %and78 = and i64 %binary_op76, 4294967295
  %or79 = or i64 %and78, -4503599627370496
  %or80 = or i64 %or79, 281474976710656
  %union_to_int_ptr81 = bitcast %union.UnionType* %int_ptr77 to i64*
  store i64 %or80, i64* %union_to_int_ptr81
  %load_ivalue82 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor83 = xor i64 %load_ivalue82, -2533274790395904
  %int_to_ptr84 = inttoptr i64 %xor83 to %Object*
  %object_body85 = getelementptr inbounds %Object* %int_to_ptr84, i32 0, i32 1
  %load_value86 = load %union.UnionType* %int_ptr77
  store %union.UnionType %load_value86, %union.UnionType* %object_body85
  %args87 = alloca %union.UnionType*
  %load_ivalue88 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor89 = xor i64 %load_ivalue88, -2533274790395904
  %int_to_ptr90 = inttoptr i64 %xor89 to %Object*
  %object_body91 = getelementptr inbounds %Object* %int_to_ptr90, i32 0, i32 1
  %get_idx92146 = bitcast %union.UnionType** %args87 to %union.UnionType**
  store %union.UnionType* %object_body91, %union.UnionType** %get_idx92146
  %array93 = alloca %ArrayObject
  %array_type94147 = bitcast %ArrayObject* %array93 to i32*
  %array_list95 = getelementptr inbounds %ArrayObject* %array93, i32 0, i32 1
  %array_size96 = getelementptr inbounds %ArrayObject* %array93, i32 0, i32 2
  store i32 3, i32* %array_type94147
  store %union.UnionType** %args87, %union.UnionType*** %array_list95
  store i64 1, i64* %array_size96
  %result97 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array93)
  %union_storage98 = alloca %union.UnionType
  %cast_to_double_ptr99148 = bitcast %union.UnionType* %union_storage98 to double*
  %cast_to_int_ptr100 = bitcast double* %cast_to_double_ptr99148 to i64*
  store i64 %result97, i64* %cast_to_int_ptr100
  %load_ivalue101 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor102 = xor i64 %load_ivalue101, -2533274790395904
  %int_to_ptr103 = inttoptr i64 %xor102 to %Object*
  %object_body104 = getelementptr inbounds %Object* %int_to_ptr103, i32 0, i32 1
  %ivalue105 = alloca %union.UnionType
  %union_to_int_ptr106 = bitcast %union.UnionType* %ivalue105 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr106
  %union_to_int_ptr107 = bitcast %union.UnionType* %object_body104 to i64*
  %dereference108 = load i64* %union_to_int_ptr107
  %trunc_int_cast109 = trunc i64 %dereference108 to i32
  %i32_to_i64_cast110 = sext i32 %trunc_int_cast109 to i64
  %union_to_int_ptr111 = bitcast %union.UnionType* %ivalue105 to i64*
  %dereference112 = load i64* %union_to_int_ptr111
  %trunc_int_cast113 = trunc i64 %dereference112 to i32
  %i32_to_i64_cast114 = sext i32 %trunc_int_cast113 to i64
  %binary_op115 = sdiv i64 %i32_to_i64_cast110, %i32_to_i64_cast114
  %int_ptr116 = alloca %union.UnionType
  %and117 = and i64 %binary_op115, 4294967295
  %or118 = or i64 %and117, -4503599627370496
  %or119 = or i64 %or118, 281474976710656
  %union_to_int_ptr120 = bitcast %union.UnionType* %int_ptr116 to i64*
  store i64 %or119, i64* %union_to_int_ptr120
  %load_ivalue121 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor122 = xor i64 %load_ivalue121, -2533274790395904
  %int_to_ptr123 = inttoptr i64 %xor122 to %Object*
  %object_body124 = getelementptr inbounds %Object* %int_to_ptr123, i32 0, i32 1
  %load_value125 = load %union.UnionType* %int_ptr116
  store %union.UnionType %load_value125, %union.UnionType* %object_body124
  %args126 = alloca %union.UnionType*
  %load_ivalue127 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor128 = xor i64 %load_ivalue127, -2533274790395904
  %int_to_ptr129 = inttoptr i64 %xor128 to %Object*
  %object_body130 = getelementptr inbounds %Object* %int_to_ptr129, i32 0, i32 1
  %get_idx131149 = bitcast %union.UnionType** %args126 to %union.UnionType**
  store %union.UnionType* %object_body130, %union.UnionType** %get_idx131149
  %array132 = alloca %ArrayObject
  %array_type133150 = bitcast %ArrayObject* %array132 to i32*
  ...
  store i32 3, i32* %array_type133150
  store %union.UnionType** %args126, %union.UnionType*** %array_list134
  ...
  %cast_to_double_ptr138151 = bitcast %union.UnionType* %union_storage137 to double*
  %cast_to_int_ptr139 = bitcast double* %cast_to_double_ptr138151 to i64*
