...
@global_value4 = common global %union.UnionType zeroinitializer, align 8
...
entrypoint:
  ...
  %"$i" = alloca %Object
  %object_body = getelementptr inbounds %Object* %"$i", i32 0, i32 1
  %load_value = load %union.UnionType* %ivalue
  store %union.UnionType %load_value, %union.UnionType* %object_body
  %base_ptr = alloca %union.UnionType
  %union_ptr_to_int = ptrtoint %Object* %"$i" to i64
  ...
  %load_value2 = load %union.UnionType* %base_ptr
  store %union.UnionType %load_value2, %union.UnionType* @global_value
  br label %loop_head

loop_head:                                        ; preds = %true_block, %entrypoint
  ...
  %object_body3 = getelementptr inbounds %Object* %int_to_ptr, i32 0, i32 1
  %ivalue4 = alloca %union.UnionType
  %union_to_int_ptr5 = bitcast %union.UnionType* %ivalue4 to i64*
  store i64 -4222124650659830, i64* %union_to_int_ptr5
  %union_to_int_ptr6 = bitcast %union.UnionType* %object_body3 to i64*
  %dereference = load i64* %union_to_int_ptr6
  %trunc_int_cast = trunc i64 %dereference to i32
  %i32_to_i64_cast = sext i32 %trunc_int_cast to i64
  %union_to_int_ptr7 = bitcast %union.UnionType* %ivalue4 to i64*
  %dereference8 = load i64* %union_to_int_ptr7
  %trunc_int_cast9 = trunc i64 %dereference8 to i32
  %i32_to_i64_cast10 = sext i32 %trunc_int_cast9 to i64
  %cmp_op = icmp slt i64 %i32_to_i64_cast, %i32_to_i64_cast10
  %zext = zext i1 %cmp_op to i64
  %int_ptr = alloca %union.UnionType
  %and = and i64 %zext, 4294967295
  %or11 = or i64 %and, -4503599627370496
  %or12 = or i64 %or11, 281474976710656
  %union_to_int_ptr13 = bitcast %union.UnionType* %int_ptr to i64*
  store i64 %or12, i64* %union_to_int_ptr13
  %union_to_int_ptr14 = bitcast %union.UnionType* %int_ptr to i64*
  %dereference15 = load i64* %union_to_int_ptr14
  %trunc_int_cast16 = trunc i64 %dereference15 to i32
  %i32_to_i64_cast17 = sext i32 %trunc_int_cast16 to i64
  %ne = icmp ne i64 %i32_to_i64_cast17, 0
  br i1 %ne, label %true_block, label %after_block

true_block:                                       ; preds = %loop_head
  %args = alloca %union.UnionType*
  %load_ivalue18 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor19 = xor i64 %load_ivalue18, -2533274790395904
  %int_to_ptr20 = inttoptr i64 %xor19 to %Object*
  %object_body21 = getelementptr inbounds %Object* %int_to_ptr20, i32 0, i32 1
  %get_idx331 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body21, %union.UnionType** %get_idx331
  %array = alloca %ArrayObject
  %array_type332 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr333 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr333 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %load_ivalue22 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor23 = xor i64 %load_ivalue22, -2533274790395904
  %int_to_ptr24 = inttoptr i64 %xor23 to %Object*
  ...
  %object_body28 = getelementptr inbounds %Object* %int_to_ptr27, i32 0, i32 1
  %union_to_int_ptr29 = bitcast %union.UnionType* %object_body28 to i64*
  %dereference30 = load i64* %union_to_int_ptr29
  %trunc_int_cast31 = trunc i64 %dereference30 to i32
  %i32_to_i64_cast32 = sext i32 %trunc_int_cast31 to i64
  %inc = add i64 %i32_to_i64_cast32, 1
  %int_ptr33 = alloca %union.UnionType
  %and34 = and i64 %inc, 4294967295
  %or35 = or i64 %and34, -4503599627370496
  %or36 = or i64 %or35, 281474976710656
  %union_to_int_ptr37 = bitcast %union.UnionType* %int_ptr33 to i64*
  store i64 %or36, i64* %union_to_int_ptr37
  %object_body38 = getelementptr inbounds %Object* %int_to_ptr24, i32 0, i32 1
  %load_value39 = load %union.UnionType* %int_ptr33
  store %union.UnionType %load_value39, %union.UnionType* %object_body38
  br label %loop_head

after_block:                                      ; preds = %loop_head
  %ivalue40 = alloca %union.UnionType
  %union_to_int_ptr41 = bitcast %union.UnionType* %ivalue40 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr41
  %"$j" = alloca %Object
  %object_body42 = getelementptr inbounds %Object* %"$j", i32 0, i32 1
  %load_value43 = load %union.UnionType* %ivalue40
  store %union.UnionType %load_value43, %union.UnionType* %object_body42
  %base_ptr44 = alloca %union.UnionType
  %union_ptr_to_int45 = ptrtoint %Object* %"$j" to i64
  %or46 = or i64 %union_ptr_to_int45, -4503599627370496
  %or47 = or i64 %or46, 1970324836974592
  %bitcast48 = bitcast %union.UnionType* %base_ptr44 to i64*
  store i64 %or47, i64* %bitcast48
  %load_value49 = load %union.UnionType* %base_ptr44
  store %union.UnionType %load_value49, %union.UnionType* @global_value1
  br label %loop_head50

loop_head50:                                      ; preds = %true_block51, %after_block
  %load_ivalue53 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor54 = xor i64 %load_ivalue53, -2533274790395904
  %int_to_ptr55 = inttoptr i64 %xor54 to %Object*
  %object_body56 = getelementptr inbounds %Object* %int_to_ptr55, i32 0, i32 1
  %ivalue57 = alloca %union.UnionType
  %union_to_int_ptr58 = bitcast %union.UnionType* %ivalue57 to i64*
  store i64 -4222124650659830, i64* %union_to_int_ptr58
  %union_to_int_ptr59 = bitcast %union.UnionType* %object_body56 to i64*
  %dereference60 = load i64* %union_to_int_ptr59
  %trunc_int_cast61 = trunc i64 %dereference60 to i32
  %i32_to_i64_cast62 = sext i32 %trunc_int_cast61 to i64
  %union_to_int_ptr63 = bitcast %union.UnionType* %ivalue57 to i64*
  %dereference64 = load i64* %union_to_int_ptr63
  %trunc_int_cast65 = trunc i64 %dereference64 to i32
  %i32_to_i64_cast66 = sext i32 %trunc_int_cast65 to i64
  %cmp_op67 = icmp slt i64 %i32_to_i64_cast62, %i32_to_i64_cast66
  %zext68 = zext i1 %cmp_op67 to i64
  %int_ptr69 = alloca %union.UnionType
  %and70 = and i64 %zext68, 4294967295
  %or71 = or i64 %and70, -4503599627370496
  %or72 = or i64 %or71, 281474976710656
  %union_to_int_ptr73 = bitcast %union.UnionType* %int_ptr69 to i64*
  store i64 %or72, i64* %union_to_int_ptr73
  %union_to_int_ptr74 = bitcast %union.UnionType* %int_ptr69 to i64*
  ...
  %ne78 = icmp ne i64 %i32_to_i64_cast77, 0
  br i1 %ne78, label %true_block51, label %after_block52

true_block51:                                     ; preds = %loop_head50
  %args79 = alloca %union.UnionType*
  %load_ivalue80 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor81 = xor i64 %load_ivalue80, -2533274790395904
  %int_to_ptr82 = inttoptr i64 %xor81 to %Object*
  %object_body83 = getelementptr inbounds %Object* %int_to_ptr82, i32 0, i32 1
  %get_idx84334 = bitcast %union.UnionType** %args79 to %union.UnionType**
  store %union.UnionType* %object_body83, %union.UnionType** %get_idx84334
  %array85 = alloca %ArrayObject
  %array_type86335 = bitcast %ArrayObject* %array85 to i32*
  %array_list87 = getelementptr inbounds %ArrayObject* %array85, i32 0, i32 1
  %array_size88 = getelementptr inbounds %ArrayObject* %array85, i32 0, i32 2
  store i32 3, i32* %array_type86335
  store %union.UnionType** %args79, %union.UnionType*** %array_list87
  store i64 1, i64* %array_size88
  %result89 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array85)
  %union_storage90 = alloca %union.UnionType
  %cast_to_double_ptr91336 = bitcast %union.UnionType* %union_storage90 to double*
  %cast_to_int_ptr92 = bitcast double* %cast_to_double_ptr91336 to i64*
  store i64 %result89, i64* %cast_to_int_ptr92
  %load_ivalue93 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor94 = xor i64 %load_ivalue93, -2533274790395904
  %int_to_ptr95 = inttoptr i64 %xor94 to %Object*
  %load_ivalue96 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  ...
  %union_to_int_ptr100 = bitcast %union.UnionType* %object_body99 to i64*
  %dereference101 = load i64* %union_to_int_ptr100
  %trunc_int_cast102 = trunc i64 %dereference101 to i32
  %i32_to_i64_cast103 = sext i32 %trunc_int_cast102 to i64
  %inc104 = add i64 %i32_to_i64_cast103, 1
  %int_ptr105 = alloca %union.UnionType
  %and106 = and i64 %inc104, 4294967295
  %or107 = or i64 %and106, -4503599627370496
  %or108 = or i64 %or107, 281474976710656
  %union_to_int_ptr109 = bitcast %union.UnionType* %int_ptr105 to i64*
  store i64 %or108, i64* %union_to_int_ptr109
  %object_body110 = getelementptr inbounds %Object* %int_to_ptr95, i32 0, i32 1
  %load_value111 = load %union.UnionType* %int_ptr105
  store %union.UnionType %load_value111, %union.UnionType* %object_body110
  br label %loop_head50

after_block52:                                    ; preds = %loop_head50
  %ivalue112 = alloca %union.UnionType
  %union_to_int_ptr113 = bitcast %union.UnionType* %ivalue112 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr113
  %ivalue114 = alloca %union.UnionType
  %union_to_int_ptr115 = bitcast %union.UnionType* %ivalue114 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr115
  ...
  store i64 -4222124650659836, i64* %union_to_int_ptr119
  %elems = alloca %union.UnionType*, i64 4
  %load_elem337 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %ivalue112, %union.UnionType** %load_elem337
  %load_elem120 = getelementptr %union.UnionType** %elems, i64 1
  store %union.UnionType* %ivalue114, %union.UnionType** %load_elem120
  %load_elem121 = getelementptr %union.UnionType** %elems, i64 2
  store %union.UnionType* %ivalue116, %union.UnionType** %load_elem121
  %load_elem122 = getelementptr %union.UnionType** %elems, i64 3
  store %union.UnionType* %ivalue118, %union.UnionType** %load_elem122
  ...
  %array_type123338 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  %array_list124 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr, i32 0, i32 1
  %array_size125 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr, i32 0, i32 2
  store i32 3, i32* %array_type123338
  store %union.UnionType** %elems, %union.UnionType*** %array_list124
  store i64 4, i64* %array_size125
  %base_ptr126 = alloca %union.UnionType
  %union_ptr_to_int127 = ptrtoint %ArrayObject* %cast_to_array_ptr to i64
  %or128 = or i64 %union_ptr_to_int127, -4503599627370496
  %or129 = or i64 %or128, 844424930131968
  %bitcast130 = bitcast %union.UnionType* %base_ptr126 to i64*
  store i64 %or129, i64* %bitcast130
  %load_value131 = load %union.UnionType* %base_ptr126
  store %union.UnionType %load_value131, %union.UnionType* @global_value2
  %args132 = alloca %union.UnionType*
  %get_idx133339 = bitcast %union.UnionType** %args132 to %union.UnionType**
  store %union.UnionType* @global_value2, %union.UnionType** %get_idx133339
  %array134 = alloca %ArrayObject
  %array_type135340 = bitcast %ArrayObject* %array134 to i32*
  ...
  store i32 3, i32* %array_type135340
  store %union.UnionType** %args132, %union.UnionType*** %array_list136
  ...
  %cast_to_double_ptr140341 = bitcast %union.UnionType* %union_storage139 to double*
  %cast_to_int_ptr141 = bitcast double* %cast_to_double_ptr140341 to i64*
  store i64 %result138, i64* %cast_to_int_ptr141
  %load_ivalue145 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  %xor146 = xor i64 %load_ivalue145, -3659174697238528
  %int_to_ptr147 = inttoptr i64 %xor146 to %ArrayObject*
  %array_size_ptr = getelementptr inbounds %ArrayObject* %int_to_ptr147, i32 0, i32 2
  %array_size148 = load i64* %array_size_ptr
  %"$itr" = alloca %Object
  %base_ptr149 = alloca %union.UnionType
  %union_ptr_to_int150 = ptrtoint %Object* %"$itr" to i64
  %or151 = or i64 %union_ptr_to_int150, -4503599627370496
  %or152 = or i64 %or151, 1970324836974592
  %bitcast153 = bitcast %union.UnionType* %base_ptr149 to i64*
  store i64 %or152, i64* %bitcast153
  %load_value154 = load %union.UnionType* %base_ptr149
  store %union.UnionType %load_value154, %union.UnionType* @global_value3
  %__hidden_idx__ = alloca i64
  store i64 0, i64* %__hidden_idx__
  br label %loop_head142

loop_head142:                                     ; preds = %true_block143, %after_block52
  %hidden_idx = load i64* %__hidden_idx__
  %0 = icmp slt i64 %hidden_idx, %array_size148
  %zext155 = zext i1 %0 to i64
  %1 = icmp ne i64 %zext155, 0
  br i1 %1, label %true_block143, label %after_block144

true_block143:                                    ; preds = %loop_head142
  %Array_get = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr147, i64 %hidden_idx)
  %load_value156 = load %union.UnionType* %Array_get
  store %union.UnionType %load_value156, %union.UnionType* @global_value4
  %args157 = alloca %union.UnionType*
  %load_ivalue158 = load i64* bitcast (%union.UnionType* @global_value4 to i64*)
  %xor159 = xor i64 %load_ivalue158, -2533274790395904
  %int_to_ptr160 = inttoptr i64 %xor159 to %Object*
  %object_body161 = getelementptr inbounds %Object* %int_to_ptr160, i32 0, i32 1
  %get_idx162342 = bitcast %union.UnionType** %args157 to %union.UnionType**
  store %union.UnionType* @global_value4, %union.UnionType** %get_idx162342
  %array163 = alloca %ArrayObject
  %array_type164343 = bitcast %ArrayObject* %array163 to i32*
  %array_list165 = getelementptr inbounds %ArrayObject* %array163, i32 0, i32 1
  %array_size166 = getelementptr inbounds %ArrayObject* %array163, i32 0, i32 2
  store i32 3, i32* %array_type164343
  store %union.UnionType** %args157, %union.UnionType*** %array_list165
  store i64 1, i64* %array_size166
  %result167 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array163)
  %union_storage168 = alloca %union.UnionType
  %cast_to_double_ptr169344 = bitcast %union.UnionType* %union_storage168 to double*
  %cast_to_int_ptr170 = bitcast double* %cast_to_double_ptr169344 to i64*
  store i64 %result167, i64* %cast_to_int_ptr170
  %inc171 = add i64 %hidden_idx, 1
  store i64 %inc171, i64* %__hidden_idx__
  br label %loop_head142

after_block144:                                   ; preds = %loop_head142
  %ivalue172 = alloca %union.UnionType
  %union_to_int_ptr173 = bitcast %union.UnionType* %ivalue172 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr173
  %load_ivalue174 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor175 = xor i64 %load_ivalue174, -2533274790395904
  %int_to_ptr176 = inttoptr i64 %xor175 to %Object*
  %object_body177 = getelementptr inbounds %Object* %int_to_ptr176, i32 0, i32 1
  %load_value178 = load %union.UnionType* %ivalue172
  store %union.UnionType %load_value178, %union.UnionType* %object_body177
  br label %loop_head179

loop_head179:                                     ; preds = %after_block217, %after_block144
  %load_ivalue182 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor183 = xor i64 %load_ivalue182, -2533274790395904
  %int_to_ptr184 = inttoptr i64 %xor183 to %Object*
  %object_body185 = getelementptr inbounds %Object* %int_to_ptr184, i32 0, i32 1
  %ivalue186 = alloca %union.UnionType
  %union_to_int_ptr187 = bitcast %union.UnionType* %ivalue186 to i64*
  store i64 -4222124650659830, i64* %union_to_int_ptr187
  %union_to_int_ptr188 = bitcast %union.UnionType* %object_body185 to i64*
  %dereference189 = load i64* %union_to_int_ptr188
  %trunc_int_cast190 = trunc i64 %dereference189 to i32
  %i32_to_i64_cast191 = sext i32 %trunc_int_cast190 to i64
  %union_to_int_ptr192 = bitcast %union.UnionType* %ivalue186 to i64*
  %dereference193 = load i64* %union_to_int_ptr192
  %trunc_int_cast194 = trunc i64 %dereference193 to i32
  %i32_to_i64_cast195 = sext i32 %trunc_int_cast194 to i64
  %cmp_op196 = icmp slt i64 %i32_to_i64_cast191, %i32_to_i64_cast195
  %zext197 = zext i1 %cmp_op196 to i64
  %int_ptr198 = alloca %union.UnionType
  %and199 = and i64 %zext197, 4294967295
  %or200 = or i64 %and199, -4503599627370496
  %or201 = or i64 %or200, 281474976710656
  %union_to_int_ptr202 = bitcast %union.UnionType* %int_ptr198 to i64*
  store i64 %or201, i64* %union_to_int_ptr202
  %union_to_int_ptr203 = bitcast %union.UnionType* %int_ptr198 to i64*
  %dereference204 = load i64* %union_to_int_ptr203
  %trunc_int_cast205 = trunc i64 %dereference204 to i32
  %i32_to_i64_cast206 = sext i32 %trunc_int_cast205 to i64
  %ne207 = icmp ne i64 %i32_to_i64_cast206, 0
  br i1 %ne207, label %true_block180, label %after_block181

true_block180:                                    ; preds = %loop_head179
  %ivalue208 = alloca %union.UnionType
  %union_to_int_ptr209 = bitcast %union.UnionType* %ivalue208 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr209
  %load_ivalue210 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor211 = xor i64 %load_ivalue210, -2533274790395904
  %int_to_ptr212 = inttoptr i64 %xor211 to %Object*
  %object_body213 = getelementptr inbounds %Object* %int_to_ptr212, i32 0, i32 1
  %load_value214 = load %union.UnionType* %ivalue208
  store %union.UnionType %load_value214, %union.UnionType* %object_body213
  br label %loop_head215

after_block181:                                   ; preds = %loop_head179
  ret i64 0

loop_head215:                                     ; preds = %true_block216, %true_block180
  %load_ivalue218 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor219 = xor i64 %load_ivalue218, -2533274790395904
  %int_to_ptr220 = inttoptr i64 %xor219 to %Object*
  %object_body221 = getelementptr inbounds %Object* %int_to_ptr220, i32 0, i32 1
  %ivalue222 = alloca %union.UnionType
  %union_to_int_ptr223 = bitcast %union.UnionType* %ivalue222 to i64*
  store i64 -4222124650659830, i64* %union_to_int_ptr223
  %union_to_int_ptr224 = bitcast %union.UnionType* %object_body221 to i64*
  %dereference225 = load i64* %union_to_int_ptr224
  %trunc_int_cast226 = trunc i64 %dereference225 to i32
  %i32_to_i64_cast227 = sext i32 %trunc_int_cast226 to i64
  %union_to_int_ptr228 = bitcast %union.UnionType* %ivalue222 to i64*
  %dereference229 = load i64* %union_to_int_ptr228
  %trunc_int_cast230 = trunc i64 %dereference229 to i32
  %i32_to_i64_cast231 = sext i32 %trunc_int_cast230 to i64
  %cmp_op232 = icmp slt i64 %i32_to_i64_cast227, %i32_to_i64_cast231
  %zext233 = zext i1 %cmp_op232 to i64
  %int_ptr234 = alloca %union.UnionType
  %and235 = and i64 %zext233, 4294967295
  %or236 = or i64 %and235, -4503599627370496
  %or237 = or i64 %or236, 281474976710656
  %union_to_int_ptr238 = bitcast %union.UnionType* %int_ptr234 to i64*
  store i64 %or237, i64* %union_to_int_ptr238
  %union_to_int_ptr239 = bitcast %union.UnionType* %int_ptr234 to i64*
  %dereference240 = load i64* %union_to_int_ptr239
  %trunc_int_cast241 = trunc i64 %dereference240 to i32
  %i32_to_i64_cast242 = sext i32 %trunc_int_cast241 to i64
  %ne243 = icmp ne i64 %i32_to_i64_cast242, 0
  br i1 %ne243, label %true_block216, label %after_block217

true_block216:                                    ; preds = %loop_head215
  %load_ivalue244 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor245 = xor i64 %load_ivalue244, -2533274790395904
  %int_to_ptr246 = inttoptr i64 %xor245 to %Object*
  %object_body247 = getelementptr inbounds %Object* %int_to_ptr246, i32 0, i32 1
  %load_ivalue248 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor249 = xor i64 %load_ivalue248, -2533274790395904
  %int_to_ptr250 = inttoptr i64 %xor249 to %Object*
  %object_body251 = getelementptr inbounds %Object* %int_to_ptr250, i32 0, i32 1
  %union_to_int_ptr252 = bitcast %union.UnionType* %object_body247 to i64*
  %dereference253 = load i64* %union_to_int_ptr252
  %trunc_int_cast254 = trunc i64 %dereference253 to i32
  %i32_to_i64_cast255 = sext i32 %trunc_int_cast254 to i64
  %union_to_int_ptr256 = bitcast %union.UnionType* %object_body251 to i64*
  %dereference257 = load i64* %union_to_int_ptr256
  %trunc_int_cast258 = trunc i64 %dereference257 to i32
  %i32_to_i64_cast259 = sext i32 %trunc_int_cast258 to i64
  %binary_op = mul i64 %i32_to_i64_cast255, %i32_to_i64_cast259
  %int_ptr260 = alloca %union.UnionType
  %and261 = and i64 %binary_op, 4294967295
  %or262 = or i64 %and261, -4503599627370496
  %or263 = or i64 %or262, 281474976710656
  %union_to_int_ptr264 = bitcast %union.UnionType* %int_ptr260 to i64*
  store i64 %or263, i64* %union_to_int_ptr264
  %string = call i64 @new_String(i8* getelementptr inbounds ([3 x i8]* @0, i32 0, i32 0))
  %union_storage265 = alloca %union.UnionType
  %cast_to_double_ptr266345 = bitcast %union.UnionType* %union_storage265 to double*
  %cast_to_int_ptr267 = bitcast double* %cast_to_double_ptr266345 to i64*
  store i64 %string, i64* %cast_to_int_ptr267
  %args268 = alloca %union.UnionType*, i64 2
  %get_idx269346 = bitcast %union.UnionType** %args268 to %union.UnionType**
  store %union.UnionType* %int_ptr260, %union.UnionType** %get_idx269346
  %get_idx270 = getelementptr %union.UnionType** %args268, i64 1
  store %union.UnionType* %union_storage265, %union.UnionType** %get_idx270
  %array271 = alloca %ArrayObject
  %array_type272347 = bitcast %ArrayObject* %array271 to i32*
  %array_list273 = getelementptr inbounds %ArrayObject* %array271, i32 0, i32 1
  %array_size274 = getelementptr inbounds %ArrayObject* %array271, i32 0, i32 2
  store i32 3, i32* %array_type272347
  store %union.UnionType** %args268, %union.UnionType*** %array_list273
  store i64 2, i64* %array_size274
  %result275 = call i64 bitcast (i64 (%struct._Array*)* @print to i64 (%ArrayObject*)*)(%ArrayObject* %array271)
  %union_storage276 = alloca %union.UnionType
  %cast_to_double_ptr277348 = bitcast %union.UnionType* %union_storage276 to double*
  %cast_to_int_ptr278 = bitcast double* %cast_to_double_ptr277348 to i64*
  store i64 %result275, i64* %cast_to_int_ptr278
  %load_ivalue279 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor280 = xor i64 %load_ivalue279, -2533274790395904
  %int_to_ptr281 = inttoptr i64 %xor280 to %Object*
  %load_ivalue282 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor283 = xor i64 %load_ivalue282, -2533274790395904
  %int_to_ptr284 = inttoptr i64 %xor283 to %Object*
  %object_body285 = getelementptr inbounds %Object* %int_to_ptr284, i32 0, i32 1
  %union_to_int_ptr286 = bitcast %union.UnionType* %object_body285 to i64*
  %dereference287 = load i64* %union_to_int_ptr286
  %trunc_int_cast288 = trunc i64 %dereference287 to i32
  %i32_to_i64_cast289 = sext i32 %trunc_int_cast288 to i64
  %inc290 = add i64 %i32_to_i64_cast289, 1
  %int_ptr291 = alloca %union.UnionType
  %and292 = and i64 %inc290, 4294967295
  %or293 = or i64 %and292, -4503599627370496
  %or294 = or i64 %or293, 281474976710656
  %union_to_int_ptr295 = bitcast %union.UnionType* %int_ptr291 to i64*
  store i64 %or294, i64* %union_to_int_ptr295
  %object_body296 = getelementptr inbounds %Object* %int_to_ptr281, i32 0, i32 1
  %load_value297 = load %union.UnionType* %int_ptr291
  store %union.UnionType %load_value297, %union.UnionType* %object_body296
  br label %loop_head215

after_block217:                                   ; preds = %loop_head215
  %args298 = alloca %union.UnionType*
  %string299 = call i64 @new_String(i8* getelementptr inbounds ([1 x i8]* @1, i32 0, i32 0))
  %union_storage300 = alloca %union.UnionType
  %cast_to_double_ptr301349 = bitcast %union.UnionType* %union_storage300 to double*
  %cast_to_int_ptr302 = bitcast double* %cast_to_double_ptr301349 to i64*
  store i64 %string299, i64* %cast_to_int_ptr302
  %get_idx303350 = bitcast %union.UnionType** %args298 to %union.UnionType**
  store %union.UnionType* %union_storage300, %union.UnionType** %get_idx303350
  %array304 = alloca %ArrayObject
  %array_type305351 = bitcast %ArrayObject* %array304 to i32*
  %array_list306 = getelementptr inbounds %ArrayObject* %array304, i32 0, i32 1
  %array_size307 = getelementptr inbounds %ArrayObject* %array304, i32 0, i32 2
  store i32 3, i32* %array_type305351
  store %union.UnionType** %args298, %union.UnionType*** %array_list306
  store i64 1, i64* %array_size307
  %result308 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array304)
  %union_storage309 = alloca %union.UnionType
  %cast_to_double_ptr310352 = bitcast %union.UnionType* %union_storage309 to double*
  %cast_to_int_ptr311 = bitcast double* %cast_to_double_ptr310352 to i64*
  store i64 %result308, i64* %cast_to_int_ptr311
  %load_ivalue312 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor313 = xor i64 %load_ivalue312, -2533274790395904
  %int_to_ptr314 = inttoptr i64 %xor313 to %Object*
  %load_ivalue315 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor316 = xor i64 %load_ivalue315, -2533274790395904
  %int_to_ptr317 = inttoptr i64 %xor316 to %Object*
  %object_body318 = getelementptr inbounds %Object* %int_to_ptr317, i32 0, i32 1
  %union_to_int_ptr319 = bitcast %union.UnionType* %object_body318 to i64*
  %dereference320 = load i64* %union_to_int_ptr319
  %trunc_int_cast321 = trunc i64 %dereference320 to i32
  %i32_to_i64_cast322 = sext i32 %trunc_int_cast321 to i64
  %inc323 = add i64 %i32_to_i64_cast322, 1
  %int_ptr324 = alloca %union.UnionType
  %and325 = and i64 %inc323, 4294967295
  %or326 = or i64 %and325, -4503599627370496
  %or327 = or i64 %or326, 281474976710656
  %union_to_int_ptr328 = bitcast %union.UnionType* %int_ptr324 to i64*
  store i64 %or327, i64* %union_to_int_ptr328
  %object_body329 = getelementptr inbounds %Object* %int_to_ptr314, i32 0, i32 1
  %load_value330 = load %union.UnionType* %int_ptr324
  store %union.UnionType %load_value330, %union.UnionType* %object_body329
  br label %loop_head179
}
