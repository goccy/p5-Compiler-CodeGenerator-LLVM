...
@1 = private unnamed_addr constant [6 x i8] c"elsif\00"
@2 = private unnamed_addr constant [5 x i8] c"else\00"
...
entrypoint:
  ...
  store i64 -4222124650659839, i64* %union_to_int_ptr2
  %union_to_int_ptr3 = bitcast %union.UnionType* %ivalue to i64*
  %dereference = load i64* %union_to_int_ptr3
  %trunc_int_cast = trunc i64 %dereference to i32
  %i32_to_i64_cast = sext i32 %trunc_int_cast to i64
  %union_to_int_ptr4 = bitcast %union.UnionType* %ivalue1 to i64*
  ...
  %binary_op = add i64 %i32_to_i64_cast, %i32_to_i64_cast7
  %int_ptr = alloca %union.UnionType
  %and = and i64 %binary_op, 4294967295
  %or = or i64 %and, -4503599627370496
  %or8 = or i64 %or, 281474976710656
  %union_to_int_ptr9 = bitcast %union.UnionType* %int_ptr to i64*
  store i64 %or8, i64* %union_to_int_ptr9
  %"$a" = alloca %Object
  %object_body = getelementptr inbounds %Object* %"$a", i32 0, i32 1
  %load_value = load %union.UnionType* %int_ptr
  ...
  %or10 = or i64 %union_ptr_to_int, -4503599627370496
  %or11 = or i64 %or10, 1970324836974592
  %bitcast = bitcast %union.UnionType* %base_ptr to i64*
  store i64 %or11, i64* %bitcast
  %load_value12 = load %union.UnionType* %base_ptr
  store %union.UnionType %load_value12, %union.UnionType* @global_value
  ...
  %object_body13 = getelementptr inbounds %Object* %int_to_ptr, i32 0, i32 1
  %ivalue14 = alloca %union.UnionType
  %union_to_int_ptr15 = bitcast %union.UnionType* %ivalue14 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr15
  %union_to_int_ptr16 = bitcast %union.UnionType* %object_body13 to i64*
  %dereference17 = load i64* %union_to_int_ptr16
  %trunc_int_cast18 = trunc i64 %dereference17 to i32
  %i32_to_i64_cast19 = sext i32 %trunc_int_cast18 to i64
  %union_to_int_ptr20 = bitcast %union.UnionType* %ivalue14 to i64*
  %dereference21 = load i64* %union_to_int_ptr20
  %trunc_int_cast22 = trunc i64 %dereference21 to i32
  %i32_to_i64_cast23 = sext i32 %trunc_int_cast22 to i64
  %binary_op24 = add i64 %i32_to_i64_cast19, %i32_to_i64_cast23
  %int_ptr25 = alloca %union.UnionType
  %and26 = and i64 %binary_op24, 4294967295
  %or27 = or i64 %and26, -4503599627370496
  %or28 = or i64 %or27, 281474976710656
  %union_to_int_ptr29 = bitcast %union.UnionType* %int_ptr25 to i64*
  store i64 %or28, i64* %union_to_int_ptr29
  ...
  %load_value34 = load %union.UnionType* %int_ptr25
  store %union.UnionType %load_value34, %union.UnionType* %object_body33
  %args = alloca %union.UnionType*
  %load_ivalue35 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor36 = xor i64 %load_ivalue35, -2533274790395904
  %int_to_ptr37 = inttoptr i64 %xor36 to %Object*
  %object_body38 = getelementptr inbounds %Object* %int_to_ptr37, i32 0, i32 1
  %get_idx344 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body38, %union.UnionType** %get_idx344
  %array = alloca %ArrayObject
  %array_type345 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr346 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr346 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %args39 = alloca %union.UnionType*
  %load_ivalue40 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor41 = xor i64 %load_ivalue40, -2533274790395904
  %int_to_ptr42 = inttoptr i64 %xor41 to %Object*
  %object_body43 = getelementptr inbounds %Object* %int_to_ptr42, i32 0, i32 1
  %ivalue44 = alloca %union.UnionType
  %union_to_int_ptr45 = bitcast %union.UnionType* %ivalue44 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr45
  %union_to_int_ptr46 = bitcast %union.UnionType* %object_body43 to i64*
  %dereference47 = load i64* %union_to_int_ptr46
  %trunc_int_cast48 = trunc i64 %dereference47 to i32
  %i32_to_i64_cast49 = sext i32 %trunc_int_cast48 to i64
  %union_to_int_ptr50 = bitcast %union.UnionType* %ivalue44 to i64*
  %dereference51 = load i64* %union_to_int_ptr50
  %trunc_int_cast52 = trunc i64 %dereference51 to i32
  %i32_to_i64_cast53 = sext i32 %trunc_int_cast52 to i64
  %cmp_op = icmp eq i64 %i32_to_i64_cast49, %i32_to_i64_cast53
  %zext = zext i1 %cmp_op to i64
  %int_ptr54 = alloca %union.UnionType
  %and55 = and i64 %zext, 4294967295
  %or56 = or i64 %and55, -4503599627370496
  %or57 = or i64 %or56, 281474976710656
  %union_to_int_ptr58 = bitcast %union.UnionType* %int_ptr54 to i64*
  store i64 %or57, i64* %union_to_int_ptr58
  %get_idx59347 = bitcast %union.UnionType** %args39 to %union.UnionType**
  store %union.UnionType* %int_ptr54, %union.UnionType** %get_idx59347
  %array60 = alloca %ArrayObject
  %array_type61348 = bitcast %ArrayObject* %array60 to i32*
  ...
  store i32 3, i32* %array_type61348
  store %union.UnionType** %args39, %union.UnionType*** %array_list62
  ...
  %cast_to_double_ptr66349 = bitcast %union.UnionType* %union_storage65 to double*
  %cast_to_int_ptr67 = bitcast double* %cast_to_double_ptr66349 to i64*
  store i64 %result64, i64* %cast_to_int_ptr67
  %load_ivalue68 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor69 = xor i64 %load_ivalue68, -2533274790395904
  %int_to_ptr70 = inttoptr i64 %xor69 to %Object*
  %object_body71 = getelementptr inbounds %Object* %int_to_ptr70, i32 0, i32 1
  %ivalue72 = alloca %union.UnionType
  %union_to_int_ptr73 = bitcast %union.UnionType* %ivalue72 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr73
  %union_to_int_ptr74 = bitcast %union.UnionType* %object_body71 to i64*
  %dereference75 = load i64* %union_to_int_ptr74
  %trunc_int_cast76 = trunc i64 %dereference75 to i32
  %i32_to_i64_cast77 = sext i32 %trunc_int_cast76 to i64
  %union_to_int_ptr78 = bitcast %union.UnionType* %ivalue72 to i64*
  %dereference79 = load i64* %union_to_int_ptr78
  %trunc_int_cast80 = trunc i64 %dereference79 to i32
  %i32_to_i64_cast81 = sext i32 %trunc_int_cast80 to i64
  %cmp_op82 = icmp ne i64 %i32_to_i64_cast77, %i32_to_i64_cast81
  %zext83 = zext i1 %cmp_op82 to i64
  %int_ptr84 = alloca %union.UnionType
  %and85 = and i64 %zext83, 4294967295
  %or86 = or i64 %and85, -4503599627370496
  %or87 = or i64 %or86, 281474976710656
  %union_to_int_ptr88 = bitcast %union.UnionType* %int_ptr84 to i64*
  store i64 %or87, i64* %union_to_int_ptr88
  %union_to_int_ptr89 = bitcast %union.UnionType* %int_ptr84 to i64*
  %dereference90 = load i64* %union_to_int_ptr89
  %trunc_int_cast91 = trunc i64 %dereference90 to i32
  %i32_to_i64_cast92 = sext i32 %trunc_int_cast91 to i64
  %0 = icmp ne i64 %i32_to_i64_cast92, 0
  br i1 %0, label %if_true_block, label %if_false_block

if_true_block:                                    ; preds = %entrypoint
  %args93 = alloca %union.UnionType*
  %string = call i64 @new_String(i8* getelementptr inbounds ([5 x i8]* @0, i32 0, i32 0))
  %union_storage94 = alloca %union.UnionType
  %cast_to_double_ptr95350 = bitcast %union.UnionType* %union_storage94 to double*
  %cast_to_int_ptr96 = bitcast double* %cast_to_double_ptr95350 to i64*
  store i64 %string, i64* %cast_to_int_ptr96
  %get_idx97351 = bitcast %union.UnionType** %args93 to %union.UnionType**
  store %union.UnionType* %union_storage94, %union.UnionType** %get_idx97351
  %array98 = alloca %ArrayObject
  %array_type99352 = bitcast %ArrayObject* %array98 to i32*
  ...
  store i32 3, i32* %array_type99352
  store %union.UnionType** %args93, %union.UnionType*** %array_list100
  ...
  %cast_to_double_ptr104353 = bitcast %union.UnionType* %union_storage103 to double*
  %cast_to_int_ptr105 = bitcast double* %cast_to_double_ptr104353 to i64*
  store i64 %result102, i64* %cast_to_int_ptr105
  br label %if_merge_block

if_false_block:                                   ; preds = %entrypoint
  %load_ivalue106 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor107 = xor i64 %load_ivalue106, -2533274790395904
  %int_to_ptr108 = inttoptr i64 %xor107 to %Object*
  %object_body109 = getelementptr inbounds %Object* %int_to_ptr108, i32 0, i32 1
  %ivalue110 = alloca %union.UnionType
  %union_to_int_ptr111 = bitcast %union.UnionType* %ivalue110 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr111
  %union_to_int_ptr112 = bitcast %union.UnionType* %object_body109 to i64*
  %dereference113 = load i64* %union_to_int_ptr112
  %trunc_int_cast114 = trunc i64 %dereference113 to i32
  %i32_to_i64_cast115 = sext i32 %trunc_int_cast114 to i64
  %union_to_int_ptr116 = bitcast %union.UnionType* %ivalue110 to i64*
  %dereference117 = load i64* %union_to_int_ptr116
  %trunc_int_cast118 = trunc i64 %dereference117 to i32
  %i32_to_i64_cast119 = sext i32 %trunc_int_cast118 to i64
  %cmp_op120 = icmp eq i64 %i32_to_i64_cast115, %i32_to_i64_cast119
  %zext121 = zext i1 %cmp_op120 to i64
  %int_ptr122 = alloca %union.UnionType
  %and123 = and i64 %zext121, 4294967295
  %or124 = or i64 %and123, -4503599627370496
  %or125 = or i64 %or124, 281474976710656
  %union_to_int_ptr126 = bitcast %union.UnionType* %int_ptr122 to i64*
  store i64 %or125, i64* %union_to_int_ptr126
  %union_to_int_ptr127 = bitcast %union.UnionType* %int_ptr122 to i64*
  %dereference128 = load i64* %union_to_int_ptr127
  %trunc_int_cast129 = trunc i64 %dereference128 to i32
  %i32_to_i64_cast130 = sext i32 %trunc_int_cast129 to i64
  %1 = icmp ne i64 %i32_to_i64_cast130, 0
  br i1 %1, label %if_true_block131, label %if_false_block132

if_merge_block:                                   ; preds = %if_true_block131, %if_false_block132, %if_true_block
  %args162 = alloca %union.UnionType*
  %ivalue163 = alloca %union.UnionType
  %union_to_int_ptr164 = bitcast %union.UnionType* %ivalue163 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr164
  %double_ptr = alloca %union.UnionType
  %cast_to_double_ptr165 = bitcast %union.UnionType* %double_ptr to double*
  store double 2.200000e+00, double* %cast_to_double_ptr165
  %union_to_int_ptr166 = bitcast %union.UnionType* %ivalue163 to i64*
  %dereference167 = load i64* %union_to_int_ptr166
  %trunc_int_cast168 = trunc i64 %dereference167 to i32
  %i32_to_i64_cast169 = sext i32 %trunc_int_cast168 to i64
  %cast_to_double_ptr170 = bitcast %union.UnionType* %double_ptr to double*
  %load_double = load double* %cast_to_double_ptr170
  %__hidden_cond__ = alloca %union.UnionType
  %ne = icmp ne i64 %i32_to_i64_cast169, 0
  br i1 %ne, label %true_block, label %false_block

if_true_block131:                                 ; preds = %if_false_block
  %args134 = alloca %union.UnionType*
  %string135 = call i64 @new_String(i8* getelementptr inbounds ([6 x i8]* @1, i32 0, i32 0))
  %union_storage136 = alloca %union.UnionType
  %cast_to_double_ptr137354 = bitcast %union.UnionType* %union_storage136 to double*
  %cast_to_int_ptr138 = bitcast double* %cast_to_double_ptr137354 to i64*
  store i64 %string135, i64* %cast_to_int_ptr138
  %get_idx139355 = bitcast %union.UnionType** %args134 to %union.UnionType**
  store %union.UnionType* %union_storage136, %union.UnionType** %get_idx139355
  %array140 = alloca %ArrayObject
  %array_type141356 = bitcast %ArrayObject* %array140 to i32*
  %array_list142 = getelementptr inbounds %ArrayObject* %array140, i32 0, i32 1
  %array_size143 = getelementptr inbounds %ArrayObject* %array140, i32 0, i32 2
  store i32 3, i32* %array_type141356
  store %union.UnionType** %args134, %union.UnionType*** %array_list142
  store i64 1, i64* %array_size143
  %result144 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array140)
  %union_storage145 = alloca %union.UnionType
  %cast_to_double_ptr146357 = bitcast %union.UnionType* %union_storage145 to double*
  %cast_to_int_ptr147 = bitcast double* %cast_to_double_ptr146357 to i64*
  store i64 %result144, i64* %cast_to_int_ptr147
  br label %if_merge_block

if_false_block132:                                ; preds = %if_false_block
  %args148 = alloca %union.UnionType*
  %string149 = call i64 @new_String(i8* getelementptr inbounds ([5 x i8]* @2, i32 0, i32 0))
  %union_storage150 = alloca %union.UnionType
  %cast_to_double_ptr151358 = bitcast %union.UnionType* %union_storage150 to double*
  %cast_to_int_ptr152 = bitcast double* %cast_to_double_ptr151358 to i64*
  store i64 %string149, i64* %cast_to_int_ptr152
  %get_idx153359 = bitcast %union.UnionType** %args148 to %union.UnionType**
  store %union.UnionType* %union_storage150, %union.UnionType** %get_idx153359
  %array154 = alloca %ArrayObject
  %array_type155360 = bitcast %ArrayObject* %array154 to i32*
  %array_list156 = getelementptr inbounds %ArrayObject* %array154, i32 0, i32 1
  %array_size157 = getelementptr inbounds %ArrayObject* %array154, i32 0, i32 2
  store i32 3, i32* %array_type155360
  store %union.UnionType** %args148, %union.UnionType*** %array_list156
  store i64 1, i64* %array_size157
  %result158 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array154)
  %union_storage159 = alloca %union.UnionType
  %cast_to_double_ptr160361 = bitcast %union.UnionType* %union_storage159 to double*
  %cast_to_int_ptr161 = bitcast double* %cast_to_double_ptr160361 to i64*
  store i64 %result158, i64* %cast_to_int_ptr161
  br label %if_merge_block

true_block:                                       ; preds = %if_merge_block
  %double_ptr171 = alloca %union.UnionType
  %cast_to_double_ptr172 = bitcast %union.UnionType* %double_ptr171 to double*
  store double %load_double, double* %cast_to_double_ptr172
  %load_nandouble = load %union.UnionType* %double_ptr171
  store %union.UnionType %load_nandouble, %union.UnionType* %__hidden_cond__
  br label %merge_block

false_block:                                      ; preds = %if_merge_block
  %int_ptr173 = alloca %union.UnionType
  %union_to_int_ptr174 = bitcast %union.UnionType* %int_ptr173 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr174
  %load_nanint = load %union.UnionType* %int_ptr173
  store %union.UnionType %load_nanint, %union.UnionType* %__hidden_cond__
  br label %merge_block

merge_block:                                      ; preds = %false_block, %true_block
  %__hidden_cond__175 = alloca %union.UnionType
  %load_hidden_cond = load %union.UnionType* %__hidden_cond__
  store %union.UnionType %load_hidden_cond, %union.UnionType* %__hidden_cond__175
  %ivalue176 = alloca %union.UnionType
  %union_to_int_ptr177 = bitcast %union.UnionType* %ivalue176 to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr177
  %union_to_int_ptr178 = bitcast %union.UnionType* %ivalue176 to i64*
  %dereference179 = load i64* %union_to_int_ptr178
  %trunc_int_cast180 = trunc i64 %dereference179 to i32
  %i32_to_i64_cast181 = sext i32 %trunc_int_cast180 to i64
  %__hidden_cond__182 = alloca %union.UnionType
  %load_value183 = load %union.UnionType* %__hidden_cond__175
  %object = call i1 bitcast (i32 (i64)* @Object_isTrue to i1 (%union.UnionType)*)(%union.UnionType %load_value183)
  br i1 %object, label %true_block184, label %false_block185

true_block184:                                    ; preds = %merge_block
  %int_ptr187 = alloca %union.UnionType
  %and188 = and i64 %i32_to_i64_cast181, 4294967295
  %or189 = or i64 %and188, -4503599627370496
  %or190 = or i64 %or189, 281474976710656
  %union_to_int_ptr191 = bitcast %union.UnionType* %int_ptr187 to i64*
  store i64 %or190, i64* %union_to_int_ptr191
  %load_nanint192 = load %union.UnionType* %int_ptr187
  store %union.UnionType %load_nanint192, %union.UnionType* %__hidden_cond__182
  br label %merge_block186

false_block185:                                   ; preds = %merge_block
  %int_ptr193 = alloca %union.UnionType
  %union_to_int_ptr194 = bitcast %union.UnionType* %int_ptr193 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr194
  %load_nanint195 = load %union.UnionType* %int_ptr193
  store %union.UnionType %load_nanint195, %union.UnionType* %__hidden_cond__182
  br label %merge_block186

merge_block186:                                   ; preds = %false_block185, %true_block184
  %__hidden_cond__196 = alloca %union.UnionType
  %load_hidden_cond197 = load %union.UnionType* %__hidden_cond__182
  store %union.UnionType %load_hidden_cond197, %union.UnionType* %__hidden_cond__196
  %double_ptr198 = alloca %union.UnionType
  %cast_to_double_ptr199 = bitcast %union.UnionType* %double_ptr198 to double*
  store double 4.200000e+00, double* %cast_to_double_ptr199
  %cast_to_double_ptr200 = bitcast %union.UnionType* %double_ptr198 to double*
  %load_double201 = load double* %cast_to_double_ptr200
  %__hidden_cond__202 = alloca %union.UnionType
  %load_value203 = load %union.UnionType* %__hidden_cond__196
  %object204 = call i1 bitcast (i32 (i64)* @Object_isTrue to i1 (%union.UnionType)*)(%union.UnionType %load_value203)
  br i1 %object204, label %true_block205, label %false_block206

true_block205:                                    ; preds = %merge_block186
  %double_ptr208 = alloca %union.UnionType
  %cast_to_double_ptr209 = bitcast %union.UnionType* %double_ptr208 to double*
  store double %load_double201, double* %cast_to_double_ptr209
  %load_nandouble210 = load %union.UnionType* %double_ptr208
  store %union.UnionType %load_nandouble210, %union.UnionType* %__hidden_cond__202
  br label %merge_block207

false_block206:                                   ; preds = %merge_block186
  %int_ptr211 = alloca %union.UnionType
  %union_to_int_ptr212 = bitcast %union.UnionType* %int_ptr211 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr212
  %load_nanint213 = load %union.UnionType* %int_ptr211
  store %union.UnionType %load_nanint213, %union.UnionType* %__hidden_cond__202
  br label %merge_block207

merge_block207:                                   ; preds = %false_block206, %true_block205
  %__hidden_cond__214 = alloca %union.UnionType
  %load_hidden_cond215 = load %union.UnionType* %__hidden_cond__202
  store %union.UnionType %load_hidden_cond215, %union.UnionType* %__hidden_cond__214
  %get_idx216362 = bitcast %union.UnionType** %args162 to %union.UnionType**
  store %union.UnionType* %__hidden_cond__214, %union.UnionType** %get_idx216362
  %array217 = alloca %ArrayObject
  %array_type218363 = bitcast %ArrayObject* %array217 to i32*
  %array_list219 = getelementptr inbounds %ArrayObject* %array217, i32 0, i32 1
  %array_size220 = getelementptr inbounds %ArrayObject* %array217, i32 0, i32 2
  store i32 3, i32* %array_type218363
  store %union.UnionType** %args162, %union.UnionType*** %array_list219
  store i64 1, i64* %array_size220
  %result221 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array217)
  %union_storage222 = alloca %union.UnionType
  %cast_to_double_ptr223364 = bitcast %union.UnionType* %union_storage222 to double*
  %cast_to_int_ptr224 = bitcast double* %cast_to_double_ptr223364 to i64*
  store i64 %result221, i64* %cast_to_int_ptr224
  %args225 = alloca %union.UnionType*
  %ivalue226 = alloca %union.UnionType
  %union_to_int_ptr227 = bitcast %union.UnionType* %ivalue226 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr227
  %ivalue228 = alloca %union.UnionType
  %union_to_int_ptr229 = bitcast %union.UnionType* %ivalue228 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr229
  ...
  %union_to_int_ptr234 = bitcast %union.UnionType* %ivalue228 to i64*
  %dereference235 = load i64* %union_to_int_ptr234
  %trunc_int_cast236 = trunc i64 %dereference235 to i32
  %i32_to_i64_cast237 = sext i32 %trunc_int_cast236 to i64
  %__hidden_cond__238 = alloca %union.UnionType
  %ne239 = icmp ne i64 %i32_to_i64_cast233, 0
  br i1 %ne239, label %true_block240, label %false_block241

true_block240:                                    ; preds = %merge_block207
  %int_ptr243 = alloca %union.UnionType
  %and244 = and i64 %i32_to_i64_cast237, 4294967295
  %or245 = or i64 %and244, -4503599627370496
  %or246 = or i64 %or245, 281474976710656
  %union_to_int_ptr247 = bitcast %union.UnionType* %int_ptr243 to i64*
  store i64 %or246, i64* %union_to_int_ptr247
  %load_nanint248 = load %union.UnionType* %int_ptr243
  store %union.UnionType %load_nanint248, %union.UnionType* %__hidden_cond__238
  br label %merge_block242

false_block241:                                   ; preds = %merge_block207
  %int_ptr249 = alloca %union.UnionType
  %union_to_int_ptr250 = bitcast %union.UnionType* %int_ptr249 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr250
  %load_nanint251 = load %union.UnionType* %int_ptr249
  store %union.UnionType %load_nanint251, %union.UnionType* %__hidden_cond__238
  br label %merge_block242

merge_block242:                                   ; preds = %false_block241, %true_block240
  %__hidden_cond__252 = alloca %union.UnionType
  %load_hidden_cond253 = load %union.UnionType* %__hidden_cond__238
  store %union.UnionType %load_hidden_cond253, %union.UnionType* %__hidden_cond__252
  %get_idx254365 = bitcast %union.UnionType** %args225 to %union.UnionType**
  store %union.UnionType* %__hidden_cond__252, %union.UnionType** %get_idx254365
  %array255 = alloca %ArrayObject
  %array_type256366 = bitcast %ArrayObject* %array255 to i32*
  %array_list257 = getelementptr inbounds %ArrayObject* %array255, i32 0, i32 1
  %array_size258 = getelementptr inbounds %ArrayObject* %array255, i32 0, i32 2
  store i32 3, i32* %array_type256366
  store %union.UnionType** %args225, %union.UnionType*** %array_list257
  store i64 1, i64* %array_size258
  %result259 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array255)
  %union_storage260 = alloca %union.UnionType
  %cast_to_double_ptr261367 = bitcast %union.UnionType* %union_storage260 to double*
  %cast_to_int_ptr262 = bitcast double* %cast_to_double_ptr261367 to i64*
  store i64 %result259, i64* %cast_to_int_ptr262
  %args263 = alloca %union.UnionType*
  %ivalue264 = alloca %union.UnionType
  %union_to_int_ptr265 = bitcast %union.UnionType* %ivalue264 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr265
  %ivalue266 = alloca %union.UnionType
  %union_to_int_ptr267 = bitcast %union.UnionType* %ivalue266 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr267
  %union_to_int_ptr268 = bitcast %union.UnionType* %ivalue264 to i64*
  %dereference269 = load i64* %union_to_int_ptr268
  %trunc_int_cast270 = trunc i64 %dereference269 to i32
  %i32_to_i64_cast271 = sext i32 %trunc_int_cast270 to i64
  %union_to_int_ptr272 = bitcast %union.UnionType* %ivalue266 to i64*
  %dereference273 = load i64* %union_to_int_ptr272
  %trunc_int_cast274 = trunc i64 %dereference273 to i32
  %i32_to_i64_cast275 = sext i32 %trunc_int_cast274 to i64
  %__hidden_cond__276 = alloca %union.UnionType
  %ne277 = icmp ne i64 %i32_to_i64_cast271, 0
  br i1 %ne277, label %true_block278, label %false_block279

true_block278:                                    ; preds = %merge_block242
  %int_ptr281 = alloca %union.UnionType
  %and282 = and i64 %i32_to_i64_cast271, 4294967295
  ...
  %load_int = load %union.UnionType* %int_ptr281
  store %union.UnionType %load_int, %union.UnionType* %__hidden_cond__276
  br label %merge_block280

false_block279:                                   ; preds = %merge_block242
  %int_ptr286 = alloca %union.UnionType
  %and287 = and i64 %i32_to_i64_cast275, 4294967295
  %or288 = or i64 %and287, -4503599627370496
  %or289 = or i64 %or288, 281474976710656
  %union_to_int_ptr290 = bitcast %union.UnionType* %int_ptr286 to i64*
  store i64 %or289, i64* %union_to_int_ptr290
  %load_int291 = load %union.UnionType* %int_ptr286
  store %union.UnionType %load_int291, %union.UnionType* %__hidden_cond__276
  br label %merge_block280

merge_block280:                                   ; preds = %false_block279, %true_block278
  %__hidden_cond__292 = alloca %union.UnionType
  %load_hidden_cond293 = load %union.UnionType* %__hidden_cond__276
  store %union.UnionType %load_hidden_cond293, %union.UnionType* %__hidden_cond__292
  %get_idx294368 = bitcast %union.UnionType** %args263 to %union.UnionType**
  store %union.UnionType* %__hidden_cond__292, %union.UnionType** %get_idx294368
  %array295 = alloca %ArrayObject
  %array_type296369 = bitcast %ArrayObject* %array295 to i32*
  %array_list297 = getelementptr inbounds %ArrayObject* %array295, i32 0, i32 1
  %array_size298 = getelementptr inbounds %ArrayObject* %array295, i32 0, i32 2
  store i32 3, i32* %array_type296369
  store %union.UnionType** %args263, %union.UnionType*** %array_list297
  store i64 1, i64* %array_size298
  %result299 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array295)
  %union_storage300 = alloca %union.UnionType
  %cast_to_double_ptr301370 = bitcast %union.UnionType* %union_storage300 to double*
  %cast_to_int_ptr302 = bitcast double* %cast_to_double_ptr301370 to i64*
  store i64 %result299, i64* %cast_to_int_ptr302
  %args303 = alloca %union.UnionType*
  %ivalue304 = alloca %union.UnionType
  %union_to_int_ptr305 = bitcast %union.UnionType* %ivalue304 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr305
  %ivalue306 = alloca %union.UnionType
  %union_to_int_ptr307 = bitcast %union.UnionType* %ivalue306 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr307
  %union_to_int_ptr308 = bitcast %union.UnionType* %ivalue304 to i64*
  %dereference309 = load i64* %union_to_int_ptr308
  %trunc_int_cast310 = trunc i64 %dereference309 to i32
  %i32_to_i64_cast311 = sext i32 %trunc_int_cast310 to i64
  %union_to_int_ptr312 = bitcast %union.UnionType* %ivalue306 to i64*
  %dereference313 = load i64* %union_to_int_ptr312
  %trunc_int_cast314 = trunc i64 %dereference313 to i32
  %i32_to_i64_cast315 = sext i32 %trunc_int_cast314 to i64
  %__hidden_cond__316 = alloca %union.UnionType
  %ne317 = icmp ne i64 %i32_to_i64_cast311, 0
  br i1 %ne317, label %true_block318, label %false_block319

true_block318:                                    ; preds = %merge_block280
  %int_ptr321 = alloca %union.UnionType
  %and322 = and i64 %i32_to_i64_cast311, 4294967295
  %or323 = or i64 %and322, -4503599627370496
  %or324 = or i64 %or323, 281474976710656
  %union_to_int_ptr325 = bitcast %union.UnionType* %int_ptr321 to i64*
  store i64 %or324, i64* %union_to_int_ptr325
  %load_int326 = load %union.UnionType* %int_ptr321
  store %union.UnionType %load_int326, %union.UnionType* %__hidden_cond__316
  br label %merge_block320

false_block319:                                   ; preds = %merge_block280
  %int_ptr327 = alloca %union.UnionType
  %and328 = and i64 %i32_to_i64_cast315, 4294967295
  %or329 = or i64 %and328, -4503599627370496
  %or330 = or i64 %or329, 281474976710656
  %union_to_int_ptr331 = bitcast %union.UnionType* %int_ptr327 to i64*
  store i64 %or330, i64* %union_to_int_ptr331
  %load_int332 = load %union.UnionType* %int_ptr327
  store %union.UnionType %load_int332, %union.UnionType* %__hidden_cond__316
  br label %merge_block320

merge_block320:                                   ; preds = %false_block319, %true_block318
  %__hidden_cond__333 = alloca %union.UnionType
  %load_hidden_cond334 = load %union.UnionType* %__hidden_cond__316
  store %union.UnionType %load_hidden_cond334, %union.UnionType* %__hidden_cond__333
  %get_idx335371 = bitcast %union.UnionType** %args303 to %union.UnionType**
  store %union.UnionType* %__hidden_cond__333, %union.UnionType** %get_idx335371
  %array336 = alloca %ArrayObject
  %array_type337372 = bitcast %ArrayObject* %array336 to i32*
  %array_list338 = getelementptr inbounds %ArrayObject* %array336, i32 0, i32 1
  %array_size339 = getelementptr inbounds %ArrayObject* %array336, i32 0, i32 2
  store i32 3, i32* %array_type337372
  store %union.UnionType** %args303, %union.UnionType*** %array_list338
  store i64 1, i64* %array_size339
  %result340 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array336)
  %union_storage341 = alloca %union.UnionType
  %cast_to_double_ptr342373 = bitcast %union.UnionType* %union_storage341 to double*
  %cast_to_int_ptr343 = bitcast double* %cast_to_double_ptr342373 to i64*
  store i64 %result340, i64* %cast_to_int_ptr343
  ret i64 0
}
