...
@1 = private unnamed_addr constant [4 x i8] c"fib\00"
...
entrypoint:
  ...
  call void bitcast (void (i8*, i8*, i64 (%struct._Array*)*)* @store_method_by_pkg_name to void (i8*, i8*, i64 (%ArrayObject*)*)*)(i8* getelementptr inbounds ([5 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @1, i32 0, i32 0), i64 (%ArrayObject*)* @fib)
  %args = alloca %union.UnionType*
  %args1 = alloca %union.UnionType*
  %ivalue = alloca %union.UnionType
  %union_to_int_ptr = bitcast %union.UnionType* %ivalue to i64*
  store i64 -4222124650659805, i64* %union_to_int_ptr
  %get_idx10 = bitcast %union.UnionType** %args1 to %union.UnionType**
  store %union.UnionType* %ivalue, %union.UnionType** %get_idx10
  %array = alloca %ArrayObject
  %array_type11 = bitcast %ArrayObject* %array to i32*
  ...
  store i32 3, i32* %array_type11
  store %union.UnionType** %args1, %union.UnionType*** %array_list
  store i64 1, i64* %array_size
  %function_rvalue = tail call fastcc i64 @fib(%ArrayObject* %array)
  %union_storage = alloca %union.UnionType
  %cast_to_double_ptr12 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr12 to i64*
  store i64 %function_rvalue, i64* %cast_to_int_ptr
  %get_idx213 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %union_storage, %union.UnionType** %get_idx213
  %array3 = alloca %ArrayObject
  %array_type414 = bitcast %ArrayObject* %array3 to i32*
  %array_list5 = getelementptr inbounds %ArrayObject* %array3, i32 0, i32 1
  %array_size6 = getelementptr inbounds %ArrayObject* %array3, i32 0, i32 2
  store i32 3, i32* %array_type414
  store %union.UnionType** %args, %union.UnionType*** %array_list5
  store i64 1, i64* %array_size6
  %result = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array3)
  %union_storage7 = alloca %union.UnionType
  %cast_to_double_ptr815 = bitcast %union.UnionType* %union_storage7 to double*
  %cast_to_int_ptr9 = bitcast double* %cast_to_double_ptr815 to i64*
  store i64 %result, i64* %cast_to_int_ptr9
  ret i64 0
}

define fastcc i64 @fib(%ArrayObject*) {
entrypoint:
  %ivalue = alloca %union.UnionType
  %union_to_int_ptr = bitcast %union.UnionType* %ivalue to i64*
  ...
  %object = call i64 bitcast (i64 (%union.UnionType*, i32)* @Object_ltInt to i64 (%union.UnionType*, i64)*)(%union.UnionType* %load_arg, i64 %i32_to_i64_cast7)
  %union_storage = alloca %union.UnionType
  %cast_to_double_ptr76 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr76 to i64*
  store i64 %object, i64* %cast_to_int_ptr
  %union_to_int_ptr8 = bitcast %union.UnionType* %union_storage to i64*
  %dereference9 = load i64* %union_to_int_ptr8
  %trunc_int_cast10 = trunc i64 %dereference9 to i32
  %i32_to_i64_cast11 = sext i32 %trunc_int_cast10 to i64
  %1 = icmp ne i64 %i32_to_i64_cast11, 0
  br i1 %1, label %if_true_block, label %if_merge_block

if_true_block:                                    ; preds = %entrypoint
  %ivalue12 = alloca %union.UnionType
  %union_to_int_ptr13 = bitcast %union.UnionType* %ivalue12 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr13
  %cast_to_double_ptr1477 = bitcast %union.UnionType* %ivalue12 to double*
  %cast_to_int_ptr15 = bitcast double* %cast_to_double_ptr1477 to i64*
  %cast_to_int = load i64* %cast_to_int_ptr15
  ret i64 %cast_to_int
  br label %if_merge_block

if_merge_block:                                   ; preds = %entrypoint, %if_true_block
  %args = alloca %union.UnionType*
  %ivalue16 = alloca %union.UnionType
  %union_to_int_ptr17 = bitcast %union.UnionType* %ivalue16 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr17
  %union_to_int_ptr18 = bitcast %union.UnionType* %ivalue16 to i64*
  %dereference19 = load i64* %union_to_int_ptr18
  %trunc_int_cast20 = trunc i64 %dereference19 to i32
  %i32_to_i64_cast21 = sext i32 %trunc_int_cast20 to i64
  %fetch_list22 = getelementptr inbounds %ArrayObject* %0, i32 0, i32 1
  %load_list23 = load %union.UnionType*** %fetch_list22
  %get_elem24 = getelementptr %union.UnionType** %load_list23, i64 %i32_to_i64_cast21
  %load_arg25 = load %union.UnionType** %get_elem24
  %ivalue26 = alloca %union.UnionType
  %union_to_int_ptr27 = bitcast %union.UnionType* %ivalue26 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr27
  %union_to_int_ptr28 = bitcast %union.UnionType* %ivalue26 to i64*
  %dereference29 = load i64* %union_to_int_ptr28
  %trunc_int_cast30 = trunc i64 %dereference29 to i32
  %i32_to_i64_cast31 = sext i32 %trunc_int_cast30 to i64
  %object32 = call i64 bitcast (i64 (%union.UnionType*, i32)* @Object_subInt to i64 (%union.UnionType*, i64)*)(%union.UnionType* %load_arg25, i64 %i32_to_i64_cast31)
  %union_storage33 = alloca %union.UnionType
  %cast_to_double_ptr3478 = bitcast %union.UnionType* %union_storage33 to double*
  %cast_to_int_ptr35 = bitcast double* %cast_to_double_ptr3478 to i64*
  store i64 %object32, i64* %cast_to_int_ptr35
  %get_idx79 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %union_storage33, %union.UnionType** %get_idx79
  %array = alloca %ArrayObject
  %array_type80 = bitcast %ArrayObject* %array to i32*
  %array_list = getelementptr inbounds %ArrayObject* %array, i32 0, i32 1
  %array_size = getelementptr inbounds %ArrayObject* %array, i32 0, i32 2
  store i32 3, i32* %array_type80
  store %union.UnionType** %args, %union.UnionType*** %array_list
  store i64 1, i64* %array_size
  %function_rvalue = tail call fastcc i64 @fib(%ArrayObject* %array)
  %union_storage36 = alloca %union.UnionType
  %cast_to_double_ptr3781 = bitcast %union.UnionType* %union_storage36 to double*
  %cast_to_int_ptr38 = bitcast double* %cast_to_double_ptr3781 to i64*
  store i64 %function_rvalue, i64* %cast_to_int_ptr38
  ...
  %union_to_int_ptr42 = bitcast %union.UnionType* %ivalue40 to i64*
  %dereference43 = load i64* %union_to_int_ptr42
  %trunc_int_cast44 = trunc i64 %dereference43 to i32
  %i32_to_i64_cast45 = sext i32 %trunc_int_cast44 to i64
  %fetch_list46 = getelementptr inbounds %ArrayObject* %0, i32 0, i32 1
  %load_list47 = load %union.UnionType*** %fetch_list46
  %get_elem48 = getelementptr %union.UnionType** %load_list47, i64 %i32_to_i64_cast45
  %load_arg49 = load %union.UnionType** %get_elem48
  %ivalue50 = alloca %union.UnionType
  %union_to_int_ptr51 = bitcast %union.UnionType* %ivalue50 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr51
  %union_to_int_ptr52 = bitcast %union.UnionType* %ivalue50 to i64*
  %dereference53 = load i64* %union_to_int_ptr52
  %trunc_int_cast54 = trunc i64 %dereference53 to i32
  %i32_to_i64_cast55 = sext i32 %trunc_int_cast54 to i64
  %object56 = call i64 bitcast (i64 (%union.UnionType*, i32)* @Object_subInt to i64 (%union.UnionType*, i64)*)(%union.UnionType* %load_arg49, i64 %i32_to_i64_cast55)
  %union_storage57 = alloca %union.UnionType
  %cast_to_double_ptr5882 = bitcast %union.UnionType* %union_storage57 to double*
  %cast_to_int_ptr59 = bitcast double* %cast_to_double_ptr5882 to i64*
  store i64 %object56, i64* %cast_to_int_ptr59
  %get_idx6083 = bitcast %union.UnionType** %args39 to %union.UnionType**
  store %union.UnionType* %union_storage57, %union.UnionType** %get_idx6083
  %array61 = alloca %ArrayObject
  %array_type6284 = bitcast %ArrayObject* %array61 to i32*
  ...
  store i32 3, i32* %array_type6284
  store %union.UnionType** %args39, %union.UnionType*** %array_list63
  store i64 1, i64* %array_size64
  %function_rvalue65 = tail call fastcc i64 @fib(%ArrayObject* %array61)
  %union_storage66 = alloca %union.UnionType
  %cast_to_double_ptr6785 = bitcast %union.UnionType* %union_storage66 to double*
  %cast_to_int_ptr68 = bitcast double* %cast_to_double_ptr6785 to i64*
  store i64 %function_rvalue65, i64* %cast_to_int_ptr68
  %object69 = call i64 @Object_addObject(%union.UnionType* %union_storage36, %union.UnionType* %union_storage66)
  ...
  store i64 %object69, i64* %cast_to_int_ptr72
  ...
  %cast_to_int75 = load i64* %cast_to_int_ptr74
  ret i64 %cast_to_int75
}
