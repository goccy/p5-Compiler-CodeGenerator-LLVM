...
entrypoint:
  ...
  %ivalue1.i = alloca %union.UnionType
  %ivalue4.i = alloca %union.UnionType
  ...
  %get_idx37 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body3, %union.UnionType** %get_idx37
  %array = alloca %ArrayObject
  %array_type38 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr39 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr39 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %load_ivalue4 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor5 = xor i64 %load_ivalue4, -2533274790395904
  %int_to_ptr6 = inttoptr i64 %xor5 to %Object*
  %object_body7 = getelementptr inbounds %Object* %int_to_ptr6, i32 0, i32 1
  %elems = alloca %union.UnionType*
  %load_elem40 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %object_body7, %union.UnionType** %load_elem40
  ...
  %array_type841 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  %array_list9 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr, i32 0, i32 1
  %array_size10 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr, i32 0, i32 2
  store i32 3, i32* %array_type841
  store %union.UnionType** %elems, %union.UnionType*** %array_list9
  store i64 1, i64* %array_size10
  %base_ptr11 = alloca %union.UnionType
  %union_ptr_to_int12 = ptrtoint %ArrayObject* %cast_to_array_ptr to i64
  ...
  %bitcast16 = bitcast %union.UnionType* %base_ptr11 to i64*
  %load_ivalue17 = load i64* %bitcast16
  %xor18 = xor i64 %load_ivalue17, -3659174697238528
  %int_to_ptr19 = inttoptr i64 %xor18 to %ArrayObject*
  %0 = bitcast %union.UnionType* %ivalue.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %0)
  %1 = bitcast %union.UnionType* %ivalue1.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %1)
  %2 = bitcast %union.UnionType* %ivalue4.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %2)
  %union_to_int_ptr.i = bitcast %union.UnionType* %ivalue.i to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr.i
  %union_to_int_ptr2.i = bitcast %union.UnionType* %ivalue1.i to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr2.i
  %union_to_int_ptr3.i = bitcast %union.UnionType* %ivalue1.i to i64*
  %dereference.i = load i64* %union_to_int_ptr3.i
  %trunc_int_cast.i = trunc i64 %dereference.i to i32
  %i32_to_i64_cast.i = sext i32 %trunc_int_cast.i to i64
  %fetch_list.i = getelementptr inbounds %ArrayObject* %int_to_ptr19, i32 0, i32 1
  ...
  %load_value.i = load %union.UnionType* %ivalue.i
  store %union.UnionType %load_value.i, %union.UnionType* %load_arg.i
  %union_to_int_ptr5.i = bitcast %union.UnionType* %ivalue4.i to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr5.i
  %cast_to_double_ptr6.i = bitcast %union.UnionType* %ivalue4.i to double*
  %cast_to_int_ptr.i = bitcast double* %cast_to_double_ptr6.i to i64*
  %cast_to_int.i = load i64* %cast_to_int_ptr.i
  %3 = bitcast %union.UnionType* %ivalue.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %3)
  %4 = bitcast %union.UnionType* %ivalue1.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %4)
  %5 = bitcast %union.UnionType* %ivalue4.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %5)
  %union_storage20 = alloca %union.UnionType
  %cast_to_double_ptr2142 = bitcast %union.UnionType* %union_storage20 to double*
  %cast_to_int_ptr22 = bitcast double* %cast_to_double_ptr2142 to i64*
  store i64 %cast_to_int.i, i64* %cast_to_int_ptr22
  ...
  %object_body27 = getelementptr inbounds %Object* %int_to_ptr26, i32 0, i32 1
  %get_idx2843 = bitcast %union.UnionType** %args23 to %union.UnionType**
  store %union.UnionType* %object_body27, %union.UnionType** %get_idx2843
  %array29 = alloca %ArrayObject
  %array_type3044 = bitcast %ArrayObject* %array29 to i32*
  %array_list31 = getelementptr inbounds %ArrayObject* %array29, i32 0, i32 1
  %array_size32 = getelementptr inbounds %ArrayObject* %array29, i32 0, i32 2
  store i32 3, i32* %array_type3044
  store %union.UnionType** %args23, %union.UnionType*** %array_list31
  store i64 1, i64* %array_size32
  %result33 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array29)
  %union_storage34 = alloca %union.UnionType
  %cast_to_double_ptr3545 = bitcast %union.UnionType* %union_storage34 to double*
  %cast_to_int_ptr36 = bitcast double* %cast_to_double_ptr3545 to i64*
  store i64 %result33, i64* %cast_to_int_ptr36
  ret i64 0
}
...
entrypoint:
  %ivalue = alloca %union.UnionType
  %union_to_int_ptr = bitcast %union.UnionType* %ivalue to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr
  %ivalue1 = alloca %union.UnionType
  %union_to_int_ptr2 = bitcast %union.UnionType* %ivalue1 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr2
  %union_to_int_ptr3 = bitcast %union.UnionType* %ivalue1 to i64*
  ...
  %load_value = load %union.UnionType* %ivalue
  store %union.UnionType %load_value, %union.UnionType* %load_arg
  %ivalue4 = alloca %union.UnionType
  %union_to_int_ptr5 = bitcast %union.UnionType* %ivalue4 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr5
  %cast_to_double_ptr6 = bitcast %union.UnionType* %ivalue4 to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr6 to i64*
  %cast_to_int = load i64* %cast_to_int_ptr
  ret i64 %cast_to_int
}
