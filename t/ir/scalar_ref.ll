...
entrypoint:
  ...
  %get_idx30 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body3, %union.UnionType** %get_idx30
  %array = alloca %ArrayObject
  %array_type31 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr32 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr32 to i64*
  ...
  %args8 = alloca %union.UnionType*
  %load_arg33 = bitcast %union.UnionType** %args8 to %union.UnionType**
  store %union.UnionType* %object_body7, %union.UnionType** %load_arg33
  %array9 = alloca %ArrayObject
  %array_type1034 = bitcast %ArrayObject* %array9 to i32*
  %array_list11 = getelementptr inbounds %ArrayObject* %array9, i32 0, i32 1
  %array_size12 = getelementptr inbounds %ArrayObject* %array9, i32 0, i32 2
  store i32 3, i32* %array_type1034
  store %union.UnionType** %args8, %union.UnionType*** %array_list11
  store i64 1, i64* %array_size12
  ...
  %fetch_list.i = getelementptr inbounds %ArrayObject* %array9, i32 0, i32 1
  ...
  %cast_to_double_ptr1435 = bitcast %union.UnionType* %union_storage13 to double*
  %cast_to_int_ptr15 = bitcast double* %cast_to_double_ptr1435 to i64*
  store i64 %cast_to_int.i, i64* %cast_to_int_ptr15
  %args16 = alloca %union.UnionType*
  %load_ivalue17 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor18 = xor i64 %load_ivalue17, -2533274790395904
  %int_to_ptr19 = inttoptr i64 %xor18 to %Object*
  %object_body20 = getelementptr inbounds %Object* %int_to_ptr19, i32 0, i32 1
  %get_idx2136 = bitcast %union.UnionType** %args16 to %union.UnionType**
  store %union.UnionType* %object_body20, %union.UnionType** %get_idx2136
  %array22 = alloca %ArrayObject
  %array_type2337 = bitcast %ArrayObject* %array22 to i32*
  %array_list24 = getelementptr inbounds %ArrayObject* %array22, i32 0, i32 1
  %array_size25 = getelementptr inbounds %ArrayObject* %array22, i32 0, i32 2
  store i32 3, i32* %array_type2337
  store %union.UnionType** %args16, %union.UnionType*** %array_list24
  store i64 1, i64* %array_size25
  %result26 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array22)
  %union_storage27 = alloca %union.UnionType
  %cast_to_double_ptr2838 = bitcast %union.UnionType* %union_storage27 to double*
  %cast_to_int_ptr29 = bitcast double* %cast_to_double_ptr2838 to i64*
  store i64 %result26, i64* %cast_to_int_ptr29
  ret i64 0
}
