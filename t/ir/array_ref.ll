...
%ArrayRef = type { i32, %union.UnionType }
...
@global_value2 = common global %union.UnionType zeroinitializer, align 8
@global_value3 = common global %union.UnionType zeroinitializer, align 8
...
if.then12:                                        ; preds = %do.body
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__._open, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 16, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
if.then34:                                        ; preds = %do.body22
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__._open, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
if.else67:                                        ; preds = %entry
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__._open, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 34, i8* getelementptr inbounds ([34 x i8]* @.str10, i32 0, i32 0)) #7
  unreachable
...
if.then:                                          ; preds = %do.body
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([9 x i8]* @__func__._binmode, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 45, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
if.then:                                          ; preds = %do.body
  ...
  %mul26 = mul i64 %conv22, %shr25
  %call = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([15 x i8]* @.str, i32 0, i32 0), i64 %mul26)
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8]* @__func__._chr, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 66, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
if.then:                                          ; preds = %do.body
  ...
  %mul26 = mul i64 %conv22, %shr25
  %call = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([15 x i8]* @.str, i32 0, i32 0), i64 %mul26)
  call void @__assert_rtn(i8* getelementptr inbounds ([7 x i8]* @__func__._close, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 79, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
sw.default:                                       ; preds = %entry
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8]* @__func__._abs, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 106, i8* getelementptr inbounds ([36 x i8]* @.str15, i32 0, i32 0)) #7
  unreachable
...
sw.default:                                       ; preds = %entry
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8]* @__func__._int, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 124, i8* getelementptr inbounds ([36 x i8]* @.str15, i32 0, i32 0)) #7
  unreachable
...
sw.default:                                       ; preds = %entry
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8]* @__func__._sin, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 150, i8* getelementptr inbounds ([36 x i8]* @.str15, i32 0, i32 0)) #7
  unreachable
...
sw.default:                                       ; preds = %entry
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8]* @__func__._cos, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 168, i8* getelementptr inbounds ([36 x i8]* @.str15, i32 0, i32 0)) #7
  unreachable
...
sw.bb:                                            ; preds = %if.end
  ...
  %9 = ptrtoint i8* %8 to i64
  %call = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %7, i8* getelementptr inbounds ([3 x i8]* @.str38, i32 0, i32 0), i64 %9)
  br label %sw.epilog
...
sw.bb6:                                           ; preds = %if.end
  ...
  %call7 = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %10, i8* getelementptr inbounds ([3 x i8]* @.str39, i32 0, i32 0), double %11)
  br label %sw.epilog

sw.bb8:                                           ; preds = %if.end
  %12 = load %struct.__sFILE** %fp.addr, align 8
  %o9 = bitcast %union.UnionType* %o to i8**
  %13 = load i8** %o9, align 8
  %14 = ptrtoint i8* %13 to i64
  ...
  %call10 = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %12, i8* getelementptr inbounds ([3 x i8]* @.str17, i32 0, i32 0), i8* %16)
  br label %sw.epilog

sw.bb11:                                          ; preds = %if.end
  %17 = load %struct.__sFILE** %fp.addr, align 8
  %18 = load %struct.__sFILE** @__stdoutp, align 8
  %cmp12 = icmp ne %struct.__sFILE* %17, %18
  br i1 %cmp12, label %if.then14, label %if.else

if.then14:                                        ; preds = %sw.bb11
  %19 = load %struct.__sFILE** %fp.addr, align 8
  %o15 = bitcast %union.UnionType* %o to i8**
  %20 = load i8** %o15, align 8
  %21 = ptrtoint i8* %20 to i64
  %xor16 = xor i64 %21, -3659174697238528
  %22 = inttoptr i64 %xor16 to %struct._Array*
...
for.cond.i:                                       ; preds = %for.inc.i, %if.then14
...
if.else:                                          ; preds = %sw.bb11
  ...
  %43 = load i8** %o17, align 8
  %44 = ptrtoint i8* %43 to i64
  %xor18 = xor i64 %44, -3659174697238528
  %45 = inttoptr i64 %xor18 to %struct._Array*
...
print.exit:                                       ; preds = %for.cond.i9
  ...
  %coerce.dive202 = bitcast %union.UnionType* %coerce to double*
  %72 = bitcast double* %coerce.dive202 to i64*
  store i64 %66, i64* %72, align 1
  br label %sw.epilog

sw.bb22:                                          ; preds = %if.end
  %73 = load %struct.__sFILE** %fp.addr, align 8
  %o23 = bitcast %union.UnionType* %o to i8**
  %74 = load i8** %o23, align 8
  %call24 = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %73, i8* getelementptr inbounds ([10 x i8]* @.str42, i32 0, i32 0), i8* %74)
  br label %sw.epilog

sw.bb25:                                          ; preds = %if.end
  %75 = load %struct.__sFILE** %fp.addr, align 8
  %o26 = bitcast %union.UnionType* %o to i8**
  %76 = load i8** %o26, align 8
  %77 = ptrtoint i8* %76 to i64
  %xor27 = xor i64 %77, -3096224743817216
  %78 = inttoptr i64 %xor27 to %struct._Hash*
  call void @print_hash(%struct.__sFILE* %75, %struct._Hash* %78)
  br label %sw.epilog

sw.bb28:                                          ; preds = %if.end
  %79 = load %struct.__sFILE** %fp.addr, align 8
  %o29 = bitcast %union.UnionType* %o to i8**
  %80 = load i8** %o29, align 8
  %call30 = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %79, i8* getelementptr inbounds ([9 x i8]* @.str43, i32 0, i32 0), i8* %80)
  br label %sw.epilog

sw.bb31:                                          ; preds = %if.end
  %81 = load %struct.__sFILE** %fp.addr, align 8
  %o32 = bitcast %union.UnionType* %o to i8**
  %82 = load i8** %o32, align 8
  %call33 = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %81, i8* getelementptr inbounds ([9 x i8]* @.str44, i32 0, i32 0), i8* %82)
  br label %sw.epilog

sw.bb34:                                          ; preds = %if.end
  %o35 = bitcast %union.UnionType* %o to i8**
  %83 = load i8** %o35, align 8
  %84 = ptrtoint i8* %83 to i64
  %xor36 = xor i64 %84, -2533274790395904
  %85 = inttoptr i64 %xor36 to %struct._Object*
  ...
  %coerce.dive373 = bitcast %union.UnionType* %v to double*
  %88 = bitcast double* %coerce.dive373 to i64*
...
sw.bb38:                                          ; preds = %if.end
  ...
  %o39 = bitcast %union.UnionType* %o to i8**
  %91 = load i8** %o39, align 8
  %92 = ptrtoint i8* %91 to i64
  %xor40 = xor i64 %92, -2251799813685248
  %93 = inttoptr i64 %xor40 to %struct._BlessedObject*
  %pkg_name = getelementptr inbounds %struct._BlessedObject* %93, i32 0, i32 3
  %94 = load i8** %pkg_name, align 8
  %o41 = bitcast %union.UnionType* %o to i8**
  %95 = load i8** %o41, align 8
  %call42 = call i32 (%struct.__sFILE*, i8*, ...)* @fprintf(%struct.__sFILE* %90, i8* getelementptr inbounds ([12 x i8]* @.str45, i32 0, i32 0), i8* %94, i8* %95)
  br label %sw.epilog

sw.epilog:                                        ; preds = %if.end, %_print_with_handler.exit, %print.exit, %sw.bb38, %sw.bb34, %sw.bb31, %sw.bb28, %sw.bb25, %sw.bb22, %sw.bb8, %sw.bb6, %sw.bb
  ret void
}
...
if.then11:                                        ; preds = %do.body
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__.shift, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 362, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
if.then10:                                        ; preds = %do.body
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8]* @__func__.push, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 402, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
sw.default:                                       ; preds = %entry
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([12 x i8]* @__func__.HashRef_get, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 473, i8* getelementptr inbounds ([33 x i8]* @.str32, i32 0, i32 0)) #7
  unreachable
...
sw.default:                                       ; preds = %entry
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([13 x i8]* @__func__.ArrayRef_get, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 530, i8* getelementptr inbounds ([33 x i8]* @.str32, i32 0, i32 0)) #7
  unreachable
...
entry:
  ...
  %class_o = alloca %union.UnionType*, align 8
  %coerce = alloca %union.UnionType, align 8
...
cond.end:                                         ; preds = %entry
  ...
  %24 = load %struct._Array** %base.addr, align 8
  %list12 = getelementptr inbounds %struct._Array* %24, i32 0, i32 1
  store %union.UnionType** %23, %union.UnionType*** %list12, align 8
  ...
  %27 = load %struct._Object*** @object_pool, align 8
  %arrayidx.i = getelementptr inbounds %struct._Object** %27, i64 %idxprom.i
  %28 = load %struct._Object** %arrayidx.i, align 8
  %29 = bitcast %struct._Object* %28 to %union.UnionType*
  store %union.UnionType* %29, %union.UnionType** %class_o, align 8
  %30 = load i8** %pkg_name.addr, align 8
  %call15 = call i64 @new_String(i8* %30)
  %coerce.dive1 = bitcast %union.UnionType* %coerce to double*
  %31 = bitcast double* %coerce.dive1 to i64*
  store i64 %call15, i64* %31, align 1
  %o = bitcast %union.UnionType* %coerce to i8**
  %32 = load i8** %o, align 8
  %33 = load %union.UnionType** %class_o, align 8
  %o16 = bitcast %union.UnionType* %33 to i8**
  store i8* %32, i8** %o16, align 8
  %34 = load %union.UnionType** %class_o, align 8
  %35 = load %struct._Array** %base.addr, align 8
  %list17 = getelementptr inbounds %struct._Array* %35, i32 0, i32 1
  %36 = load %union.UnionType*** %list17, align 8
  %arrayidx2 = bitcast %union.UnionType** %36 to %union.UnionType**
  store %union.UnionType* %34, %union.UnionType** %arrayidx2, align 8
  %37 = load %struct._Array** %base.addr, align 8
  %size18 = getelementptr inbounds %struct._Array* %37, i32 0, i32 2
  %38 = load i64* %size18, align 8
  %inc = add i64 %38, 1
...
cond.end:                                         ; preds = %entry
  ...
  %28 = load %struct._Object** %arrayidx.i, align 8
  %29 = bitcast %struct._Object* %28 to %union.UnionType*
  store %union.UnionType* %29, %union.UnionType** %elem, align 8
  %30 = load %struct._BlessedObject** %self.addr, align 8
  %31 = ptrtoint %struct._BlessedObject* %30 to i64
  %or = or i64 %31, -4503599627370496
  %or15 = or i64 %or, 2251799813685248
  %32 = inttoptr i64 %or15 to i8*
  %33 = load %union.UnionType** %elem, align 8
  %o = bitcast %union.UnionType* %33 to i8**
  store i8* %32, i8** %o, align 8
  %34 = load %union.UnionType** %elem, align 8
  %35 = load %struct._Array** %base.addr, align 8
  %list16 = getelementptr inbounds %struct._Array* %35, i32 0, i32 1
  %36 = load %union.UnionType*** %list16, align 8
  %arrayidx1 = bitcast %union.UnionType** %36 to %union.UnionType**
  store %union.UnionType* %34, %union.UnionType** %arrayidx1, align 8
  %37 = load %struct._Array** %base.addr, align 8
  %size17 = getelementptr inbounds %struct._Array* %37, i32 0, i32 2
  %38 = load i64* %size17, align 8
  %inc = add i64 %38, 1
...
if.then10:                                        ; preds = %do.body
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__.bless, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 664, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
if.then46:                                        ; preds = %do.body34
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__.bless, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 666, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
cond.true70:                                      ; preds = %land.end
  call void @__assert_rtn(i8* getelementptr inbounds ([6 x i8]* @__func__.bless, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 677, i8* getelementptr inbounds ([30 x i8]* @.str35, i32 0, i32 0)) #7
  unreachable
...
entry:
  ...
  call void @llvm.lifetime.end(i64 -1, i8* %20) #3
  %coerce.dive22 = bitcast %union.UnionType* %_pkg to double*
...
if.then:                                          ; preds = %entry
  ...
  %27 = ptrtoint i8* %26 to i64
  %xor10 = xor i64 %27, -1407374883553280
  %28 = inttoptr i64 %xor10 to %struct._Package*
  store %struct._Package* %28, %struct._Package** %retval
  br label %return

cond.end:                                         ; preds = %entry
  %call11 = call i8* @calloc(i64 48, i64 1)
  %29 = bitcast i8* %call11 to %struct._Package*
  ...
  %table13 = getelementptr inbounds %struct._Package* %32, i32 0, i32 1
  ...
  %87 = inttoptr i64 %or26 to i8*
  %o27 = bitcast %union.UnionType* %value to i8**
  store i8* %87, i8** %o27, align 8
  ...
  %90 = bitcast double* %coerce.dive284 to i64*
...
entry:
  ...
  %14 = bitcast double* %coerce.dive72 to i64*
  %15 = load i64* %14, align 1
  %16 = bitcast %struct._Hash** %hash.addr.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %16) #3
  %17 = bitcast %struct._String** %key.addr.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %17) #3
  %18 = bitcast %union.UnionType* %elem.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %18) #3
  %19 = bitcast i64* %size.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %19) #3
  store %struct._Hash* %10, %struct._Hash** %hash.addr.i, align 8
  store %struct._String* %13, %struct._String** %key.addr.i, align 8
  %coerce.dive1.i = bitcast %union.UnionType* %elem.i to double*
  %20 = bitcast double* %coerce.dive1.i to i64*
  store i64 %15, i64* %20, align 1
  %21 = load %struct._Hash** %hash.addr.i, align 8
  %size1.i = getelementptr inbounds %struct._Hash* %21, i32 0, i32 3
  %22 = load i64* %size1.i, align 8
  store i64 %22, i64* %size.i, align 8
  %23 = load %struct._String** %key.addr.i, align 8
  %hash2.i = getelementptr inbounds %struct._String* %23, i32 0, i32 3
  %24 = load i64* %hash2.i, align 8
  %25 = load %struct._Hash** %hash.addr.i, align 8
  %table.i = getelementptr inbounds %struct._Hash* %25, i32 0, i32 1
  %26 = load %union.UnionType** %table.i, align 8
  %arrayidx.i = getelementptr inbounds %union.UnionType* %26, i64 %24
  %27 = bitcast %union.UnionType* %arrayidx.i to i8*
  %28 = bitcast %union.UnionType* %elem.i to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %27, i8* %28, i64 8, i32 8, i1 false) #3
  %29 = load %struct._String** %key.addr.i, align 8
  %30 = load i64* %size.i, align 8
  %add.i = add i64 %30, 1
  %31 = load %struct._Hash** %hash.addr.i, align 8
  %keys.i = getelementptr inbounds %struct._Hash* %31, i32 0, i32 2
  %32 = load %struct._String*** %keys.i, align 8
  %arrayidx3.i = getelementptr inbounds %struct._String** %32, i64 %add.i
  store %struct._String* %29, %struct._String** %arrayidx3.i, align 8
  %33 = load %struct._Hash** %hash.addr.i, align 8
  %size4.i = getelementptr inbounds %struct._Hash* %33, i32 0, i32 3
  %34 = load i64* %size4.i, align 8
  %inc.i = add i64 %34, 1
  store i64 %inc.i, i64* %size4.i, align 8
  %35 = bitcast %struct._Hash** %hash.addr.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %35) #3
  %36 = bitcast %struct._String** %key.addr.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %36) #3
  %37 = bitcast %union.UnionType* %elem.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %37) #3
  %38 = bitcast i64* %size.i to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %38) #3
  ret void
}
...
cond.true:                                        ; preds = %land.end
  call void @__assert_rtn(i8* getelementptr inbounds ([19 x i8]* @__func__.get_method_by_name, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 750, i8* getelementptr inbounds ([33 x i8]* @.str37, i32 0, i32 0)) #7
  unreachable
...
land.end:                                         ; preds = %land.rhs, %entry
  ...
  br i1 %tobool4, label %cond.true, label %cond.end

cond.true:                                        ; preds = %land.end
  call void @__assert_rtn(i8* getelementptr inbounds ([25 x i8]* @__func__.get_class_method_by_name, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 761, i8* getelementptr inbounds ([33 x i8]* @.str37, i32 0, i32 0)) #7
  unreachable

cond.end:                                         ; preds = %land.end
  %17 = load %struct._CodeRef** %code_ref, align 8
  %code = getelementptr inbounds %struct._CodeRef* %17, i32 0, i32 1
  %18 = load i64 (%struct._Array*)** %code, align 8
  ret i64 (%struct._Array*)* %18
}
...
if.then:                                          ; preds = %do.body
  ...
  call void @__assert_rtn(i8* getelementptr inbounds ([33 x i8]* @__func__.dynamic_blessed_object_cast_code, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8]* @.str1, i32 0, i32 0), i32 892, i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0)) #7
  unreachable
...
entrypoint:
  ...
  %ivalue1 = alloca %union.UnionType
  %union_to_int_ptr2 = bitcast %union.UnionType* %ivalue1 to i64*
  store i64 -4222124650659835, i64* %union_to_int_ptr2
  %ivalue3 = alloca %union.UnionType
  %union_to_int_ptr4 = bitcast %union.UnionType* %ivalue3 to i64*
  store i64 -4222124650659834, i64* %union_to_int_ptr4
  %ivalue5 = alloca %union.UnionType
  %union_to_int_ptr6 = bitcast %union.UnionType* %ivalue5 to i64*
  store i64 -4222124650659833, i64* %union_to_int_ptr6
  %elems = alloca %union.UnionType*, i64 3
  %load_elem587 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %ivalue1, %union.UnionType** %load_elem587
  %load_elem7 = getelementptr %union.UnionType** %elems, i64 1
  store %union.UnionType* %ivalue3, %union.UnionType** %load_elem7
  %load_elem8 = getelementptr %union.UnionType** %elems, i64 2
  store %union.UnionType* %ivalue5, %union.UnionType** %load_elem8
  ...
  %array_type588 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  ...
  store i32 3, i32* %array_type588
  store %union.UnionType** %elems, %union.UnionType*** %array_list
  store i64 3, i64* %array_size
  ...
  %or9 = or i64 %or, 844424930131968
  %bitcast = bitcast %union.UnionType* %base_ptr to i64*
  store i64 %or9, i64* %bitcast
  %fetched_object10 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr = bitcast %Object* %fetched_object10 to %ArrayRef*
  %array_ref_type589 = bitcast %ArrayRef* %cast_to_array_ref_ptr to i32*
  %array_ref_body = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr, i32 0, i32 1
  store i32 4, i32* %array_ref_type589
  %load_array_body = load %union.UnionType* %base_ptr
  store %union.UnionType %load_array_body, %union.UnionType* %array_ref_body
  %base_ptr11 = alloca %union.UnionType
  %union_ptr_to_int12 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr to i64
  %or13 = or i64 %union_ptr_to_int12, -4503599627370496
  %or14 = or i64 %or13, 1125899906842624
  %bitcast15 = bitcast %union.UnionType* %base_ptr11 to i64*
  store i64 %or14, i64* %bitcast15
  %ivalue16 = alloca %union.UnionType
  %union_to_int_ptr17 = bitcast %union.UnionType* %ivalue16 to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr17
  %ivalue18 = alloca %union.UnionType
  %union_to_int_ptr19 = bitcast %union.UnionType* %ivalue18 to i64*
  store i64 -4222124650659836, i64* %union_to_int_ptr19
  %elems20 = alloca %union.UnionType*, i64 4
  %load_elem21590 = bitcast %union.UnionType** %elems20 to %union.UnionType**
  store %union.UnionType* %ivalue, %union.UnionType** %load_elem21590
  %load_elem22 = getelementptr %union.UnionType** %elems20, i64 1
  store %union.UnionType* %base_ptr11, %union.UnionType** %load_elem22
  %load_elem23 = getelementptr %union.UnionType** %elems20, i64 2
  store %union.UnionType* %ivalue16, %union.UnionType** %load_elem23
  %load_elem24 = getelementptr %union.UnionType** %elems20, i64 3
  store %union.UnionType* %ivalue18, %union.UnionType** %load_elem24
  %fetched_object25 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr26 = bitcast %Object* %fetched_object25 to %ArrayObject*
  %array_type27591 = bitcast %ArrayObject* %cast_to_array_ptr26 to i32*
  %array_list28 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr26, i32 0, i32 1
  %array_size29 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr26, i32 0, i32 2
  store i32 3, i32* %array_type27591
  store %union.UnionType** %elems20, %union.UnionType*** %array_list28
  store i64 4, i64* %array_size29
  %base_ptr30 = alloca %union.UnionType
  %union_ptr_to_int31 = ptrtoint %ArrayObject* %cast_to_array_ptr26 to i64
  %or32 = or i64 %union_ptr_to_int31, -4503599627370496
  %or33 = or i64 %or32, 844424930131968
  %bitcast34 = bitcast %union.UnionType* %base_ptr30 to i64*
  store i64 %or33, i64* %bitcast34
  %fetched_object35 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr36 = bitcast %Object* %fetched_object35 to %ArrayRef*
  %array_ref_type37592 = bitcast %ArrayRef* %cast_to_array_ref_ptr36 to i32*
  %array_ref_body38 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr36, i32 0, i32 1
  store i32 4, i32* %array_ref_type37592
  %load_array_body39 = load %union.UnionType* %base_ptr30
  store %union.UnionType %load_array_body39, %union.UnionType* %array_ref_body38
  %base_ptr40 = alloca %union.UnionType
  %union_ptr_to_int41 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr36 to i64
  %or42 = or i64 %union_ptr_to_int41, -4503599627370496
  %or43 = or i64 %or42, 1125899906842624
  %bitcast44 = bitcast %union.UnionType* %base_ptr40 to i64*
  store i64 %or43, i64* %bitcast44
  %load_value = load %union.UnionType* %base_ptr40
  store %union.UnionType %load_value, %union.UnionType* @global_value
  %load_value45 = load %union.UnionType* @global_value
  store %union.UnionType %load_value45, %union.UnionType* @global_value1
  %args = alloca %union.UnionType*
  %get_idx593 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* @global_value, %union.UnionType** %get_idx593
  %array = alloca %ArrayObject
  %array_type46594 = bitcast %ArrayObject* %array to i32*
  %array_list47 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 1
  %array_size48 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 2
  store i32 3, i32* %array_type46594
  store %union.UnionType** %args, %union.UnionType*** %array_list47
  store i64 1, i64* %array_size48
  %result = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array)
  %union_storage = alloca %union.UnionType
  %cast_to_double_ptr595 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr595 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %args49 = alloca %union.UnionType*
  %get_idx50596 = bitcast %union.UnionType** %args49 to %union.UnionType**
  store %union.UnionType* @global_value1, %union.UnionType** %get_idx50596
  %array51 = alloca %ArrayObject
  %array_type52597 = bitcast %ArrayObject* %array51 to i32*
  ...
  store i32 3, i32* %array_type52597
  store %union.UnionType** %args49, %union.UnionType*** %array_list53
  store i64 1, i64* %array_size54
  %result55 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array51)
  %union_storage56 = alloca %union.UnionType
  %cast_to_double_ptr57598 = bitcast %union.UnionType* %union_storage56 to double*
  %cast_to_int_ptr58 = bitcast double* %cast_to_double_ptr57598 to i64*
  store i64 %result55, i64* %cast_to_int_ptr58
  %args59 = alloca %union.UnionType*
  %load_ivalue = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor = xor i64 %load_ivalue, -3377699720527872
  %int_to_ptr = inttoptr i64 %xor to %ArrayRef*
  %arrayref_body = getelementptr inbounds %ArrayRef* %int_to_ptr, i32 0, i32 1
  %get_idx60599 = bitcast %union.UnionType** %args59 to %union.UnionType**
  store %union.UnionType* %arrayref_body, %union.UnionType** %get_idx60599
  %array61 = alloca %ArrayObject
  %array_type62600 = bitcast %ArrayObject* %array61 to i32*
  %array_list63 = getelementptr inbounds %ArrayObject* %array61, i32 0, i32 1
  %array_size64 = getelementptr inbounds %ArrayObject* %array61, i32 0, i32 2
  store i32 3, i32* %array_type62600
  store %union.UnionType** %args59, %union.UnionType*** %array_list63
  store i64 1, i64* %array_size64
  %result65 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array61)
  %union_storage66 = alloca %union.UnionType
  %cast_to_double_ptr67601 = bitcast %union.UnionType* %union_storage66 to double*
  %cast_to_int_ptr68 = bitcast double* %cast_to_double_ptr67601 to i64*
  store i64 %result65, i64* %cast_to_int_ptr68
  %args69 = alloca %union.UnionType*
  %ivalue70 = alloca %union.UnionType
  %union_to_int_ptr71 = bitcast %union.UnionType* %ivalue70 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr71
  %elems72 = alloca %union.UnionType*
  %load_elem73602 = bitcast %union.UnionType** %elems72 to %union.UnionType**
  store %union.UnionType* %ivalue70, %union.UnionType** %load_elem73602
  %fetched_object74 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr75 = bitcast %Object* %fetched_object74 to %ArrayObject*
  %array_type76603 = bitcast %ArrayObject* %cast_to_array_ptr75 to i32*
  %array_list77 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr75, i32 0, i32 1
  %array_size78 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr75, i32 0, i32 2
  store i32 3, i32* %array_type76603
  store %union.UnionType** %elems72, %union.UnionType*** %array_list77
  store i64 1, i64* %array_size78
  %base_ptr79 = alloca %union.UnionType
  %union_ptr_to_int80 = ptrtoint %ArrayObject* %cast_to_array_ptr75 to i64
  %or81 = or i64 %union_ptr_to_int80, -4503599627370496
  %or82 = or i64 %or81, 844424930131968
  %bitcast83 = bitcast %union.UnionType* %base_ptr79 to i64*
  store i64 %or82, i64* %bitcast83
  %fetched_object84 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr85 = bitcast %Object* %fetched_object84 to %ArrayRef*
  %array_ref_type86604 = bitcast %ArrayRef* %cast_to_array_ref_ptr85 to i32*
  %array_ref_body87 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr85, i32 0, i32 1
  store i32 4, i32* %array_ref_type86604
  %load_array_body88 = load %union.UnionType* %base_ptr79
  store %union.UnionType %load_array_body88, %union.UnionType* %array_ref_body87
  %base_ptr89 = alloca %union.UnionType
  %union_ptr_to_int90 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr85 to i64
  %or91 = or i64 %union_ptr_to_int90, -4503599627370496
  %or92 = or i64 %or91, 1125899906842624
  %bitcast93 = bitcast %union.UnionType* %base_ptr89 to i64*
  store i64 %or92, i64* %bitcast93
  %load_ivalue94 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor95 = xor i64 %load_ivalue94, -3377699720527872
  %int_to_ptr96 = inttoptr i64 %xor95 to %ArrayRef*
  %bitcast97 = bitcast %union.UnionType* %base_ptr89 to i64*
  %load_ivalue98 = load i64* %bitcast97
  %xor99 = xor i64 %load_ivalue98, -3377699720527872
  %int_to_ptr100 = inttoptr i64 %xor99 to %ArrayRef*
  %arrayref_body101 = getelementptr inbounds %ArrayRef* %int_to_ptr100, i32 0, i32 1
  %bitcast102 = bitcast %union.UnionType* %arrayref_body101 to i64*
  %load_ivalue103 = load i64* %bitcast102
  %xor104 = xor i64 %load_ivalue103, -3659174697238528
  %int_to_ptr105 = inttoptr i64 %xor104 to %ArrayObject*
  %Array_get = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr105, i64 0)
  %union_to_int_ptr106 = bitcast %union.UnionType* %Array_get to i64*
  %dereference = load i64* %union_to_int_ptr106
  %trunc_int_cast = trunc i64 %dereference to i32
  %i32_to_i64_cast = sext i32 %trunc_int_cast to i64
  %ArrayRef_get = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* @global_value, i64 %i32_to_i64_cast)
  %get_idx107605 = bitcast %union.UnionType** %args69 to %union.UnionType**
  store %union.UnionType* %ArrayRef_get, %union.UnionType** %get_idx107605
  %array108 = alloca %ArrayObject
  %array_type109606 = bitcast %ArrayObject* %array108 to i32*
  %array_list110 = getelementptr inbounds %ArrayObject* %array108, i32 0, i32 1
  %array_size111 = getelementptr inbounds %ArrayObject* %array108, i32 0, i32 2
  store i32 3, i32* %array_type109606
  store %union.UnionType** %args69, %union.UnionType*** %array_list110
  store i64 1, i64* %array_size111
  %result112 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array108)
  %union_storage113 = alloca %union.UnionType
  %cast_to_double_ptr114607 = bitcast %union.UnionType* %union_storage113 to double*
  %cast_to_int_ptr115 = bitcast double* %cast_to_double_ptr114607 to i64*
  store i64 %result112, i64* %cast_to_int_ptr115
  %ivalue116 = alloca %union.UnionType
  %union_to_int_ptr117 = bitcast %union.UnionType* %ivalue116 to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr117
  %ivalue118 = alloca %union.UnionType
  %union_to_int_ptr119 = bitcast %union.UnionType* %ivalue118 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr119
  %elems120 = alloca %union.UnionType*
  %load_elem121608 = bitcast %union.UnionType** %elems120 to %union.UnionType**
  store %union.UnionType* %ivalue118, %union.UnionType** %load_elem121608
  %fetched_object122 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr123 = bitcast %Object* %fetched_object122 to %ArrayObject*
  %array_type124609 = bitcast %ArrayObject* %cast_to_array_ptr123 to i32*
  %array_list125 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr123, i32 0, i32 1
  %array_size126 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr123, i32 0, i32 2
  store i32 3, i32* %array_type124609
  store %union.UnionType** %elems120, %union.UnionType*** %array_list125
  store i64 1, i64* %array_size126
  %base_ptr127 = alloca %union.UnionType
  %union_ptr_to_int128 = ptrtoint %ArrayObject* %cast_to_array_ptr123 to i64
  %or129 = or i64 %union_ptr_to_int128, -4503599627370496
  %or130 = or i64 %or129, 844424930131968
  %bitcast131 = bitcast %union.UnionType* %base_ptr127 to i64*
  store i64 %or130, i64* %bitcast131
  %fetched_object132 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr133 = bitcast %Object* %fetched_object132 to %ArrayRef*
  %array_ref_type134610 = bitcast %ArrayRef* %cast_to_array_ref_ptr133 to i32*
  %array_ref_body135 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr133, i32 0, i32 1
  store i32 4, i32* %array_ref_type134610
  %load_array_body136 = load %union.UnionType* %base_ptr127
  store %union.UnionType %load_array_body136, %union.UnionType* %array_ref_body135
  %base_ptr137 = alloca %union.UnionType
  %union_ptr_to_int138 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr133 to i64
  %or139 = or i64 %union_ptr_to_int138, -4503599627370496
  %or140 = or i64 %or139, 1125899906842624
  %bitcast141 = bitcast %union.UnionType* %base_ptr137 to i64*
  store i64 %or140, i64* %bitcast141
  %load_ivalue142 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor143 = xor i64 %load_ivalue142, -3377699720527872
  %int_to_ptr144 = inttoptr i64 %xor143 to %ArrayRef*
  %bitcast145 = bitcast %union.UnionType* %base_ptr137 to i64*
  %load_ivalue146 = load i64* %bitcast145
  %xor147 = xor i64 %load_ivalue146, -3377699720527872
  %int_to_ptr148 = inttoptr i64 %xor147 to %ArrayRef*
  %arrayref_body149 = getelementptr inbounds %ArrayRef* %int_to_ptr148, i32 0, i32 1
  %bitcast150 = bitcast %union.UnionType* %arrayref_body149 to i64*
  %load_ivalue151 = load i64* %bitcast150
  %xor152 = xor i64 %load_ivalue151, -3659174697238528
  %int_to_ptr153 = inttoptr i64 %xor152 to %ArrayObject*
  %Array_get154 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr153, i64 0)
  %union_to_int_ptr155 = bitcast %union.UnionType* %Array_get154 to i64*
  %dereference156 = load i64* %union_to_int_ptr155
  %trunc_int_cast157 = trunc i64 %dereference156 to i32
  %i32_to_i64_cast158 = sext i32 %trunc_int_cast157 to i64
  %ArrayRef_get159 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* @global_value, i64 %i32_to_i64_cast158)
  %load_value160 = load %union.UnionType* %ivalue116
  store %union.UnionType %load_value160, %union.UnionType* %ArrayRef_get159
  %args161 = alloca %union.UnionType*
  %load_ivalue162 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor163 = xor i64 %load_ivalue162, -3377699720527872
  %int_to_ptr164 = inttoptr i64 %xor163 to %ArrayRef*
  %arrayref_body165 = getelementptr inbounds %ArrayRef* %int_to_ptr164, i32 0, i32 1
  %get_idx166611 = bitcast %union.UnionType** %args161 to %union.UnionType**
  store %union.UnionType* %arrayref_body165, %union.UnionType** %get_idx166611
  %array167 = alloca %ArrayObject
  %array_type168612 = bitcast %ArrayObject* %array167 to i32*
  %array_list169 = getelementptr inbounds %ArrayObject* %array167, i32 0, i32 1
  %array_size170 = getelementptr inbounds %ArrayObject* %array167, i32 0, i32 2
  store i32 3, i32* %array_type168612
  store %union.UnionType** %args161, %union.UnionType*** %array_list169
  store i64 1, i64* %array_size170
  %result171 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array167)
  %union_storage172 = alloca %union.UnionType
  %cast_to_double_ptr173613 = bitcast %union.UnionType* %union_storage172 to double*
  %cast_to_int_ptr174 = bitcast double* %cast_to_double_ptr173613 to i64*
  store i64 %result171, i64* %cast_to_int_ptr174
  %args175 = alloca %union.UnionType*
  %ivalue176 = alloca %union.UnionType
  %union_to_int_ptr177 = bitcast %union.UnionType* %ivalue176 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr177
  %elems178 = alloca %union.UnionType*
  %load_elem179614 = bitcast %union.UnionType** %elems178 to %union.UnionType**
  store %union.UnionType* %ivalue176, %union.UnionType** %load_elem179614
  %fetched_object180 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr181 = bitcast %Object* %fetched_object180 to %ArrayObject*
  %array_type182615 = bitcast %ArrayObject* %cast_to_array_ptr181 to i32*
  %array_list183 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr181, i32 0, i32 1
  %array_size184 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr181, i32 0, i32 2
  store i32 3, i32* %array_type182615
  store %union.UnionType** %elems178, %union.UnionType*** %array_list183
  store i64 1, i64* %array_size184
  %base_ptr185 = alloca %union.UnionType
  %union_ptr_to_int186 = ptrtoint %ArrayObject* %cast_to_array_ptr181 to i64
  %or187 = or i64 %union_ptr_to_int186, -4503599627370496
  %or188 = or i64 %or187, 844424930131968
  %bitcast189 = bitcast %union.UnionType* %base_ptr185 to i64*
  store i64 %or188, i64* %bitcast189
  %fetched_object190 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr191 = bitcast %Object* %fetched_object190 to %ArrayRef*
  %array_ref_type192616 = bitcast %ArrayRef* %cast_to_array_ref_ptr191 to i32*
  %array_ref_body193 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr191, i32 0, i32 1
  store i32 4, i32* %array_ref_type192616
  %load_array_body194 = load %union.UnionType* %base_ptr185
  store %union.UnionType %load_array_body194, %union.UnionType* %array_ref_body193
  %base_ptr195 = alloca %union.UnionType
  %union_ptr_to_int196 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr191 to i64
  %or197 = or i64 %union_ptr_to_int196, -4503599627370496
  %or198 = or i64 %or197, 1125899906842624
  %bitcast199 = bitcast %union.UnionType* %base_ptr195 to i64*
  store i64 %or198, i64* %bitcast199
  %load_ivalue200 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor201 = xor i64 %load_ivalue200, -3377699720527872
  %int_to_ptr202 = inttoptr i64 %xor201 to %ArrayRef*
  %bitcast203 = bitcast %union.UnionType* %base_ptr195 to i64*
  %load_ivalue204 = load i64* %bitcast203
  %xor205 = xor i64 %load_ivalue204, -3377699720527872
  %int_to_ptr206 = inttoptr i64 %xor205 to %ArrayRef*
  %arrayref_body207 = getelementptr inbounds %ArrayRef* %int_to_ptr206, i32 0, i32 1
  %bitcast208 = bitcast %union.UnionType* %arrayref_body207 to i64*
  %load_ivalue209 = load i64* %bitcast208
  %xor210 = xor i64 %load_ivalue209, -3659174697238528
  %int_to_ptr211 = inttoptr i64 %xor210 to %ArrayObject*
  %Array_get212 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr211, i64 0)
  %union_to_int_ptr213 = bitcast %union.UnionType* %Array_get212 to i64*
  %dereference214 = load i64* %union_to_int_ptr213
  %trunc_int_cast215 = trunc i64 %dereference214 to i32
  %i32_to_i64_cast216 = sext i32 %trunc_int_cast215 to i64
  %ArrayRef_get217 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* @global_value, i64 %i32_to_i64_cast216)
  %get_idx218617 = bitcast %union.UnionType** %args175 to %union.UnionType**
  store %union.UnionType* %ArrayRef_get217, %union.UnionType** %get_idx218617
  %array219 = alloca %ArrayObject
  %array_type220618 = bitcast %ArrayObject* %array219 to i32*
  %array_list221 = getelementptr inbounds %ArrayObject* %array219, i32 0, i32 1
  %array_size222 = getelementptr inbounds %ArrayObject* %array219, i32 0, i32 2
  store i32 3, i32* %array_type220618
  store %union.UnionType** %args175, %union.UnionType*** %array_list221
  store i64 1, i64* %array_size222
  %result223 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array219)
  %union_storage224 = alloca %union.UnionType
  %cast_to_double_ptr225619 = bitcast %union.UnionType* %union_storage224 to double*
  %cast_to_int_ptr226 = bitcast double* %cast_to_double_ptr225619 to i64*
  store i64 %result223, i64* %cast_to_int_ptr226
  %ivalue227 = alloca %union.UnionType
  %union_to_int_ptr228 = bitcast %union.UnionType* %ivalue227 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr228
  %elems229 = alloca %union.UnionType*
  %load_elem230620 = bitcast %union.UnionType** %elems229 to %union.UnionType**
  store %union.UnionType* %ivalue227, %union.UnionType** %load_elem230620
  %fetched_object231 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr232 = bitcast %Object* %fetched_object231 to %ArrayObject*
  %array_type233621 = bitcast %ArrayObject* %cast_to_array_ptr232 to i32*
  %array_list234 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr232, i32 0, i32 1
  %array_size235 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr232, i32 0, i32 2
  store i32 3, i32* %array_type233621
  store %union.UnionType** %elems229, %union.UnionType*** %array_list234
  store i64 1, i64* %array_size235
  %base_ptr236 = alloca %union.UnionType
  %union_ptr_to_int237 = ptrtoint %ArrayObject* %cast_to_array_ptr232 to i64
  %or238 = or i64 %union_ptr_to_int237, -4503599627370496
  %or239 = or i64 %or238, 844424930131968
  %bitcast240 = bitcast %union.UnionType* %base_ptr236 to i64*
  store i64 %or239, i64* %bitcast240
  %fetched_object241 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr242 = bitcast %Object* %fetched_object241 to %ArrayRef*
  %array_ref_type243622 = bitcast %ArrayRef* %cast_to_array_ref_ptr242 to i32*
  %array_ref_body244 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr242, i32 0, i32 1
  store i32 4, i32* %array_ref_type243622
  %load_array_body245 = load %union.UnionType* %base_ptr236
  store %union.UnionType %load_array_body245, %union.UnionType* %array_ref_body244
  %base_ptr246 = alloca %union.UnionType
  %union_ptr_to_int247 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr242 to i64
  %or248 = or i64 %union_ptr_to_int247, -4503599627370496
  %or249 = or i64 %or248, 1125899906842624
  %bitcast250 = bitcast %union.UnionType* %base_ptr246 to i64*
  store i64 %or249, i64* %bitcast250
  %load_ivalue251 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor252 = xor i64 %load_ivalue251, -3377699720527872
  %int_to_ptr253 = inttoptr i64 %xor252 to %ArrayRef*
  %bitcast254 = bitcast %union.UnionType* %base_ptr246 to i64*
  %load_ivalue255 = load i64* %bitcast254
  %xor256 = xor i64 %load_ivalue255, -3377699720527872
  %int_to_ptr257 = inttoptr i64 %xor256 to %ArrayRef*
  %arrayref_body258 = getelementptr inbounds %ArrayRef* %int_to_ptr257, i32 0, i32 1
  %bitcast259 = bitcast %union.UnionType* %arrayref_body258 to i64*
  %load_ivalue260 = load i64* %bitcast259
  %xor261 = xor i64 %load_ivalue260, -3659174697238528
  %int_to_ptr262 = inttoptr i64 %xor261 to %ArrayObject*
  %Array_get263 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr262, i64 0)
  %union_to_int_ptr264 = bitcast %union.UnionType* %Array_get263 to i64*
  %dereference265 = load i64* %union_to_int_ptr264
  %trunc_int_cast266 = trunc i64 %dereference265 to i32
  %i32_to_i64_cast267 = sext i32 %trunc_int_cast266 to i64
  %ArrayRef_get268 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* @global_value, i64 %i32_to_i64_cast267)
  %"$c" = alloca %Object
  %object_body = getelementptr inbounds %Object* %"$c", i32 0, i32 1
  %load_value269 = load %union.UnionType* %ArrayRef_get268
  store %union.UnionType %load_value269, %union.UnionType* %object_body
  %base_ptr270 = alloca %union.UnionType
  %union_ptr_to_int271 = ptrtoint %Object* %"$c" to i64
  %or272 = or i64 %union_ptr_to_int271, -4503599627370496
  %or273 = or i64 %or272, 1970324836974592
  %bitcast274 = bitcast %union.UnionType* %base_ptr270 to i64*
  store i64 %or273, i64* %bitcast274
  %load_value275 = load %union.UnionType* %base_ptr270
  store %union.UnionType %load_value275, %union.UnionType* @global_value2
  %args276 = alloca %union.UnionType*
  %load_ivalue277 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  %xor278 = xor i64 %load_ivalue277, -2533274790395904
  %int_to_ptr279 = inttoptr i64 %xor278 to %Object*
  %object_body280 = getelementptr inbounds %Object* %int_to_ptr279, i32 0, i32 1
  %get_idx281623 = bitcast %union.UnionType** %args276 to %union.UnionType**
  store %union.UnionType* %object_body280, %union.UnionType** %get_idx281623
  %array282 = alloca %ArrayObject
  %array_type283624 = bitcast %ArrayObject* %array282 to i32*
  %array_list284 = getelementptr inbounds %ArrayObject* %array282, i32 0, i32 1
  %array_size285 = getelementptr inbounds %ArrayObject* %array282, i32 0, i32 2
  store i32 3, i32* %array_type283624
  store %union.UnionType** %args276, %union.UnionType*** %array_list284
  store i64 1, i64* %array_size285
  %result286 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array282)
  %union_storage287 = alloca %union.UnionType
  %cast_to_double_ptr288625 = bitcast %union.UnionType* %union_storage287 to double*
  %cast_to_int_ptr289 = bitcast double* %cast_to_double_ptr288625 to i64*
  store i64 %result286, i64* %cast_to_int_ptr289
  %args290 = alloca %union.UnionType*
  %load_ivalue291 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  %xor292 = xor i64 %load_ivalue291, -2533274790395904
  %int_to_ptr293 = inttoptr i64 %xor292 to %Object*
  %object_body294 = getelementptr inbounds %Object* %int_to_ptr293, i32 0, i32 1
  %bitcast295 = bitcast %union.UnionType* %object_body294 to i64*
  %load_ivalue296 = load i64* %bitcast295
  %xor297 = xor i64 %load_ivalue296, -3377699720527872
  %int_to_ptr298 = inttoptr i64 %xor297 to %ArrayRef*
  %arrayref_body299 = getelementptr inbounds %ArrayRef* %int_to_ptr298, i32 0, i32 1
  %get_idx300626 = bitcast %union.UnionType** %args290 to %union.UnionType**
  store %union.UnionType* %arrayref_body299, %union.UnionType** %get_idx300626
  %array301 = alloca %ArrayObject
  %array_type302627 = bitcast %ArrayObject* %array301 to i32*
  %array_list303 = getelementptr inbounds %ArrayObject* %array301, i32 0, i32 1
  %array_size304 = getelementptr inbounds %ArrayObject* %array301, i32 0, i32 2
  store i32 3, i32* %array_type302627
  store %union.UnionType** %args290, %union.UnionType*** %array_list303
  store i64 1, i64* %array_size304
  %result305 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array301)
  %union_storage306 = alloca %union.UnionType
  %cast_to_double_ptr307628 = bitcast %union.UnionType* %union_storage306 to double*
  %cast_to_int_ptr308 = bitcast double* %cast_to_double_ptr307628 to i64*
  store i64 %result305, i64* %cast_to_int_ptr308
  %args309 = alloca %union.UnionType*
  %load_ivalue310 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  %xor311 = xor i64 %load_ivalue310, -2533274790395904
  %int_to_ptr312 = inttoptr i64 %xor311 to %Object*
  %object_body313 = getelementptr inbounds %Object* %int_to_ptr312, i32 0, i32 1
  %ivalue314 = alloca %union.UnionType
  %union_to_int_ptr315 = bitcast %union.UnionType* %ivalue314 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr315
  %elems316 = alloca %union.UnionType*
  %load_elem317629 = bitcast %union.UnionType** %elems316 to %union.UnionType**
  store %union.UnionType* %ivalue314, %union.UnionType** %load_elem317629
  %fetched_object318 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr319 = bitcast %Object* %fetched_object318 to %ArrayObject*
  %array_type320630 = bitcast %ArrayObject* %cast_to_array_ptr319 to i32*
  %array_list321 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr319, i32 0, i32 1
  %array_size322 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr319, i32 0, i32 2
  store i32 3, i32* %array_type320630
  store %union.UnionType** %elems316, %union.UnionType*** %array_list321
  store i64 1, i64* %array_size322
  %base_ptr323 = alloca %union.UnionType
  %union_ptr_to_int324 = ptrtoint %ArrayObject* %cast_to_array_ptr319 to i64
  %or325 = or i64 %union_ptr_to_int324, -4503599627370496
  %or326 = or i64 %or325, 844424930131968
  %bitcast327 = bitcast %union.UnionType* %base_ptr323 to i64*
  store i64 %or326, i64* %bitcast327
  %fetched_object328 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr329 = bitcast %Object* %fetched_object328 to %ArrayRef*
  %array_ref_type330631 = bitcast %ArrayRef* %cast_to_array_ref_ptr329 to i32*
  %array_ref_body331 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr329, i32 0, i32 1
  store i32 4, i32* %array_ref_type330631
  %load_array_body332 = load %union.UnionType* %base_ptr323
  store %union.UnionType %load_array_body332, %union.UnionType* %array_ref_body331
  %base_ptr333 = alloca %union.UnionType
  %union_ptr_to_int334 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr329 to i64
  %or335 = or i64 %union_ptr_to_int334, -4503599627370496
  %or336 = or i64 %or335, 1125899906842624
  %bitcast337 = bitcast %union.UnionType* %base_ptr333 to i64*
  store i64 %or336, i64* %bitcast337
  %bitcast338 = bitcast %union.UnionType* %base_ptr333 to i64*
  %load_ivalue339 = load i64* %bitcast338
  %xor340 = xor i64 %load_ivalue339, -3377699720527872
  %int_to_ptr341 = inttoptr i64 %xor340 to %ArrayRef*
  %arrayref_body342 = getelementptr inbounds %ArrayRef* %int_to_ptr341, i32 0, i32 1
  %bitcast343 = bitcast %union.UnionType* %arrayref_body342 to i64*
  %load_ivalue344 = load i64* %bitcast343
  %xor345 = xor i64 %load_ivalue344, -3659174697238528
  %int_to_ptr346 = inttoptr i64 %xor345 to %ArrayObject*
  %Array_get347 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr346, i64 0)
  %union_to_int_ptr348 = bitcast %union.UnionType* %Array_get347 to i64*
  %dereference349 = load i64* %union_to_int_ptr348
  %trunc_int_cast350 = trunc i64 %dereference349 to i32
  %i32_to_i64_cast351 = sext i32 %trunc_int_cast350 to i64
  %ArrayRef_get352 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* %object_body313, i64 %i32_to_i64_cast351)
  %get_idx353632 = bitcast %union.UnionType** %args309 to %union.UnionType**
  store %union.UnionType* %ArrayRef_get352, %union.UnionType** %get_idx353632
  %array354 = alloca %ArrayObject
  %array_type355633 = bitcast %ArrayObject* %array354 to i32*
  %array_list356 = getelementptr inbounds %ArrayObject* %array354, i32 0, i32 1
  %array_size357 = getelementptr inbounds %ArrayObject* %array354, i32 0, i32 2
  store i32 3, i32* %array_type355633
  store %union.UnionType** %args309, %union.UnionType*** %array_list356
  store i64 1, i64* %array_size357
  %result358 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array354)
  %union_storage359 = alloca %union.UnionType
  %cast_to_double_ptr360634 = bitcast %union.UnionType* %union_storage359 to double*
  %cast_to_int_ptr361 = bitcast double* %cast_to_double_ptr360634 to i64*
  store i64 %result358, i64* %cast_to_int_ptr361
  %ivalue362 = alloca %union.UnionType
  %union_to_int_ptr363 = bitcast %union.UnionType* %ivalue362 to i64*
  store i64 -4222124650659830, i64* %union_to_int_ptr363
  %load_ivalue364 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  %xor365 = xor i64 %load_ivalue364, -2533274790395904
  %int_to_ptr366 = inttoptr i64 %xor365 to %Object*
  %object_body367 = getelementptr inbounds %Object* %int_to_ptr366, i32 0, i32 1
  %ivalue368 = alloca %union.UnionType
  %union_to_int_ptr369 = bitcast %union.UnionType* %ivalue368 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr369
  %elems370 = alloca %union.UnionType*
  %load_elem371635 = bitcast %union.UnionType** %elems370 to %union.UnionType**
  store %union.UnionType* %ivalue368, %union.UnionType** %load_elem371635
  %fetched_object372 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr373 = bitcast %Object* %fetched_object372 to %ArrayObject*
  %array_type374636 = bitcast %ArrayObject* %cast_to_array_ptr373 to i32*
  %array_list375 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr373, i32 0, i32 1
  %array_size376 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr373, i32 0, i32 2
  store i32 3, i32* %array_type374636
  store %union.UnionType** %elems370, %union.UnionType*** %array_list375
  store i64 1, i64* %array_size376
  %base_ptr377 = alloca %union.UnionType
  %union_ptr_to_int378 = ptrtoint %ArrayObject* %cast_to_array_ptr373 to i64
  %or379 = or i64 %union_ptr_to_int378, -4503599627370496
  %or380 = or i64 %or379, 844424930131968
  %bitcast381 = bitcast %union.UnionType* %base_ptr377 to i64*
  store i64 %or380, i64* %bitcast381
  %fetched_object382 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr383 = bitcast %Object* %fetched_object382 to %ArrayRef*
  %array_ref_type384637 = bitcast %ArrayRef* %cast_to_array_ref_ptr383 to i32*
  %array_ref_body385 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr383, i32 0, i32 1
  store i32 4, i32* %array_ref_type384637
  %load_array_body386 = load %union.UnionType* %base_ptr377
  store %union.UnionType %load_array_body386, %union.UnionType* %array_ref_body385
  %base_ptr387 = alloca %union.UnionType
  %union_ptr_to_int388 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr383 to i64
  %or389 = or i64 %union_ptr_to_int388, -4503599627370496
  %or390 = or i64 %or389, 1125899906842624
  %bitcast391 = bitcast %union.UnionType* %base_ptr387 to i64*
  store i64 %or390, i64* %bitcast391
  %bitcast392 = bitcast %union.UnionType* %base_ptr387 to i64*
  %load_ivalue393 = load i64* %bitcast392
  %xor394 = xor i64 %load_ivalue393, -3377699720527872
  %int_to_ptr395 = inttoptr i64 %xor394 to %ArrayRef*
  %arrayref_body396 = getelementptr inbounds %ArrayRef* %int_to_ptr395, i32 0, i32 1
  %bitcast397 = bitcast %union.UnionType* %arrayref_body396 to i64*
  %load_ivalue398 = load i64* %bitcast397
  %xor399 = xor i64 %load_ivalue398, -3659174697238528
  %int_to_ptr400 = inttoptr i64 %xor399 to %ArrayObject*
  %Array_get401 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr400, i64 0)
  %union_to_int_ptr402 = bitcast %union.UnionType* %Array_get401 to i64*
  %dereference403 = load i64* %union_to_int_ptr402
  %trunc_int_cast404 = trunc i64 %dereference403 to i32
  %i32_to_i64_cast405 = sext i32 %trunc_int_cast404 to i64
  %ArrayRef_get406 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* %object_body367, i64 %i32_to_i64_cast405)
  %load_value407 = load %union.UnionType* %ivalue362
  store %union.UnionType %load_value407, %union.UnionType* %ArrayRef_get406
  %args408 = alloca %union.UnionType*
  %load_ivalue409 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  ...
  %bitcast413 = bitcast %union.UnionType* %object_body412 to i64*
  %load_ivalue414 = load i64* %bitcast413
  %xor415 = xor i64 %load_ivalue414, -3377699720527872
  %int_to_ptr416 = inttoptr i64 %xor415 to %ArrayRef*
  %arrayref_body417 = getelementptr inbounds %ArrayRef* %int_to_ptr416, i32 0, i32 1
  %get_idx418638 = bitcast %union.UnionType** %args408 to %union.UnionType**
  store %union.UnionType* %arrayref_body417, %union.UnionType** %get_idx418638
  %array419 = alloca %ArrayObject
  %array_type420639 = bitcast %ArrayObject* %array419 to i32*
  %array_list421 = getelementptr inbounds %ArrayObject* %array419, i32 0, i32 1
  %array_size422 = getelementptr inbounds %ArrayObject* %array419, i32 0, i32 2
  store i32 3, i32* %array_type420639
  store %union.UnionType** %args408, %union.UnionType*** %array_list421
  store i64 1, i64* %array_size422
  %result423 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array419)
  %union_storage424 = alloca %union.UnionType
  %cast_to_double_ptr425640 = bitcast %union.UnionType* %union_storage424 to double*
  %cast_to_int_ptr426 = bitcast double* %cast_to_double_ptr425640 to i64*
  store i64 %result423, i64* %cast_to_int_ptr426
  %ivalue427 = alloca %union.UnionType
  %union_to_int_ptr428 = bitcast %union.UnionType* %ivalue427 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr428
  %elems429 = alloca %union.UnionType*
  %load_elem430641 = bitcast %union.UnionType** %elems429 to %union.UnionType**
  store %union.UnionType* %ivalue427, %union.UnionType** %load_elem430641
  %fetched_object431 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr432 = bitcast %Object* %fetched_object431 to %ArrayObject*
  %array_type433642 = bitcast %ArrayObject* %cast_to_array_ptr432 to i32*
  %array_list434 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr432, i32 0, i32 1
  %array_size435 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr432, i32 0, i32 2
  store i32 3, i32* %array_type433642
  store %union.UnionType** %elems429, %union.UnionType*** %array_list434
  store i64 1, i64* %array_size435
  %base_ptr436 = alloca %union.UnionType
  %union_ptr_to_int437 = ptrtoint %ArrayObject* %cast_to_array_ptr432 to i64
  %or438 = or i64 %union_ptr_to_int437, -4503599627370496
  %or439 = or i64 %or438, 844424930131968
  %bitcast440 = bitcast %union.UnionType* %base_ptr436 to i64*
  store i64 %or439, i64* %bitcast440
  %fetched_object441 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr442 = bitcast %Object* %fetched_object441 to %ArrayRef*
  %array_ref_type443643 = bitcast %ArrayRef* %cast_to_array_ref_ptr442 to i32*
  %array_ref_body444 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr442, i32 0, i32 1
  store i32 4, i32* %array_ref_type443643
  %load_array_body445 = load %union.UnionType* %base_ptr436
  store %union.UnionType %load_array_body445, %union.UnionType* %array_ref_body444
  %base_ptr446 = alloca %union.UnionType
  %union_ptr_to_int447 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr442 to i64
  %or448 = or i64 %union_ptr_to_int447, -4503599627370496
  %or449 = or i64 %or448, 1125899906842624
  %bitcast450 = bitcast %union.UnionType* %base_ptr446 to i64*
  store i64 %or449, i64* %bitcast450
  %load_ivalue451 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor452 = xor i64 %load_ivalue451, -3377699720527872
  %int_to_ptr453 = inttoptr i64 %xor452 to %ArrayRef*
  %bitcast454 = bitcast %union.UnionType* %base_ptr446 to i64*
  %load_ivalue455 = load i64* %bitcast454
  %xor456 = xor i64 %load_ivalue455, -3377699720527872
  %int_to_ptr457 = inttoptr i64 %xor456 to %ArrayRef*
  %arrayref_body458 = getelementptr inbounds %ArrayRef* %int_to_ptr457, i32 0, i32 1
  %bitcast459 = bitcast %union.UnionType* %arrayref_body458 to i64*
  %load_ivalue460 = load i64* %bitcast459
  %xor461 = xor i64 %load_ivalue460, -3659174697238528
  %int_to_ptr462 = inttoptr i64 %xor461 to %ArrayObject*
  %Array_get463 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr462, i64 0)
  %union_to_int_ptr464 = bitcast %union.UnionType* %Array_get463 to i64*
  %dereference465 = load i64* %union_to_int_ptr464
  %trunc_int_cast466 = trunc i64 %dereference465 to i32
  %i32_to_i64_cast467 = sext i32 %trunc_int_cast466 to i64
  %ArrayRef_get468 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* @global_value, i64 %i32_to_i64_cast467)
  %"$d" = alloca %Object
  %object_body469 = getelementptr inbounds %Object* %"$d", i32 0, i32 1
  %load_value470 = load %union.UnionType* %ArrayRef_get468
  store %union.UnionType %load_value470, %union.UnionType* %object_body469
  %base_ptr471 = alloca %union.UnionType
  %union_ptr_to_int472 = ptrtoint %Object* %"$d" to i64
  %or473 = or i64 %union_ptr_to_int472, -4503599627370496
  %or474 = or i64 %or473, 1970324836974592
  %bitcast475 = bitcast %union.UnionType* %base_ptr471 to i64*
  store i64 %or474, i64* %bitcast475
  %load_value476 = load %union.UnionType* %base_ptr471
  store %union.UnionType %load_value476, %union.UnionType* @global_value3
  %args477 = alloca %union.UnionType*
  %load_ivalue478 = load i64* bitcast (%union.UnionType* @global_value3 to i64*)
  %xor479 = xor i64 %load_ivalue478, -2533274790395904
  %int_to_ptr480 = inttoptr i64 %xor479 to %Object*
  %object_body481 = getelementptr inbounds %Object* %int_to_ptr480, i32 0, i32 1
  %bitcast482 = bitcast %union.UnionType* %object_body481 to i64*
  %load_ivalue483 = load i64* %bitcast482
  %xor484 = xor i64 %load_ivalue483, -3377699720527872
  %int_to_ptr485 = inttoptr i64 %xor484 to %ArrayRef*
  %arrayref_body486 = getelementptr inbounds %ArrayRef* %int_to_ptr485, i32 0, i32 1
  %get_idx487644 = bitcast %union.UnionType** %args477 to %union.UnionType**
  store %union.UnionType* %arrayref_body486, %union.UnionType** %get_idx487644
  %array488 = alloca %ArrayObject
  %array_type489645 = bitcast %ArrayObject* %array488 to i32*
  %array_list490 = getelementptr inbounds %ArrayObject* %array488, i32 0, i32 1
  %array_size491 = getelementptr inbounds %ArrayObject* %array488, i32 0, i32 2
  store i32 3, i32* %array_type489645
  store %union.UnionType** %args477, %union.UnionType*** %array_list490
  store i64 1, i64* %array_size491
  %result492 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array488)
  %union_storage493 = alloca %union.UnionType
  %cast_to_double_ptr494646 = bitcast %union.UnionType* %union_storage493 to double*
  %cast_to_int_ptr495 = bitcast double* %cast_to_double_ptr494646 to i64*
  store i64 %result492, i64* %cast_to_int_ptr495
  %args496 = alloca %union.UnionType*
  %ivalue497 = alloca %union.UnionType
  %union_to_int_ptr498 = bitcast %union.UnionType* %ivalue497 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr498
  %elems499 = alloca %union.UnionType*
  %load_elem500647 = bitcast %union.UnionType** %elems499 to %union.UnionType**
  store %union.UnionType* %ivalue497, %union.UnionType** %load_elem500647
  %fetched_object501 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr502 = bitcast %Object* %fetched_object501 to %ArrayObject*
  %array_type503648 = bitcast %ArrayObject* %cast_to_array_ptr502 to i32*
  %array_list504 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr502, i32 0, i32 1
  %array_size505 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr502, i32 0, i32 2
  store i32 3, i32* %array_type503648
  store %union.UnionType** %elems499, %union.UnionType*** %array_list504
  store i64 1, i64* %array_size505
  %base_ptr506 = alloca %union.UnionType
  %union_ptr_to_int507 = ptrtoint %ArrayObject* %cast_to_array_ptr502 to i64
  %or508 = or i64 %union_ptr_to_int507, -4503599627370496
  %or509 = or i64 %or508, 844424930131968
  %bitcast510 = bitcast %union.UnionType* %base_ptr506 to i64*
  store i64 %or509, i64* %bitcast510
  %fetched_object511 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr512 = bitcast %Object* %fetched_object511 to %ArrayRef*
  %array_ref_type513649 = bitcast %ArrayRef* %cast_to_array_ref_ptr512 to i32*
  %array_ref_body514 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr512, i32 0, i32 1
  store i32 4, i32* %array_ref_type513649
  %load_array_body515 = load %union.UnionType* %base_ptr506
  store %union.UnionType %load_array_body515, %union.UnionType* %array_ref_body514
  %base_ptr516 = alloca %union.UnionType
  %union_ptr_to_int517 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr512 to i64
  %or518 = or i64 %union_ptr_to_int517, -4503599627370496
  %or519 = or i64 %or518, 1125899906842624
  %bitcast520 = bitcast %union.UnionType* %base_ptr516 to i64*
  store i64 %or519, i64* %bitcast520
  %load_ivalue521 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor522 = xor i64 %load_ivalue521, -3377699720527872
  %int_to_ptr523 = inttoptr i64 %xor522 to %ArrayRef*
  %bitcast524 = bitcast %union.UnionType* %base_ptr516 to i64*
  %load_ivalue525 = load i64* %bitcast524
  %xor526 = xor i64 %load_ivalue525, -3377699720527872
  %int_to_ptr527 = inttoptr i64 %xor526 to %ArrayRef*
  %arrayref_body528 = getelementptr inbounds %ArrayRef* %int_to_ptr527, i32 0, i32 1
  %bitcast529 = bitcast %union.UnionType* %arrayref_body528 to i64*
  %load_ivalue530 = load i64* %bitcast529
  %xor531 = xor i64 %load_ivalue530, -3659174697238528
  %int_to_ptr532 = inttoptr i64 %xor531 to %ArrayObject*
  %Array_get533 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr532, i64 0)
  %union_to_int_ptr534 = bitcast %union.UnionType* %Array_get533 to i64*
  %dereference535 = load i64* %union_to_int_ptr534
  %trunc_int_cast536 = trunc i64 %dereference535 to i32
  %i32_to_i64_cast537 = sext i32 %trunc_int_cast536 to i64
  %ArrayRef_get538 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* @global_value, i64 %i32_to_i64_cast537)
  %ivalue539 = alloca %union.UnionType
  %union_to_int_ptr540 = bitcast %union.UnionType* %ivalue539 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr540
  %elems541 = alloca %union.UnionType*
  %load_elem542650 = bitcast %union.UnionType** %elems541 to %union.UnionType**
  store %union.UnionType* %ivalue539, %union.UnionType** %load_elem542650
  %fetched_object543 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr544 = bitcast %Object* %fetched_object543 to %ArrayObject*
  %array_type545651 = bitcast %ArrayObject* %cast_to_array_ptr544 to i32*
  %array_list546 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr544, i32 0, i32 1
  %array_size547 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr544, i32 0, i32 2
  store i32 3, i32* %array_type545651
  store %union.UnionType** %elems541, %union.UnionType*** %array_list546
  store i64 1, i64* %array_size547
  %base_ptr548 = alloca %union.UnionType
  %union_ptr_to_int549 = ptrtoint %ArrayObject* %cast_to_array_ptr544 to i64
  %or550 = or i64 %union_ptr_to_int549, -4503599627370496
  %or551 = or i64 %or550, 844424930131968
  %bitcast552 = bitcast %union.UnionType* %base_ptr548 to i64*
  store i64 %or551, i64* %bitcast552
  %fetched_object553 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr554 = bitcast %Object* %fetched_object553 to %ArrayRef*
  %array_ref_type555652 = bitcast %ArrayRef* %cast_to_array_ref_ptr554 to i32*
  %array_ref_body556 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr554, i32 0, i32 1
  store i32 4, i32* %array_ref_type555652
  %load_array_body557 = load %union.UnionType* %base_ptr548
  store %union.UnionType %load_array_body557, %union.UnionType* %array_ref_body556
  %base_ptr558 = alloca %union.UnionType
  %union_ptr_to_int559 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr554 to i64
  %or560 = or i64 %union_ptr_to_int559, -4503599627370496
  %or561 = or i64 %or560, 1125899906842624
  %bitcast562 = bitcast %union.UnionType* %base_ptr558 to i64*
  store i64 %or561, i64* %bitcast562
  %bitcast563 = bitcast %union.UnionType* %base_ptr558 to i64*
  %load_ivalue564 = load i64* %bitcast563
  %xor565 = xor i64 %load_ivalue564, -3377699720527872
  %int_to_ptr566 = inttoptr i64 %xor565 to %ArrayRef*
  %arrayref_body567 = getelementptr inbounds %ArrayRef* %int_to_ptr566, i32 0, i32 1
  %bitcast568 = bitcast %union.UnionType* %arrayref_body567 to i64*
  %load_ivalue569 = load i64* %bitcast568
  %xor570 = xor i64 %load_ivalue569, -3659174697238528
  %int_to_ptr571 = inttoptr i64 %xor570 to %ArrayObject*
  %Array_get572 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr571, i64 0)
  %union_to_int_ptr573 = bitcast %union.UnionType* %Array_get572 to i64*
  %dereference574 = load i64* %union_to_int_ptr573
  %trunc_int_cast575 = trunc i64 %dereference574 to i32
  %i32_to_i64_cast576 = sext i32 %trunc_int_cast575 to i64
  %ArrayRef_get577 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* %ArrayRef_get538, i64 %i32_to_i64_cast576)
  %get_idx578653 = bitcast %union.UnionType** %args496 to %union.UnionType**
  store %union.UnionType* %ArrayRef_get577, %union.UnionType** %get_idx578653
  %array579 = alloca %ArrayObject
  %array_type580654 = bitcast %ArrayObject* %array579 to i32*
  %array_list581 = getelementptr inbounds %ArrayObject* %array579, i32 0, i32 1
  %array_size582 = getelementptr inbounds %ArrayObject* %array579, i32 0, i32 2
  store i32 3, i32* %array_type580654
  store %union.UnionType** %args496, %union.UnionType*** %array_list581
  store i64 1, i64* %array_size582
  %result583 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array579)
  %union_storage584 = alloca %union.UnionType
  %cast_to_double_ptr585655 = bitcast %union.UnionType* %union_storage584 to double*
  %cast_to_int_ptr586 = bitcast double* %cast_to_double_ptr585655 to i64*
  store i64 %result583, i64* %cast_to_int_ptr586
  ret i64 0
}
