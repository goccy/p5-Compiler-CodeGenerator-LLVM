...
%CodeRefObject = type { i32, i64 (%ArrayObject*)* }
...
entrypoint:
  ...
  %code_ref = alloca %CodeRefObject
  %code_ref_type66 = bitcast %CodeRefObject* %code_ref to i32*
  %code_ref_body = getelementptr inbounds %CodeRefObject* %code_ref, i32 0, i32 1
  store i32 9, i32* %code_ref_type66
  store i64 (%ArrayObject*)* @f, i64 (%ArrayObject*)** %code_ref_body
  %base_ptr = alloca %union.UnionType
  %union_ptr_to_int = ptrtoint %CodeRefObject* %code_ref to i64
  %or = or i64 %union_ptr_to_int, -4503599627370496
  %or1 = or i64 %or, 2533274790395904
  %bitcast = bitcast %union.UnionType* %base_ptr to i64*
  store i64 %or1, i64* %bitcast
  %"$code" = alloca %Object
  %object_body = getelementptr inbounds %Object* %"$code", i32 0, i32 1
  %load_value = load %union.UnionType* %base_ptr
  store %union.UnionType %load_value, %union.UnionType* %object_body
  %base_ptr2 = alloca %union.UnionType
  %union_ptr_to_int3 = ptrtoint %Object* %"$code" to i64
  ...
  %load_value7 = load %union.UnionType* %base_ptr2
  store %union.UnionType %load_value7, %union.UnionType* @global_value
  ...
  %get_idx67 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body8, %union.UnionType** %get_idx67
  %array = alloca %ArrayObject
  %array_type68 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr69 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr69 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %args9 = alloca %union.UnionType*
  %load_ivalue10 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor11 = xor i64 %load_ivalue10, -2533274790395904
  %int_to_ptr12 = inttoptr i64 %xor11 to %Object*
  %object_body13 = getelementptr inbounds %Object* %int_to_ptr12, i32 0, i32 1
  %bitcast14 = bitcast %union.UnionType* %object_body13 to i64*
  %load_ivalue15 = load i64* %bitcast14
  %xor16 = xor i64 %load_ivalue15, -1970324836974592
  %int_to_ptr17 = inttoptr i64 %xor16 to %CodeRefObject*
  %coderef_body = getelementptr inbounds %CodeRefObject* %int_to_ptr17, i32 0, i32 1
  %0 = load i64 (%ArrayObject*)** %coderef_body
  %args18 = alloca %union.UnionType*
  %ivalue = alloca %union.UnionType
  %union_to_int_ptr = bitcast %union.UnionType* %ivalue to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr
  %get_idx1970 = bitcast %union.UnionType** %args18 to %union.UnionType**
  store %union.UnionType* %ivalue, %union.UnionType** %get_idx1970
  ...
  %array_type2071 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  %array_list21 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr, i32 0, i32 1
  %array_size22 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr, i32 0, i32 2
  store i32 3, i32* %array_type2071
  store %union.UnionType** %args18, %union.UnionType*** %array_list21
  store i64 1, i64* %array_size22
  %1 = call i64 %0(%ArrayObject* %cast_to_array_ptr)
  %union_storage23 = alloca %union.UnionType
  %cast_to_double_ptr2472 = bitcast %union.UnionType* %union_storage23 to double*
  %cast_to_int_ptr25 = bitcast double* %cast_to_double_ptr2472 to i64*
  store i64 %1, i64* %cast_to_int_ptr25
  %get_idx2673 = bitcast %union.UnionType** %args9 to %union.UnionType**
  store %union.UnionType* %union_storage23, %union.UnionType** %get_idx2673
  %array27 = alloca %ArrayObject
  %array_type2874 = bitcast %ArrayObject* %array27 to i32*
  %array_list29 = getelementptr inbounds %ArrayObject* %array27, i32 0, i32 1
  %array_size30 = getelementptr inbounds %ArrayObject* %array27, i32 0, i32 2
  store i32 3, i32* %array_type2874
  store %union.UnionType** %args9, %union.UnionType*** %array_list29
  store i64 1, i64* %array_size30
  %result31 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array27)
  %union_storage32 = alloca %union.UnionType
  %cast_to_double_ptr3375 = bitcast %union.UnionType* %union_storage32 to double*
  %cast_to_int_ptr34 = bitcast double* %cast_to_double_ptr3375 to i64*
  store i64 %result31, i64* %cast_to_int_ptr34
  %args35 = alloca %union.UnionType*
  %load_ivalue36 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor37 = xor i64 %load_ivalue36, -2533274790395904
  %int_to_ptr38 = inttoptr i64 %xor37 to %Object*
  %object_body39 = getelementptr inbounds %Object* %int_to_ptr38, i32 0, i32 1
  %bitcast40 = bitcast %union.UnionType* %object_body39 to i64*
  %load_ivalue41 = load i64* %bitcast40
  %xor42 = xor i64 %load_ivalue41, -1970324836974592
  %int_to_ptr43 = inttoptr i64 %xor42 to %CodeRefObject*
  %coderef_body44 = getelementptr inbounds %CodeRefObject* %int_to_ptr43, i32 0, i32 1
  %2 = load i64 (%ArrayObject*)** %coderef_body44
  %args45 = alloca %union.UnionType*
  %ivalue46 = alloca %union.UnionType
  %union_to_int_ptr47 = bitcast %union.UnionType* %ivalue46 to i64*
  store i64 -4222124650659836, i64* %union_to_int_ptr47
  %get_idx4876 = bitcast %union.UnionType** %args45 to %union.UnionType**
  store %union.UnionType* %ivalue46, %union.UnionType** %get_idx4876
  %fetched_object49 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr50 = bitcast %Object* %fetched_object49 to %ArrayObject*
  %array_type5177 = bitcast %ArrayObject* %cast_to_array_ptr50 to i32*
  %array_list52 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr50, i32 0, i32 1
  %array_size53 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr50, i32 0, i32 2
  store i32 3, i32* %array_type5177
  store %union.UnionType** %args45, %union.UnionType*** %array_list52
  store i64 1, i64* %array_size53
  %3 = call i64 %2(%ArrayObject* %cast_to_array_ptr50)
  %union_storage54 = alloca %union.UnionType
  %cast_to_double_ptr5578 = bitcast %union.UnionType* %union_storage54 to double*
  %cast_to_int_ptr56 = bitcast double* %cast_to_double_ptr5578 to i64*
  store i64 %3, i64* %cast_to_int_ptr56
  %get_idx5779 = bitcast %union.UnionType** %args35 to %union.UnionType**
  store %union.UnionType* %union_storage54, %union.UnionType** %get_idx5779
  %array58 = alloca %ArrayObject
  %array_type5980 = bitcast %ArrayObject* %array58 to i32*
  ...
  store i32 3, i32* %array_type5980
  store %union.UnionType** %args35, %union.UnionType*** %array_list60
  ...
  %cast_to_double_ptr6481 = bitcast %union.UnionType* %union_storage63 to double*
  %cast_to_int_ptr65 = bitcast double* %cast_to_double_ptr6481 to i64*
