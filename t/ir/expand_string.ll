...
@1 = private unnamed_addr constant [13 x i8] c"$a : $b : $c\00"
...
entrypoint:
  ...
  store double 2.345000e+00, double* %cast_to_double_ptr
  %"$b" = alloca %Object
  %object_body3 = getelementptr inbounds %Object* %"$b", i32 0, i32 1
  %load_value4 = load %union.UnionType* %double_ptr
  store %union.UnionType %load_value4, %union.UnionType* %object_body3
  %base_ptr5 = alloca %union.UnionType
  %union_ptr_to_int6 = ptrtoint %Object* %"$b" to i64
  ...
  %load_value10 = load %union.UnionType* %base_ptr5
  store %union.UnionType %load_value10, %union.UnionType* @global_value1
  %string = call i64 @new_String(i8* getelementptr inbounds ([6 x i8]* @0, i32 0, i32 0))
  %union_storage = alloca %union.UnionType
  %cast_to_double_ptr1127 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr1127 to i64*
  store i64 %string, i64* %cast_to_int_ptr
  %"$c" = alloca %Object
  %object_body12 = getelementptr inbounds %Object* %"$c", i32 0, i32 1
  %load_value13 = load %union.UnionType* %union_storage
  store %union.UnionType %load_value13, %union.UnionType* %object_body12
  %base_ptr14 = alloca %union.UnionType
  %union_ptr_to_int15 = ptrtoint %Object* %"$c" to i64
  %or16 = or i64 %union_ptr_to_int15, -4503599627370496
  %or17 = or i64 %or16, 1970324836974592
  %bitcast18 = bitcast %union.UnionType* %base_ptr14 to i64*
  store i64 %or17, i64* %bitcast18
  %load_value19 = load %union.UnionType* %base_ptr14
  store %union.UnionType %load_value19, %union.UnionType* @global_value2
  %args = alloca %union.UnionType*
  %string20 = call i64 @new_String(i8* getelementptr inbounds ([13 x i8]* @1, i32 0, i32 0))
  %union_storage21 = alloca %union.UnionType
  %cast_to_double_ptr2228 = bitcast %union.UnionType* %union_storage21 to double*
  %cast_to_int_ptr23 = bitcast double* %cast_to_double_ptr2228 to i64*
  store i64 %string20, i64* %cast_to_int_ptr23
  %get_idx29 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %union_storage21, %union.UnionType** %get_idx29
  %array = alloca %ArrayObject
  %array_type30 = bitcast %ArrayObject* %array to i32*
  ...
  %cast_to_double_ptr2531 = bitcast %union.UnionType* %union_storage24 to double*
  %cast_to_int_ptr26 = bitcast double* %cast_to_double_ptr2531 to i64*
  store i64 %result, i64* %cast_to_int_ptr26
  ret i64 0
}
