...
@2 = private unnamed_addr constant [2 x i8] c"c\00"
@3 = private unnamed_addr constant [2 x i8] c"d\00"
@4 = private unnamed_addr constant [2 x i8] c"e\00"
@5 = private unnamed_addr constant [5 x i8] c"hoge\00"
...
@6 = private unnamed_addr constant [1 x i8] zeroinitializer
...
entrypoint:
  ...
  %cast_to_double_ptr232 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr232 to i64*
  ...
  %cast_to_double_ptr3233 = bitcast %union.UnionType* %union_storage2 to double*
  %cast_to_int_ptr4 = bitcast double* %cast_to_double_ptr3233 to i64*
  ...
  %cast_to_double_ptr7234 = bitcast %union.UnionType* %union_storage6 to double*
  %cast_to_int_ptr8 = bitcast double* %cast_to_double_ptr7234 to i64*
  ...
  %load_elem235 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %union_storage6, %union.UnionType** %load_elem235
  %load_elem9 = getelementptr %union.UnionType** %elems, i64 1
  store %union.UnionType* %ivalue, %union.UnionType** %load_elem9
  ...
  %array_type236 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  ...
  %cast_to_double_ptr13237 = bitcast %union.UnionType* %union_storage12 to double*
  %cast_to_int_ptr14 = bitcast double* %cast_to_double_ptr13237 to i64*
  store i64 %hash, i64* %cast_to_int_ptr14
  %fetched_object15 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr = bitcast %Object* %fetched_object15 to %HashRef*
  %hash_ref_type238 = bitcast %HashRef* %cast_to_hash_ref_ptr to i32*
  %hash_ref_body = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr, i32 0, i32 1
  store i32 6, i32* %hash_ref_type238
  %load_hash_body = load %union.UnionType* %union_storage12
  store %union.UnionType %load_hash_body, %union.UnionType* %hash_ref_body
  %base_ptr16 = alloca %union.UnionType
  %union_ptr_to_int17 = ptrtoint %HashRef* %cast_to_hash_ref_ptr to i64
  %or18 = or i64 %union_ptr_to_int17, -4503599627370496
  %or19 = or i64 %or18, 1688849860263936
  %bitcast20 = bitcast %union.UnionType* %base_ptr16 to i64*
  store i64 %or19, i64* %bitcast20
  %elems21 = alloca %union.UnionType*, i64 2
  %load_elem22239 = bitcast %union.UnionType** %elems21 to %union.UnionType**
  store %union.UnionType* %union_storage2, %union.UnionType** %load_elem22239
  %load_elem23 = getelementptr %union.UnionType** %elems21, i64 1
  store %union.UnionType* %base_ptr16, %union.UnionType** %load_elem23
  %fetched_object24 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr25 = bitcast %Object* %fetched_object24 to %ArrayObject*
  %array_type26240 = bitcast %ArrayObject* %cast_to_array_ptr25 to i32*
  %array_list27 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr25, i32 0, i32 1
  %array_size28 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr25, i32 0, i32 2
  store i32 3, i32* %array_type26240
  store %union.UnionType** %elems21, %union.UnionType*** %array_list27
  store i64 2, i64* %array_size28
  %base_ptr29 = alloca %union.UnionType
  %union_ptr_to_int30 = ptrtoint %ArrayObject* %cast_to_array_ptr25 to i64
  %or31 = or i64 %union_ptr_to_int30, -4503599627370496
  %or32 = or i64 %or31, 844424930131968
  %bitcast33 = bitcast %union.UnionType* %base_ptr29 to i64*
  store i64 %or32, i64* %bitcast33
  %bitcast34 = bitcast %union.UnionType* %base_ptr29 to i64*
  %load_ivalue35 = load i64* %bitcast34
  %xor36 = xor i64 %load_ivalue35, -3659174697238528
  %int_to_ptr37 = inttoptr i64 %xor36 to %ArrayObject*
  %hash38 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr37)
  %union_storage39 = alloca %union.UnionType
  %cast_to_double_ptr40241 = bitcast %union.UnionType* %union_storage39 to double*
  %cast_to_int_ptr41 = bitcast double* %cast_to_double_ptr40241 to i64*
  store i64 %hash38, i64* %cast_to_int_ptr41
  %fetched_object42 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr43 = bitcast %Object* %fetched_object42 to %HashRef*
  %hash_ref_type44242 = bitcast %HashRef* %cast_to_hash_ref_ptr43 to i32*
  %hash_ref_body45 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr43, i32 0, i32 1
  store i32 6, i32* %hash_ref_type44242
  %load_hash_body46 = load %union.UnionType* %union_storage39
  store %union.UnionType %load_hash_body46, %union.UnionType* %hash_ref_body45
  %base_ptr47 = alloca %union.UnionType
  %union_ptr_to_int48 = ptrtoint %HashRef* %cast_to_hash_ref_ptr43 to i64
  %or49 = or i64 %union_ptr_to_int48, -4503599627370496
  %or50 = or i64 %or49, 1688849860263936
  %bitcast51 = bitcast %union.UnionType* %base_ptr47 to i64*
  store i64 %or50, i64* %bitcast51
  %string52 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @3, i32 0, i32 0))
  %union_storage53 = alloca %union.UnionType
  %cast_to_double_ptr54243 = bitcast %union.UnionType* %union_storage53 to double*
  %cast_to_int_ptr55 = bitcast double* %cast_to_double_ptr54243 to i64*
  store i64 %string52, i64* %cast_to_int_ptr55
  %string56 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @4, i32 0, i32 0))
  %union_storage57 = alloca %union.UnionType
  %cast_to_double_ptr58244 = bitcast %union.UnionType* %union_storage57 to double*
  %cast_to_int_ptr59 = bitcast double* %cast_to_double_ptr58244 to i64*
  store i64 %string56, i64* %cast_to_int_ptr59
  %string60 = call i64 @new_String(i8* getelementptr inbounds ([5 x i8]* @5, i32 0, i32 0))
  %union_storage61 = alloca %union.UnionType
  %cast_to_double_ptr62245 = bitcast %union.UnionType* %union_storage61 to double*
  %cast_to_int_ptr63 = bitcast double* %cast_to_double_ptr62245 to i64*
  store i64 %string60, i64* %cast_to_int_ptr63
  %elems64 = alloca %union.UnionType*, i64 2
  %load_elem65246 = bitcast %union.UnionType** %elems64 to %union.UnionType**
  store %union.UnionType* %union_storage57, %union.UnionType** %load_elem65246
  %load_elem66 = getelementptr %union.UnionType** %elems64, i64 1
  store %union.UnionType* %union_storage61, %union.UnionType** %load_elem66
  %fetched_object67 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr68 = bitcast %Object* %fetched_object67 to %ArrayObject*
  %array_type69247 = bitcast %ArrayObject* %cast_to_array_ptr68 to i32*
  %array_list70 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr68, i32 0, i32 1
  %array_size71 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr68, i32 0, i32 2
  store i32 3, i32* %array_type69247
  store %union.UnionType** %elems64, %union.UnionType*** %array_list70
  store i64 2, i64* %array_size71
  %base_ptr72 = alloca %union.UnionType
  %union_ptr_to_int73 = ptrtoint %ArrayObject* %cast_to_array_ptr68 to i64
  %or74 = or i64 %union_ptr_to_int73, -4503599627370496
  %or75 = or i64 %or74, 844424930131968
  %bitcast76 = bitcast %union.UnionType* %base_ptr72 to i64*
  store i64 %or75, i64* %bitcast76
  %bitcast77 = bitcast %union.UnionType* %base_ptr72 to i64*
  %load_ivalue78 = load i64* %bitcast77
  %xor79 = xor i64 %load_ivalue78, -3659174697238528
  %int_to_ptr80 = inttoptr i64 %xor79 to %ArrayObject*
  %hash81 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr80)
  %union_storage82 = alloca %union.UnionType
  %cast_to_double_ptr83248 = bitcast %union.UnionType* %union_storage82 to double*
  %cast_to_int_ptr84 = bitcast double* %cast_to_double_ptr83248 to i64*
  store i64 %hash81, i64* %cast_to_int_ptr84
  %fetched_object85 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr86 = bitcast %Object* %fetched_object85 to %HashRef*
  %hash_ref_type87249 = bitcast %HashRef* %cast_to_hash_ref_ptr86 to i32*
  %hash_ref_body88 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr86, i32 0, i32 1
  store i32 6, i32* %hash_ref_type87249
  %load_hash_body89 = load %union.UnionType* %union_storage82
  store %union.UnionType %load_hash_body89, %union.UnionType* %hash_ref_body88
  %base_ptr90 = alloca %union.UnionType
  %union_ptr_to_int91 = ptrtoint %HashRef* %cast_to_hash_ref_ptr86 to i64
  %or92 = or i64 %union_ptr_to_int91, -4503599627370496
  %or93 = or i64 %or92, 1688849860263936
  %bitcast94 = bitcast %union.UnionType* %base_ptr90 to i64*
  store i64 %or93, i64* %bitcast94
  %elems95 = alloca %union.UnionType*, i64 4
  %load_elem96250 = bitcast %union.UnionType** %elems95 to %union.UnionType**
  store %union.UnionType* %union_storage, %union.UnionType** %load_elem96250
  %load_elem97 = getelementptr %union.UnionType** %elems95, i64 1
  store %union.UnionType* %base_ptr47, %union.UnionType** %load_elem97
  %load_elem98 = getelementptr %union.UnionType** %elems95, i64 2
  store %union.UnionType* %union_storage53, %union.UnionType** %load_elem98
  %load_elem99 = getelementptr %union.UnionType** %elems95, i64 3
  store %union.UnionType* %base_ptr90, %union.UnionType** %load_elem99
  %fetched_object100 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr101 = bitcast %Object* %fetched_object100 to %ArrayObject*
  %array_type102251 = bitcast %ArrayObject* %cast_to_array_ptr101 to i32*
  %array_list103 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr101, i32 0, i32 1
  %array_size104 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr101, i32 0, i32 2
  store i32 3, i32* %array_type102251
  store %union.UnionType** %elems95, %union.UnionType*** %array_list103
  store i64 4, i64* %array_size104
  %base_ptr105 = alloca %union.UnionType
  %union_ptr_to_int106 = ptrtoint %ArrayObject* %cast_to_array_ptr101 to i64
  %or107 = or i64 %union_ptr_to_int106, -4503599627370496
  %or108 = or i64 %or107, 844424930131968
  %bitcast109 = bitcast %union.UnionType* %base_ptr105 to i64*
  store i64 %or108, i64* %bitcast109
  %bitcast110 = bitcast %union.UnionType* %base_ptr105 to i64*
  %load_ivalue111 = load i64* %bitcast110
  %xor112 = xor i64 %load_ivalue111, -3659174697238528
  %int_to_ptr113 = inttoptr i64 %xor112 to %ArrayObject*
  %hash114 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr113)
  %union_storage115 = alloca %union.UnionType
  %cast_to_double_ptr116252 = bitcast %union.UnionType* %union_storage115 to double*
  %cast_to_int_ptr117 = bitcast double* %cast_to_double_ptr116252 to i64*
  store i64 %hash114, i64* %cast_to_int_ptr117
  %fetched_object118 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr119 = bitcast %Object* %fetched_object118 to %HashRef*
  %hash_ref_type120253 = bitcast %HashRef* %cast_to_hash_ref_ptr119 to i32*
  %hash_ref_body121 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr119, i32 0, i32 1
  store i32 6, i32* %hash_ref_type120253
  %load_hash_body122 = load %union.UnionType* %union_storage115
  store %union.UnionType %load_hash_body122, %union.UnionType* %hash_ref_body121
  %base_ptr123 = alloca %union.UnionType
  %union_ptr_to_int124 = ptrtoint %HashRef* %cast_to_hash_ref_ptr119 to i64
  %or125 = or i64 %union_ptr_to_int124, -4503599627370496
  %or126 = or i64 %or125, 1688849860263936
  %bitcast127 = bitcast %union.UnionType* %base_ptr123 to i64*
  store i64 %or126, i64* %bitcast127
  %load_value = load %union.UnionType* %base_ptr123
  store %union.UnionType %load_value, %union.UnionType* @global_value
  %ivalue128 = alloca %union.UnionType
  %union_to_int_ptr129 = bitcast %union.UnionType* %ivalue128 to i64*
  store i64 -4222124650659840, i64* %union_to_int_ptr129
  %ivalue130 = alloca %union.UnionType
  %union_to_int_ptr131 = bitcast %union.UnionType* %ivalue130 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr131
  %ivalue132 = alloca %union.UnionType
  %union_to_int_ptr133 = bitcast %union.UnionType* %ivalue132 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr133
  %elems134 = alloca %union.UnionType*
  %load_elem135254 = bitcast %union.UnionType** %elems134 to %union.UnionType**
  store %union.UnionType* %ivalue132, %union.UnionType** %load_elem135254
  %fetched_object136 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr137 = bitcast %Object* %fetched_object136 to %ArrayObject*
  %array_type138255 = bitcast %ArrayObject* %cast_to_array_ptr137 to i32*
  %array_list139 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr137, i32 0, i32 1
  %array_size140 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr137, i32 0, i32 2
  store i32 3, i32* %array_type138255
  store %union.UnionType** %elems134, %union.UnionType*** %array_list139
  store i64 1, i64* %array_size140
  %base_ptr141 = alloca %union.UnionType
  %union_ptr_to_int142 = ptrtoint %ArrayObject* %cast_to_array_ptr137 to i64
  %or143 = or i64 %union_ptr_to_int142, -4503599627370496
  %or144 = or i64 %or143, 844424930131968
  %bitcast145 = bitcast %union.UnionType* %base_ptr141 to i64*
  store i64 %or144, i64* %bitcast145
  %fetched_object146 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr = bitcast %Object* %fetched_object146 to %ArrayRef*
  %array_ref_type256 = bitcast %ArrayRef* %cast_to_array_ref_ptr to i32*
  %array_ref_body = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr, i32 0, i32 1
  store i32 4, i32* %array_ref_type256
  %load_array_body = load %union.UnionType* %base_ptr141
  store %union.UnionType %load_array_body, %union.UnionType* %array_ref_body
  %base_ptr147 = alloca %union.UnionType
  %union_ptr_to_int148 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr to i64
  %or149 = or i64 %union_ptr_to_int148, -4503599627370496
  %or150 = or i64 %or149, 1125899906842624
  %bitcast151 = bitcast %union.UnionType* %base_ptr147 to i64*
  store i64 %or150, i64* %bitcast151
  %elems152 = alloca %union.UnionType*, i64 2
  %load_elem153257 = bitcast %union.UnionType** %elems152 to %union.UnionType**
  store %union.UnionType* %ivalue130, %union.UnionType** %load_elem153257
  %load_elem154 = getelementptr %union.UnionType** %elems152, i64 1
  store %union.UnionType* %base_ptr147, %union.UnionType** %load_elem154
  %fetched_object155 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr156 = bitcast %Object* %fetched_object155 to %ArrayObject*
  %array_type157258 = bitcast %ArrayObject* %cast_to_array_ptr156 to i32*
  %array_list158 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr156, i32 0, i32 1
  %array_size159 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr156, i32 0, i32 2
  store i32 3, i32* %array_type157258
  store %union.UnionType** %elems152, %union.UnionType*** %array_list158
  store i64 2, i64* %array_size159
  %base_ptr160 = alloca %union.UnionType
  %union_ptr_to_int161 = ptrtoint %ArrayObject* %cast_to_array_ptr156 to i64
  %or162 = or i64 %union_ptr_to_int161, -4503599627370496
  %or163 = or i64 %or162, 844424930131968
  %bitcast164 = bitcast %union.UnionType* %base_ptr160 to i64*
  store i64 %or163, i64* %bitcast164
  %fetched_object165 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr166 = bitcast %Object* %fetched_object165 to %ArrayRef*
  %array_ref_type167259 = bitcast %ArrayRef* %cast_to_array_ref_ptr166 to i32*
  %array_ref_body168 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr166, i32 0, i32 1
  store i32 4, i32* %array_ref_type167259
  %load_array_body169 = load %union.UnionType* %base_ptr160
  store %union.UnionType %load_array_body169, %union.UnionType* %array_ref_body168
  %base_ptr170 = alloca %union.UnionType
  %union_ptr_to_int171 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr166 to i64
  %or172 = or i64 %union_ptr_to_int171, -4503599627370496
  %or173 = or i64 %or172, 1125899906842624
  %bitcast174 = bitcast %union.UnionType* %base_ptr170 to i64*
  store i64 %or173, i64* %bitcast174
  %ivalue175 = alloca %union.UnionType
  %union_to_int_ptr176 = bitcast %union.UnionType* %ivalue175 to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr176
  %elems177 = alloca %union.UnionType*, i64 3
  %load_elem178260 = bitcast %union.UnionType** %elems177 to %union.UnionType**
  store %union.UnionType* %ivalue128, %union.UnionType** %load_elem178260
  %load_elem179 = getelementptr %union.UnionType** %elems177, i64 1
  store %union.UnionType* %base_ptr170, %union.UnionType** %load_elem179
  %load_elem180 = getelementptr %union.UnionType** %elems177, i64 2
  store %union.UnionType* %ivalue175, %union.UnionType** %load_elem180
  %fetched_object181 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr182 = bitcast %Object* %fetched_object181 to %ArrayObject*
  %array_type183261 = bitcast %ArrayObject* %cast_to_array_ptr182 to i32*
  %array_list184 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr182, i32 0, i32 1
  %array_size185 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr182, i32 0, i32 2
  store i32 3, i32* %array_type183261
  store %union.UnionType** %elems177, %union.UnionType*** %array_list184
  store i64 3, i64* %array_size185
  %base_ptr186 = alloca %union.UnionType
  %union_ptr_to_int187 = ptrtoint %ArrayObject* %cast_to_array_ptr182 to i64
  %or188 = or i64 %union_ptr_to_int187, -4503599627370496
  %or189 = or i64 %or188, 844424930131968
  %bitcast190 = bitcast %union.UnionType* %base_ptr186 to i64*
  store i64 %or189, i64* %bitcast190
  %fetched_object191 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr192 = bitcast %Object* %fetched_object191 to %ArrayRef*
  %array_ref_type193262 = bitcast %ArrayRef* %cast_to_array_ref_ptr192 to i32*
  %array_ref_body194 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr192, i32 0, i32 1
  store i32 4, i32* %array_ref_type193262
  %load_array_body195 = load %union.UnionType* %base_ptr186
  store %union.UnionType %load_array_body195, %union.UnionType* %array_ref_body194
  %base_ptr196 = alloca %union.UnionType
  %union_ptr_to_int197 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr192 to i64
  %or198 = or i64 %union_ptr_to_int197, -4503599627370496
  %or199 = or i64 %or198, 1125899906842624
  %bitcast200 = bitcast %union.UnionType* %base_ptr196 to i64*
  store i64 %or199, i64* %bitcast200
  %load_value201 = load %union.UnionType* %base_ptr196
  store %union.UnionType %load_value201, %union.UnionType* @global_value1
  %args = alloca %union.UnionType*
  %get_idx263 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* @global_value, %union.UnionType** %get_idx263
  %array = alloca %ArrayObject
  %array_type202264 = bitcast %ArrayObject* %array to i32*
  %array_list203 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 1
  %array_size204 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 2
  store i32 3, i32* %array_type202264
  store %union.UnionType** %args, %union.UnionType*** %array_list203
  store i64 1, i64* %array_size204
  %result = call i64 bitcast (i64 (%struct._Array*)* @Object_dumper to i64 (%ArrayObject*)*)(%ArrayObject* %array)
  %union_storage205 = alloca %union.UnionType
  %cast_to_double_ptr206265 = bitcast %union.UnionType* %union_storage205 to double*
  %cast_to_int_ptr207 = bitcast double* %cast_to_double_ptr206265 to i64*
  store i64 %result, i64* %cast_to_int_ptr207
  %args208 = alloca %union.UnionType*
  %string209 = call i64 @new_String(i8* getelementptr inbounds ([1 x i8]* @6, i32 0, i32 0))
  %union_storage210 = alloca %union.UnionType
  %cast_to_double_ptr211266 = bitcast %union.UnionType* %union_storage210 to double*
  %cast_to_int_ptr212 = bitcast double* %cast_to_double_ptr211266 to i64*
  store i64 %string209, i64* %cast_to_int_ptr212
  %get_idx213267 = bitcast %union.UnionType** %args208 to %union.UnionType**
  store %union.UnionType* %union_storage210, %union.UnionType** %get_idx213267
  %array214 = alloca %ArrayObject
  %array_type215268 = bitcast %ArrayObject* %array214 to i32*
  %array_list216 = getelementptr inbounds %ArrayObject* %array214, i32 0, i32 1
  %array_size217 = getelementptr inbounds %ArrayObject* %array214, i32 0, i32 2
  store i32 3, i32* %array_type215268
  store %union.UnionType** %args208, %union.UnionType*** %array_list216
  store i64 1, i64* %array_size217
  %result218 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array214)
  %union_storage219 = alloca %union.UnionType
  %cast_to_double_ptr220269 = bitcast %union.UnionType* %union_storage219 to double*
  %cast_to_int_ptr221 = bitcast double* %cast_to_double_ptr220269 to i64*
  store i64 %result218, i64* %cast_to_int_ptr221
  %args222 = alloca %union.UnionType*
  %get_idx223270 = bitcast %union.UnionType** %args222 to %union.UnionType**
  store %union.UnionType* @global_value1, %union.UnionType** %get_idx223270
  %array224 = alloca %ArrayObject
  %array_type225271 = bitcast %ArrayObject* %array224 to i32*
  %array_list226 = getelementptr inbounds %ArrayObject* %array224, i32 0, i32 1
  %array_size227 = getelementptr inbounds %ArrayObject* %array224, i32 0, i32 2
  store i32 3, i32* %array_type225271
  store %union.UnionType** %args222, %union.UnionType*** %array_list226
  store i64 1, i64* %array_size227
  %result228 = call i64 bitcast (i64 (%struct._Array*)* @Object_dumper to i64 (%ArrayObject*)*)(%ArrayObject* %array224)
  %union_storage229 = alloca %union.UnionType
  %cast_to_double_ptr230272 = bitcast %union.UnionType* %union_storage229 to double*
  %cast_to_int_ptr231 = bitcast double* %cast_to_double_ptr230272 to i64*
  store i64 %result228, i64* %cast_to_int_ptr231
  ret i64 0
}
