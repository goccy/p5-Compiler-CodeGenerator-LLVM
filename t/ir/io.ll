...
@1 = private unnamed_addr constant [11 x i8] c"io_test.pl\00"
...
entrypoint:
  ...
  %union_ptr_to_int = ptrtoint %Object* %"$fh" to i64
  ...
  %object_body = getelementptr inbounds %Object* %int_to_ptr, i32 0, i32 1
  %string = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @0, i32 0, i32 0))
  %union_storage = alloca %union.UnionType
  %cast_to_double_ptr43 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr43 to i64*
  store i64 %string, i64* %cast_to_int_ptr
  %string2 = call i64 @new_String(i8* getelementptr inbounds ([11 x i8]* @1, i32 0, i32 0))
  %union_storage3 = alloca %union.UnionType
  %cast_to_double_ptr444 = bitcast %union.UnionType* %union_storage3 to double*
  %cast_to_int_ptr5 = bitcast double* %cast_to_double_ptr444 to i64*
  store i64 %string2, i64* %cast_to_int_ptr5
  %args = alloca %union.UnionType*, i64 3
  %get_idx45 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body, %union.UnionType** %get_idx45
  %get_idx6 = getelementptr %union.UnionType** %args, i64 1
  store %union.UnionType* %union_storage, %union.UnionType** %get_idx6
  %get_idx7 = getelementptr %union.UnionType** %args, i64 2
  store %union.UnionType* %union_storage3, %union.UnionType** %get_idx7
  %array = alloca %ArrayObject
  %array_type46 = bitcast %ArrayObject* %array to i32*
  ...
  store i32 3, i32* %array_type46
  store %union.UnionType** %args, %union.UnionType*** %array_list
  store i64 3, i64* %array_size
  %result = call i64 bitcast (i64 (%struct._Array*)* @_open to i64 (%ArrayObject*)*)(%ArrayObject* %array)
  %union_storage8 = alloca %union.UnionType
  %cast_to_double_ptr947 = bitcast %union.UnionType* %union_storage8 to double*
  %cast_to_int_ptr10 = bitcast double* %cast_to_double_ptr947 to i64*
  store i64 %result, i64* %cast_to_int_ptr10
  %args11 = alloca %union.UnionType*
  %string12 = call i64 @new_String(i8* getelementptr inbounds ([12 x i8]* @2, i32 0, i32 0))
  %union_storage13 = alloca %union.UnionType
  %cast_to_double_ptr1448 = bitcast %union.UnionType* %union_storage13 to double*
  %cast_to_int_ptr15 = bitcast double* %cast_to_double_ptr1448 to i64*
  store i64 %string12, i64* %cast_to_int_ptr15
  %get_idx1649 = bitcast %union.UnionType** %args11 to %union.UnionType**
  store %union.UnionType* %union_storage13, %union.UnionType** %get_idx1649
  %array17 = alloca %ArrayObject
  %array_type1850 = bitcast %ArrayObject* %array17 to i32*
  %array_list19 = getelementptr inbounds %ArrayObject* %array17, i32 0, i32 1
  %array_size20 = getelementptr inbounds %ArrayObject* %array17, i32 0, i32 2
  store i32 3, i32* %array_type1850
  store %union.UnionType** %args11, %union.UnionType*** %array_list19
  store i64 1, i64* %array_size20
  %load_ivalue21 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor22 = xor i64 %load_ivalue21, -2533274790395904
  %int_to_ptr23 = inttoptr i64 %xor22 to %Object*
  %object_body24 = getelementptr inbounds %Object* %int_to_ptr23, i32 0, i32 1
  %result25 = call i64 bitcast (i64 (%union.UnionType*, %struct._Array*)* @print_with_handler to i64 (%union.UnionType*, %ArrayObject*)*)(%union.UnionType* %object_body24, %ArrayObject* %array17)
  %union_storage26 = alloca %union.UnionType
  %cast_to_double_ptr2751 = bitcast %union.UnionType* %union_storage26 to double*
  %cast_to_int_ptr28 = bitcast double* %cast_to_double_ptr2751 to i64*
  store i64 %result25, i64* %cast_to_int_ptr28
  ...
  %get_idx3452 = bitcast %union.UnionType** %args29 to %union.UnionType**
  store %union.UnionType* @global_value, %union.UnionType** %get_idx3452
  %array35 = alloca %ArrayObject
  %array_type3653 = bitcast %ArrayObject* %array35 to i32*
  ...
  store i32 3, i32* %array_type3653
  store %union.UnionType** %args29, %union.UnionType*** %array_list37
  store i64 1, i64* %array_size38
  %result39 = call i64 bitcast (i64 (%struct._Array*)* @_close to i64 (%ArrayObject*)*)(%ArrayObject* %array35)
  %union_storage40 = alloca %union.UnionType
  %cast_to_double_ptr4154 = bitcast %union.UnionType* %union_storage40 to double*
  %cast_to_int_ptr42 = bitcast double* %cast_to_double_ptr4154 to i64*
