...
@2 = private unnamed_addr constant [2 x i8] c"d\00"
@3 = private unnamed_addr constant [2 x i8] c"c\00"
@global_value = common global %union.UnionType zeroinitializer, align 8
@4 = private unnamed_addr constant [2 x i8] c"a\00"
@5 = private unnamed_addr constant [2 x i8] c"b\00"
@6 = private unnamed_addr constant [2 x i8] c"c\00"
@7 = private unnamed_addr constant [2 x i8] c"a\00"
@global_value1 = common global %union.UnionType zeroinitializer, align 8
@8 = private unnamed_addr constant [2 x i8] c"b\00"
@9 = private unnamed_addr constant [2 x i8] c"d\00"
...
entrypoint:
  ...
  %cast_to_double_ptr466 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr466 to i64*
  ...
  %cast_to_double_ptr3467 = bitcast %union.UnionType* %union_storage2 to double*
  %cast_to_int_ptr4 = bitcast double* %cast_to_double_ptr3467 to i64*
  store i64 %string1, i64* %cast_to_int_ptr4
  %string5 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @2, i32 0, i32 0))
  %union_storage6 = alloca %union.UnionType
  %cast_to_double_ptr7468 = bitcast %union.UnionType* %union_storage6 to double*
  %cast_to_int_ptr8 = bitcast double* %cast_to_double_ptr7468 to i64*
  store i64 %string5, i64* %cast_to_int_ptr8
  %ivalue9 = alloca %union.UnionType
  %union_to_int_ptr10 = bitcast %union.UnionType* %ivalue9 to i64*
  store i64 -4222124650659832, i64* %union_to_int_ptr10
  %elems = alloca %union.UnionType*, i64 2
  %load_elem469 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %union_storage6, %union.UnionType** %load_elem469
  %load_elem11 = getelementptr %union.UnionType** %elems, i64 1
  store %union.UnionType* %ivalue9, %union.UnionType** %load_elem11
  ...
  %array_type470 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  ...
  %or12 = or i64 %or, 844424930131968
  %bitcast = bitcast %union.UnionType* %base_ptr to i64*
  store i64 %or12, i64* %bitcast
  %bitcast13 = bitcast %union.UnionType* %base_ptr to i64*
  %load_ivalue = load i64* %bitcast13
  ...
  %union_storage14 = alloca %union.UnionType
  %cast_to_double_ptr15471 = bitcast %union.UnionType* %union_storage14 to double*
  %cast_to_int_ptr16 = bitcast double* %cast_to_double_ptr15471 to i64*
  store i64 %hash, i64* %cast_to_int_ptr16
  ...
  %hash_ref_type472 = bitcast %HashRef* %cast_to_hash_ref_ptr to i32*
  %hash_ref_body = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr, i32 0, i32 1
  store i32 6, i32* %hash_ref_type472
  %load_hash_body = load %union.UnionType* %union_storage14
  ...
  %string23 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @3, i32 0, i32 0))
  %union_storage24 = alloca %union.UnionType
  %cast_to_double_ptr25473 = bitcast %union.UnionType* %union_storage24 to double*
  %cast_to_int_ptr26 = bitcast double* %cast_to_double_ptr25473 to i64*
  store i64 %string23, i64* %cast_to_int_ptr26
  %ivalue27 = alloca %union.UnionType
  %union_to_int_ptr28 = bitcast %union.UnionType* %ivalue27 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr28
  %elems29 = alloca %union.UnionType*, i64 6
  %load_elem30474 = bitcast %union.UnionType** %elems29 to %union.UnionType**
  store %union.UnionType* %union_storage, %union.UnionType** %load_elem30474
  %load_elem31 = getelementptr %union.UnionType** %elems29, i64 1
  store %union.UnionType* %ivalue, %union.UnionType** %load_elem31
  %load_elem32 = getelementptr %union.UnionType** %elems29, i64 2
  store %union.UnionType* %union_storage2, %union.UnionType** %load_elem32
  %load_elem33 = getelementptr %union.UnionType** %elems29, i64 3
  store %union.UnionType* %base_ptr18, %union.UnionType** %load_elem33
  %load_elem34 = getelementptr %union.UnionType** %elems29, i64 4
  store %union.UnionType* %union_storage24, %union.UnionType** %load_elem34
  %load_elem35 = getelementptr %union.UnionType** %elems29, i64 5
  store %union.UnionType* %ivalue27, %union.UnionType** %load_elem35
  %fetched_object36 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr37 = bitcast %Object* %fetched_object36 to %ArrayObject*
  %array_type38475 = bitcast %ArrayObject* %cast_to_array_ptr37 to i32*
  %array_list39 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr37, i32 0, i32 1
  %array_size40 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr37, i32 0, i32 2
  store i32 3, i32* %array_type38475
  store %union.UnionType** %elems29, %union.UnionType*** %array_list39
  store i64 6, i64* %array_size40
  %base_ptr41 = alloca %union.UnionType
  %union_ptr_to_int42 = ptrtoint %ArrayObject* %cast_to_array_ptr37 to i64
  %or43 = or i64 %union_ptr_to_int42, -4503599627370496
  %or44 = or i64 %or43, 844424930131968
  %bitcast45 = bitcast %union.UnionType* %base_ptr41 to i64*
  store i64 %or44, i64* %bitcast45
  %bitcast46 = bitcast %union.UnionType* %base_ptr41 to i64*
  %load_ivalue47 = load i64* %bitcast46
  %xor48 = xor i64 %load_ivalue47, -3659174697238528
  %int_to_ptr49 = inttoptr i64 %xor48 to %ArrayObject*
  %hash50 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr49)
  %union_storage51 = alloca %union.UnionType
  %cast_to_double_ptr52476 = bitcast %union.UnionType* %union_storage51 to double*
  %cast_to_int_ptr53 = bitcast double* %cast_to_double_ptr52476 to i64*
  store i64 %hash50, i64* %cast_to_int_ptr53
  %fetched_object54 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr55 = bitcast %Object* %fetched_object54 to %HashRef*
  %hash_ref_type56477 = bitcast %HashRef* %cast_to_hash_ref_ptr55 to i32*
  %hash_ref_body57 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr55, i32 0, i32 1
  store i32 6, i32* %hash_ref_type56477
  %load_hash_body58 = load %union.UnionType* %union_storage51
  store %union.UnionType %load_hash_body58, %union.UnionType* %hash_ref_body57
  %base_ptr59 = alloca %union.UnionType
  %union_ptr_to_int60 = ptrtoint %HashRef* %cast_to_hash_ref_ptr55 to i64
  %or61 = or i64 %union_ptr_to_int60, -4503599627370496
  %or62 = or i64 %or61, 1688849860263936
  %bitcast63 = bitcast %union.UnionType* %base_ptr59 to i64*
  store i64 %or62, i64* %bitcast63
  %load_value = load %union.UnionType* %base_ptr59
  store %union.UnionType %load_value, %union.UnionType* @global_value
  %args = alloca %union.UnionType*
  %get_idx478 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* @global_value, %union.UnionType** %get_idx478
  %array = alloca %ArrayObject
  %array_type64479 = bitcast %ArrayObject* %array to i32*
  %array_list65 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 1
  %array_size66 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 2
  store i32 3, i32* %array_type64479
  store %union.UnionType** %args, %union.UnionType*** %array_list65
  store i64 1, i64* %array_size66
  %result = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array)
  %union_storage67 = alloca %union.UnionType
  %cast_to_double_ptr68480 = bitcast %union.UnionType* %union_storage67 to double*
  %cast_to_int_ptr69 = bitcast double* %cast_to_double_ptr68480 to i64*
  store i64 %result, i64* %cast_to_int_ptr69
  %args70 = alloca %union.UnionType*
  %load_ivalue71 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor72 = xor i64 %load_ivalue71, -2814749767106560
  %int_to_ptr73 = inttoptr i64 %xor72 to %HashRef*
  %hashref_body = getelementptr inbounds %HashRef* %int_to_ptr73, i32 0, i32 1
  %get_idx74481 = bitcast %union.UnionType** %args70 to %union.UnionType**
  store %union.UnionType* %hashref_body, %union.UnionType** %get_idx74481
  %array75 = alloca %ArrayObject
  %array_type76482 = bitcast %ArrayObject* %array75 to i32*
  %array_list77 = getelementptr inbounds %ArrayObject* %array75, i32 0, i32 1
  %array_size78 = getelementptr inbounds %ArrayObject* %array75, i32 0, i32 2
  store i32 3, i32* %array_type76482
  store %union.UnionType** %args70, %union.UnionType*** %array_list77
  store i64 1, i64* %array_size78
  %result79 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array75)
  %union_storage80 = alloca %union.UnionType
  %cast_to_double_ptr81483 = bitcast %union.UnionType* %union_storage80 to double*
  %cast_to_int_ptr82 = bitcast double* %cast_to_double_ptr81483 to i64*
  store i64 %result79, i64* %cast_to_int_ptr82
  %args83 = alloca %union.UnionType*
  %string84 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @4, i32 0, i32 0))
  %union_storage85 = alloca %union.UnionType
  %cast_to_double_ptr86484 = bitcast %union.UnionType* %union_storage85 to double*
  %cast_to_int_ptr87 = bitcast double* %cast_to_double_ptr86484 to i64*
  store i64 %string84, i64* %cast_to_int_ptr87
  %elems88 = alloca %union.UnionType*
  %load_elem89485 = bitcast %union.UnionType** %elems88 to %union.UnionType**
  store %union.UnionType* %union_storage85, %union.UnionType** %load_elem89485
  %fetched_object90 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr91 = bitcast %Object* %fetched_object90 to %ArrayObject*
  %array_type92486 = bitcast %ArrayObject* %cast_to_array_ptr91 to i32*
  %array_list93 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr91, i32 0, i32 1
  %array_size94 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr91, i32 0, i32 2
  store i32 3, i32* %array_type92486
  store %union.UnionType** %elems88, %union.UnionType*** %array_list93
  store i64 1, i64* %array_size94
  %base_ptr95 = alloca %union.UnionType
  %union_ptr_to_int96 = ptrtoint %ArrayObject* %cast_to_array_ptr91 to i64
  %or97 = or i64 %union_ptr_to_int96, -4503599627370496
  %or98 = or i64 %or97, 844424930131968
  %bitcast99 = bitcast %union.UnionType* %base_ptr95 to i64*
  store i64 %or98, i64* %bitcast99
  %bitcast100 = bitcast %union.UnionType* %base_ptr95 to i64*
  %load_ivalue101 = load i64* %bitcast100
  %xor102 = xor i64 %load_ivalue101, -3659174697238528
  %int_to_ptr103 = inttoptr i64 %xor102 to %ArrayObject*
  %hash104 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr103)
  %union_storage105 = alloca %union.UnionType
  %cast_to_double_ptr106487 = bitcast %union.UnionType* %union_storage105 to double*
  %cast_to_int_ptr107 = bitcast double* %cast_to_double_ptr106487 to i64*
  store i64 %hash104, i64* %cast_to_int_ptr107
  %fetched_object108 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr109 = bitcast %Object* %fetched_object108 to %HashRef*
  %hash_ref_type110488 = bitcast %HashRef* %cast_to_hash_ref_ptr109 to i32*
  %hash_ref_body111 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr109, i32 0, i32 1
  store i32 6, i32* %hash_ref_type110488
  %load_hash_body112 = load %union.UnionType* %union_storage105
  store %union.UnionType %load_hash_body112, %union.UnionType* %hash_ref_body111
  %base_ptr113 = alloca %union.UnionType
  %union_ptr_to_int114 = ptrtoint %HashRef* %cast_to_hash_ref_ptr109 to i64
  %or115 = or i64 %union_ptr_to_int114, -4503599627370496
  %or116 = or i64 %or115, 1688849860263936
  %bitcast117 = bitcast %union.UnionType* %base_ptr113 to i64*
  store i64 %or116, i64* %bitcast117
  %load_ivalue118 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor119 = xor i64 %load_ivalue118, -2814749767106560
  %int_to_ptr120 = inttoptr i64 %xor119 to %HashRef*
  %bitcast121 = bitcast %union.UnionType* %base_ptr113 to i64*
  %load_ivalue122 = load i64* %bitcast121
  %xor123 = xor i64 %load_ivalue122, -2814749767106560
  %int_to_ptr124 = inttoptr i64 %xor123 to %HashRef*
  %hashref_body125 = getelementptr inbounds %HashRef* %int_to_ptr124, i32 0, i32 1
  %bitcast126 = bitcast %union.UnionType* %hashref_body125 to i64*
  %load_ivalue127 = load i64* %bitcast126
  %xor128 = xor i64 %load_ivalue127, -3096224743817216
  %int_to_ptr129 = inttoptr i64 %xor128 to %HashObject*
  %keys = getelementptr inbounds %HashObject* %int_to_ptr129, i32 0, i32 2
  %load_keys = load i8*** %keys
  %zero_at_keys489 = bitcast i8** %load_keys to i8**
  %load_key = load i8** %zero_at_keys489
  %bitcast130 = bitcast i8* %load_key to %StringObject*
  %HashRef_get = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* @global_value, %StringObject* %bitcast130)
  %get_idx131490 = bitcast %union.UnionType** %args83 to %union.UnionType**
  store %union.UnionType* %HashRef_get, %union.UnionType** %get_idx131490
  %array132 = alloca %ArrayObject
  %array_type133491 = bitcast %ArrayObject* %array132 to i32*
  ...
  store i32 3, i32* %array_type133491
  store %union.UnionType** %args83, %union.UnionType*** %array_list134
  ...
  %cast_to_double_ptr138492 = bitcast %union.UnionType* %union_storage137 to double*
  %cast_to_int_ptr139 = bitcast double* %cast_to_double_ptr138492 to i64*
  store i64 %result136, i64* %cast_to_int_ptr139
  %args140 = alloca %union.UnionType*
  %string141 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @5, i32 0, i32 0))
  %union_storage142 = alloca %union.UnionType
  %cast_to_double_ptr143493 = bitcast %union.UnionType* %union_storage142 to double*
  %cast_to_int_ptr144 = bitcast double* %cast_to_double_ptr143493 to i64*
  store i64 %string141, i64* %cast_to_int_ptr144
  %elems145 = alloca %union.UnionType*
  %load_elem146494 = bitcast %union.UnionType** %elems145 to %union.UnionType**
  store %union.UnionType* %union_storage142, %union.UnionType** %load_elem146494
  %fetched_object147 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr148 = bitcast %Object* %fetched_object147 to %ArrayObject*
  %array_type149495 = bitcast %ArrayObject* %cast_to_array_ptr148 to i32*
  %array_list150 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr148, i32 0, i32 1
  %array_size151 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr148, i32 0, i32 2
  store i32 3, i32* %array_type149495
  store %union.UnionType** %elems145, %union.UnionType*** %array_list150
  store i64 1, i64* %array_size151
  %base_ptr152 = alloca %union.UnionType
  %union_ptr_to_int153 = ptrtoint %ArrayObject* %cast_to_array_ptr148 to i64
  %or154 = or i64 %union_ptr_to_int153, -4503599627370496
  %or155 = or i64 %or154, 844424930131968
  %bitcast156 = bitcast %union.UnionType* %base_ptr152 to i64*
  store i64 %or155, i64* %bitcast156
  %bitcast157 = bitcast %union.UnionType* %base_ptr152 to i64*
  %load_ivalue158 = load i64* %bitcast157
  %xor159 = xor i64 %load_ivalue158, -3659174697238528
  %int_to_ptr160 = inttoptr i64 %xor159 to %ArrayObject*
  %hash161 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr160)
  %union_storage162 = alloca %union.UnionType
  %cast_to_double_ptr163496 = bitcast %union.UnionType* %union_storage162 to double*
  %cast_to_int_ptr164 = bitcast double* %cast_to_double_ptr163496 to i64*
  store i64 %hash161, i64* %cast_to_int_ptr164
  %fetched_object165 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr166 = bitcast %Object* %fetched_object165 to %HashRef*
  %hash_ref_type167497 = bitcast %HashRef* %cast_to_hash_ref_ptr166 to i32*
  %hash_ref_body168 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr166, i32 0, i32 1
  store i32 6, i32* %hash_ref_type167497
  %load_hash_body169 = load %union.UnionType* %union_storage162
  store %union.UnionType %load_hash_body169, %union.UnionType* %hash_ref_body168
  %base_ptr170 = alloca %union.UnionType
  %union_ptr_to_int171 = ptrtoint %HashRef* %cast_to_hash_ref_ptr166 to i64
  %or172 = or i64 %union_ptr_to_int171, -4503599627370496
  %or173 = or i64 %or172, 1688849860263936
  %bitcast174 = bitcast %union.UnionType* %base_ptr170 to i64*
  store i64 %or173, i64* %bitcast174
  %load_ivalue175 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor176 = xor i64 %load_ivalue175, -2814749767106560
  %int_to_ptr177 = inttoptr i64 %xor176 to %HashRef*
  %bitcast178 = bitcast %union.UnionType* %base_ptr170 to i64*
  %load_ivalue179 = load i64* %bitcast178
  %xor180 = xor i64 %load_ivalue179, -2814749767106560
  %int_to_ptr181 = inttoptr i64 %xor180 to %HashRef*
  %hashref_body182 = getelementptr inbounds %HashRef* %int_to_ptr181, i32 0, i32 1
  %bitcast183 = bitcast %union.UnionType* %hashref_body182 to i64*
  %load_ivalue184 = load i64* %bitcast183
  %xor185 = xor i64 %load_ivalue184, -3096224743817216
  %int_to_ptr186 = inttoptr i64 %xor185 to %HashObject*
  %keys187 = getelementptr inbounds %HashObject* %int_to_ptr186, i32 0, i32 2
  %load_keys188 = load i8*** %keys187
  %zero_at_keys189498 = bitcast i8** %load_keys188 to i8**
  %load_key190 = load i8** %zero_at_keys189498
  %bitcast191 = bitcast i8* %load_key190 to %StringObject*
  %HashRef_get192 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* @global_value, %StringObject* %bitcast191)
  %get_idx193499 = bitcast %union.UnionType** %args140 to %union.UnionType**
  store %union.UnionType* %HashRef_get192, %union.UnionType** %get_idx193499
  %array194 = alloca %ArrayObject
  %array_type195500 = bitcast %ArrayObject* %array194 to i32*
  %array_list196 = getelementptr inbounds %ArrayObject* %array194, i32 0, i32 1
  %array_size197 = getelementptr inbounds %ArrayObject* %array194, i32 0, i32 2
  store i32 3, i32* %array_type195500
  store %union.UnionType** %args140, %union.UnionType*** %array_list196
  store i64 1, i64* %array_size197
  %result198 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array194)
  %union_storage199 = alloca %union.UnionType
  %cast_to_double_ptr200501 = bitcast %union.UnionType* %union_storage199 to double*
  %cast_to_int_ptr201 = bitcast double* %cast_to_double_ptr200501 to i64*
  store i64 %result198, i64* %cast_to_int_ptr201
  %args202 = alloca %union.UnionType*
  %string203 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @6, i32 0, i32 0))
  %union_storage204 = alloca %union.UnionType
  %cast_to_double_ptr205502 = bitcast %union.UnionType* %union_storage204 to double*
  %cast_to_int_ptr206 = bitcast double* %cast_to_double_ptr205502 to i64*
  store i64 %string203, i64* %cast_to_int_ptr206
  %elems207 = alloca %union.UnionType*
  %load_elem208503 = bitcast %union.UnionType** %elems207 to %union.UnionType**
  store %union.UnionType* %union_storage204, %union.UnionType** %load_elem208503
  %fetched_object209 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr210 = bitcast %Object* %fetched_object209 to %ArrayObject*
  %array_type211504 = bitcast %ArrayObject* %cast_to_array_ptr210 to i32*
  %array_list212 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr210, i32 0, i32 1
  %array_size213 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr210, i32 0, i32 2
  store i32 3, i32* %array_type211504
  store %union.UnionType** %elems207, %union.UnionType*** %array_list212
  store i64 1, i64* %array_size213
  %base_ptr214 = alloca %union.UnionType
  %union_ptr_to_int215 = ptrtoint %ArrayObject* %cast_to_array_ptr210 to i64
  %or216 = or i64 %union_ptr_to_int215, -4503599627370496
  %or217 = or i64 %or216, 844424930131968
  %bitcast218 = bitcast %union.UnionType* %base_ptr214 to i64*
  store i64 %or217, i64* %bitcast218
  %bitcast219 = bitcast %union.UnionType* %base_ptr214 to i64*
  %load_ivalue220 = load i64* %bitcast219
  %xor221 = xor i64 %load_ivalue220, -3659174697238528
  %int_to_ptr222 = inttoptr i64 %xor221 to %ArrayObject*
  %hash223 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr222)
  %union_storage224 = alloca %union.UnionType
  %cast_to_double_ptr225505 = bitcast %union.UnionType* %union_storage224 to double*
  %cast_to_int_ptr226 = bitcast double* %cast_to_double_ptr225505 to i64*
  store i64 %hash223, i64* %cast_to_int_ptr226
  %fetched_object227 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr228 = bitcast %Object* %fetched_object227 to %HashRef*
  %hash_ref_type229506 = bitcast %HashRef* %cast_to_hash_ref_ptr228 to i32*
  %hash_ref_body230 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr228, i32 0, i32 1
  store i32 6, i32* %hash_ref_type229506
  %load_hash_body231 = load %union.UnionType* %union_storage224
  store %union.UnionType %load_hash_body231, %union.UnionType* %hash_ref_body230
  %base_ptr232 = alloca %union.UnionType
  %union_ptr_to_int233 = ptrtoint %HashRef* %cast_to_hash_ref_ptr228 to i64
  %or234 = or i64 %union_ptr_to_int233, -4503599627370496
  %or235 = or i64 %or234, 1688849860263936
  %bitcast236 = bitcast %union.UnionType* %base_ptr232 to i64*
  store i64 %or235, i64* %bitcast236
  %load_ivalue237 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor238 = xor i64 %load_ivalue237, -2814749767106560
  %int_to_ptr239 = inttoptr i64 %xor238 to %HashRef*
  %bitcast240 = bitcast %union.UnionType* %base_ptr232 to i64*
  %load_ivalue241 = load i64* %bitcast240
  %xor242 = xor i64 %load_ivalue241, -2814749767106560
  %int_to_ptr243 = inttoptr i64 %xor242 to %HashRef*
  %hashref_body244 = getelementptr inbounds %HashRef* %int_to_ptr243, i32 0, i32 1
  %bitcast245 = bitcast %union.UnionType* %hashref_body244 to i64*
  %load_ivalue246 = load i64* %bitcast245
  %xor247 = xor i64 %load_ivalue246, -3096224743817216
  %int_to_ptr248 = inttoptr i64 %xor247 to %HashObject*
  %keys249 = getelementptr inbounds %HashObject* %int_to_ptr248, i32 0, i32 2
  %load_keys250 = load i8*** %keys249
  %zero_at_keys251507 = bitcast i8** %load_keys250 to i8**
  %load_key252 = load i8** %zero_at_keys251507
  %bitcast253 = bitcast i8* %load_key252 to %StringObject*
  %HashRef_get254 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* @global_value, %StringObject* %bitcast253)
  %get_idx255508 = bitcast %union.UnionType** %args202 to %union.UnionType**
  store %union.UnionType* %HashRef_get254, %union.UnionType** %get_idx255508
  %array256 = alloca %ArrayObject
  %array_type257509 = bitcast %ArrayObject* %array256 to i32*
  %array_list258 = getelementptr inbounds %ArrayObject* %array256, i32 0, i32 1
  %array_size259 = getelementptr inbounds %ArrayObject* %array256, i32 0, i32 2
  store i32 3, i32* %array_type257509
  store %union.UnionType** %args202, %union.UnionType*** %array_list258
  store i64 1, i64* %array_size259
  %result260 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array256)
  %union_storage261 = alloca %union.UnionType
  %cast_to_double_ptr262510 = bitcast %union.UnionType* %union_storage261 to double*
  %cast_to_int_ptr263 = bitcast double* %cast_to_double_ptr262510 to i64*
  store i64 %result260, i64* %cast_to_int_ptr263
  %ivalue264 = alloca %union.UnionType
  %union_to_int_ptr265 = bitcast %union.UnionType* %ivalue264 to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr265
  %string266 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @7, i32 0, i32 0))
  %union_storage267 = alloca %union.UnionType
  %cast_to_double_ptr268511 = bitcast %union.UnionType* %union_storage267 to double*
  %cast_to_int_ptr269 = bitcast double* %cast_to_double_ptr268511 to i64*
  store i64 %string266, i64* %cast_to_int_ptr269
  %elems270 = alloca %union.UnionType*
  %load_elem271512 = bitcast %union.UnionType** %elems270 to %union.UnionType**
  store %union.UnionType* %union_storage267, %union.UnionType** %load_elem271512
  %fetched_object272 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr273 = bitcast %Object* %fetched_object272 to %ArrayObject*
  %array_type274513 = bitcast %ArrayObject* %cast_to_array_ptr273 to i32*
  %array_list275 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr273, i32 0, i32 1
  %array_size276 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr273, i32 0, i32 2
  store i32 3, i32* %array_type274513
  store %union.UnionType** %elems270, %union.UnionType*** %array_list275
  store i64 1, i64* %array_size276
  %base_ptr277 = alloca %union.UnionType
  %union_ptr_to_int278 = ptrtoint %ArrayObject* %cast_to_array_ptr273 to i64
  %or279 = or i64 %union_ptr_to_int278, -4503599627370496
  %or280 = or i64 %or279, 844424930131968
  %bitcast281 = bitcast %union.UnionType* %base_ptr277 to i64*
  store i64 %or280, i64* %bitcast281
  %bitcast282 = bitcast %union.UnionType* %base_ptr277 to i64*
  %load_ivalue283 = load i64* %bitcast282
  %xor284 = xor i64 %load_ivalue283, -3659174697238528
  %int_to_ptr285 = inttoptr i64 %xor284 to %ArrayObject*
  %hash286 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr285)
  %union_storage287 = alloca %union.UnionType
  %cast_to_double_ptr288514 = bitcast %union.UnionType* %union_storage287 to double*
  %cast_to_int_ptr289 = bitcast double* %cast_to_double_ptr288514 to i64*
  store i64 %hash286, i64* %cast_to_int_ptr289
  %fetched_object290 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr291 = bitcast %Object* %fetched_object290 to %HashRef*
  %hash_ref_type292515 = bitcast %HashRef* %cast_to_hash_ref_ptr291 to i32*
  %hash_ref_body293 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr291, i32 0, i32 1
  store i32 6, i32* %hash_ref_type292515
  %load_hash_body294 = load %union.UnionType* %union_storage287
  store %union.UnionType %load_hash_body294, %union.UnionType* %hash_ref_body293
  %base_ptr295 = alloca %union.UnionType
  %union_ptr_to_int296 = ptrtoint %HashRef* %cast_to_hash_ref_ptr291 to i64
  %or297 = or i64 %union_ptr_to_int296, -4503599627370496
  %or298 = or i64 %or297, 1688849860263936
  %bitcast299 = bitcast %union.UnionType* %base_ptr295 to i64*
  store i64 %or298, i64* %bitcast299
  %load_ivalue300 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor301 = xor i64 %load_ivalue300, -2814749767106560
  %int_to_ptr302 = inttoptr i64 %xor301 to %HashRef*
  %bitcast303 = bitcast %union.UnionType* %base_ptr295 to i64*
  %load_ivalue304 = load i64* %bitcast303
  %xor305 = xor i64 %load_ivalue304, -2814749767106560
  %int_to_ptr306 = inttoptr i64 %xor305 to %HashRef*
  %hashref_body307 = getelementptr inbounds %HashRef* %int_to_ptr306, i32 0, i32 1
  %bitcast308 = bitcast %union.UnionType* %hashref_body307 to i64*
  %load_ivalue309 = load i64* %bitcast308
  %xor310 = xor i64 %load_ivalue309, -3096224743817216
  %int_to_ptr311 = inttoptr i64 %xor310 to %HashObject*
  %keys312 = getelementptr inbounds %HashObject* %int_to_ptr311, i32 0, i32 2
  %load_keys313 = load i8*** %keys312
  %zero_at_keys314516 = bitcast i8** %load_keys313 to i8**
  %load_key315 = load i8** %zero_at_keys314516
  %bitcast316 = bitcast i8* %load_key315 to %StringObject*
  %HashRef_get317 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* @global_value, %StringObject* %bitcast316)
  %load_value318 = load %union.UnionType* %ivalue264
  store %union.UnionType %load_value318, %union.UnionType* %HashRef_get317
  %args319 = alloca %union.UnionType*
  %load_ivalue320 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor321 = xor i64 %load_ivalue320, -2814749767106560
  %int_to_ptr322 = inttoptr i64 %xor321 to %HashRef*
  %hashref_body323 = getelementptr inbounds %HashRef* %int_to_ptr322, i32 0, i32 1
  %get_idx324517 = bitcast %union.UnionType** %args319 to %union.UnionType**
  store %union.UnionType* %hashref_body323, %union.UnionType** %get_idx324517
  %array325 = alloca %ArrayObject
  %array_type326518 = bitcast %ArrayObject* %array325 to i32*
  %array_list327 = getelementptr inbounds %ArrayObject* %array325, i32 0, i32 1
  %array_size328 = getelementptr inbounds %ArrayObject* %array325, i32 0, i32 2
  store i32 3, i32* %array_type326518
  store %union.UnionType** %args319, %union.UnionType*** %array_list327
  store i64 1, i64* %array_size328
  %result329 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array325)
  %union_storage330 = alloca %union.UnionType
  %cast_to_double_ptr331519 = bitcast %union.UnionType* %union_storage330 to double*
  %cast_to_int_ptr332 = bitcast double* %cast_to_double_ptr331519 to i64*
  store i64 %result329, i64* %cast_to_int_ptr332
  %load_ivalue333 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor334 = xor i64 %load_ivalue333, -2814749767106560
  %int_to_ptr335 = inttoptr i64 %xor334 to %HashRef*
  %hashref_body336 = getelementptr inbounds %HashRef* %int_to_ptr335, i32 0, i32 1
  %bitcast337 = bitcast %union.UnionType* %hashref_body336 to i64*
  %load_ivalue338 = load i64* %bitcast337
  %xor339 = xor i64 %load_ivalue338, -3096224743817216
  %int_to_ptr340 = inttoptr i64 %xor339 to %HashObject*
  %hash_to_array = call i64 bitcast (i64 (%struct._Hash*)* @Hash_to_array to i64 (%HashObject*)*)(%HashObject* %int_to_ptr340)
  %union_storage341 = alloca %union.UnionType
  %cast_to_double_ptr342520 = bitcast %union.UnionType* %union_storage341 to double*
  %cast_to_int_ptr343 = bitcast double* %cast_to_double_ptr342520 to i64*
  store i64 %hash_to_array, i64* %cast_to_int_ptr343
  %load_value344 = load %union.UnionType* %union_storage341
  store %union.UnionType %load_value344, %union.UnionType* @global_value1
  %args345 = alloca %union.UnionType*
  %get_idx346521 = bitcast %union.UnionType** %args345 to %union.UnionType**
  store %union.UnionType* @global_value1, %union.UnionType** %get_idx346521
  %array347 = alloca %ArrayObject
  %array_type348522 = bitcast %ArrayObject* %array347 to i32*
  %array_list349 = getelementptr inbounds %ArrayObject* %array347, i32 0, i32 1
  %array_size350 = getelementptr inbounds %ArrayObject* %array347, i32 0, i32 2
  store i32 3, i32* %array_type348522
  store %union.UnionType** %args345, %union.UnionType*** %array_list349
  store i64 1, i64* %array_size350
  %result351 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array347)
  %union_storage352 = alloca %union.UnionType
  %cast_to_double_ptr353523 = bitcast %union.UnionType* %union_storage352 to double*
  %cast_to_int_ptr354 = bitcast double* %cast_to_double_ptr353523 to i64*
  store i64 %result351, i64* %cast_to_int_ptr354
  %args355 = alloca %union.UnionType*
  %string356 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @8, i32 0, i32 0))
  %union_storage357 = alloca %union.UnionType
  %cast_to_double_ptr358524 = bitcast %union.UnionType* %union_storage357 to double*
  %cast_to_int_ptr359 = bitcast double* %cast_to_double_ptr358524 to i64*
  store i64 %string356, i64* %cast_to_int_ptr359
  %elems360 = alloca %union.UnionType*
  %load_elem361525 = bitcast %union.UnionType** %elems360 to %union.UnionType**
  store %union.UnionType* %union_storage357, %union.UnionType** %load_elem361525
  %fetched_object362 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr363 = bitcast %Object* %fetched_object362 to %ArrayObject*
  %array_type364526 = bitcast %ArrayObject* %cast_to_array_ptr363 to i32*
  %array_list365 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr363, i32 0, i32 1
  %array_size366 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr363, i32 0, i32 2
  store i32 3, i32* %array_type364526
  store %union.UnionType** %elems360, %union.UnionType*** %array_list365
  store i64 1, i64* %array_size366
  %base_ptr367 = alloca %union.UnionType
  %union_ptr_to_int368 = ptrtoint %ArrayObject* %cast_to_array_ptr363 to i64
  %or369 = or i64 %union_ptr_to_int368, -4503599627370496
  %or370 = or i64 %or369, 844424930131968
  %bitcast371 = bitcast %union.UnionType* %base_ptr367 to i64*
  store i64 %or370, i64* %bitcast371
  %bitcast372 = bitcast %union.UnionType* %base_ptr367 to i64*
  %load_ivalue373 = load i64* %bitcast372
  %xor374 = xor i64 %load_ivalue373, -3659174697238528
  %int_to_ptr375 = inttoptr i64 %xor374 to %ArrayObject*
  %hash376 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr375)
  %union_storage377 = alloca %union.UnionType
  %cast_to_double_ptr378527 = bitcast %union.UnionType* %union_storage377 to double*
  %cast_to_int_ptr379 = bitcast double* %cast_to_double_ptr378527 to i64*
  store i64 %hash376, i64* %cast_to_int_ptr379
  %fetched_object380 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr381 = bitcast %Object* %fetched_object380 to %HashRef*
  %hash_ref_type382528 = bitcast %HashRef* %cast_to_hash_ref_ptr381 to i32*
  %hash_ref_body383 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr381, i32 0, i32 1
  store i32 6, i32* %hash_ref_type382528
  %load_hash_body384 = load %union.UnionType* %union_storage377
  store %union.UnionType %load_hash_body384, %union.UnionType* %hash_ref_body383
  %base_ptr385 = alloca %union.UnionType
  %union_ptr_to_int386 = ptrtoint %HashRef* %cast_to_hash_ref_ptr381 to i64
  %or387 = or i64 %union_ptr_to_int386, -4503599627370496
  %or388 = or i64 %or387, 1688849860263936
  %bitcast389 = bitcast %union.UnionType* %base_ptr385 to i64*
  store i64 %or388, i64* %bitcast389
  %load_ivalue390 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor391 = xor i64 %load_ivalue390, -2814749767106560
  %int_to_ptr392 = inttoptr i64 %xor391 to %HashRef*
  %bitcast393 = bitcast %union.UnionType* %base_ptr385 to i64*
  %load_ivalue394 = load i64* %bitcast393
  %xor395 = xor i64 %load_ivalue394, -2814749767106560
  %int_to_ptr396 = inttoptr i64 %xor395 to %HashRef*
  %hashref_body397 = getelementptr inbounds %HashRef* %int_to_ptr396, i32 0, i32 1
  %bitcast398 = bitcast %union.UnionType* %hashref_body397 to i64*
  %load_ivalue399 = load i64* %bitcast398
  %xor400 = xor i64 %load_ivalue399, -3096224743817216
  %int_to_ptr401 = inttoptr i64 %xor400 to %HashObject*
  %keys402 = getelementptr inbounds %HashObject* %int_to_ptr401, i32 0, i32 2
  %load_keys403 = load i8*** %keys402
  %zero_at_keys404529 = bitcast i8** %load_keys403 to i8**
  %load_key405 = load i8** %zero_at_keys404529
  %bitcast406 = bitcast i8* %load_key405 to %StringObject*
  %HashRef_get407 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* @global_value, %StringObject* %bitcast406)
  %string408 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @9, i32 0, i32 0))
  %union_storage409 = alloca %union.UnionType
  %cast_to_double_ptr410530 = bitcast %union.UnionType* %union_storage409 to double*
  %cast_to_int_ptr411 = bitcast double* %cast_to_double_ptr410530 to i64*
  store i64 %string408, i64* %cast_to_int_ptr411
  %elems412 = alloca %union.UnionType*
  %load_elem413531 = bitcast %union.UnionType** %elems412 to %union.UnionType**
  store %union.UnionType* %union_storage409, %union.UnionType** %load_elem413531
  %fetched_object414 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr415 = bitcast %Object* %fetched_object414 to %ArrayObject*
  %array_type416532 = bitcast %ArrayObject* %cast_to_array_ptr415 to i32*
  %array_list417 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr415, i32 0, i32 1
  %array_size418 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr415, i32 0, i32 2
  store i32 3, i32* %array_type416532
  store %union.UnionType** %elems412, %union.UnionType*** %array_list417
  store i64 1, i64* %array_size418
  %base_ptr419 = alloca %union.UnionType
  %union_ptr_to_int420 = ptrtoint %ArrayObject* %cast_to_array_ptr415 to i64
  %or421 = or i64 %union_ptr_to_int420, -4503599627370496
  %or422 = or i64 %or421, 844424930131968
  %bitcast423 = bitcast %union.UnionType* %base_ptr419 to i64*
  store i64 %or422, i64* %bitcast423
  %bitcast424 = bitcast %union.UnionType* %base_ptr419 to i64*
  %load_ivalue425 = load i64* %bitcast424
  %xor426 = xor i64 %load_ivalue425, -3659174697238528
  %int_to_ptr427 = inttoptr i64 %xor426 to %ArrayObject*
  %hash428 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr427)
  %union_storage429 = alloca %union.UnionType
  %cast_to_double_ptr430533 = bitcast %union.UnionType* %union_storage429 to double*
  %cast_to_int_ptr431 = bitcast double* %cast_to_double_ptr430533 to i64*
  store i64 %hash428, i64* %cast_to_int_ptr431
  %fetched_object432 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr433 = bitcast %Object* %fetched_object432 to %HashRef*
  %hash_ref_type434534 = bitcast %HashRef* %cast_to_hash_ref_ptr433 to i32*
  %hash_ref_body435 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr433, i32 0, i32 1
  store i32 6, i32* %hash_ref_type434534
  %load_hash_body436 = load %union.UnionType* %union_storage429
  store %union.UnionType %load_hash_body436, %union.UnionType* %hash_ref_body435
  %base_ptr437 = alloca %union.UnionType
  %union_ptr_to_int438 = ptrtoint %HashRef* %cast_to_hash_ref_ptr433 to i64
  %or439 = or i64 %union_ptr_to_int438, -4503599627370496
  %or440 = or i64 %or439, 1688849860263936
  %bitcast441 = bitcast %union.UnionType* %base_ptr437 to i64*
  store i64 %or440, i64* %bitcast441
  %bitcast442 = bitcast %union.UnionType* %base_ptr437 to i64*
  %load_ivalue443 = load i64* %bitcast442
  %xor444 = xor i64 %load_ivalue443, -2814749767106560
  %int_to_ptr445 = inttoptr i64 %xor444 to %HashRef*
  %hashref_body446 = getelementptr inbounds %HashRef* %int_to_ptr445, i32 0, i32 1
  %bitcast447 = bitcast %union.UnionType* %hashref_body446 to i64*
  %load_ivalue448 = load i64* %bitcast447
  %xor449 = xor i64 %load_ivalue448, -3096224743817216
  %int_to_ptr450 = inttoptr i64 %xor449 to %HashObject*
  %keys451 = getelementptr inbounds %HashObject* %int_to_ptr450, i32 0, i32 2
  %load_keys452 = load i8*** %keys451
  %zero_at_keys453535 = bitcast i8** %load_keys452 to i8**
  %load_key454 = load i8** %zero_at_keys453535
  %bitcast455 = bitcast i8* %load_key454 to %StringObject*
  %HashRef_get456 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* %HashRef_get407, %StringObject* %bitcast455)
  %get_idx457536 = bitcast %union.UnionType** %args355 to %union.UnionType**
  store %union.UnionType* %HashRef_get456, %union.UnionType** %get_idx457536
  %array458 = alloca %ArrayObject
  %array_type459537 = bitcast %ArrayObject* %array458 to i32*
  %array_list460 = getelementptr inbounds %ArrayObject* %array458, i32 0, i32 1
  %array_size461 = getelementptr inbounds %ArrayObject* %array458, i32 0, i32 2
  store i32 3, i32* %array_type459537
  store %union.UnionType** %args355, %union.UnionType*** %array_list460
  store i64 1, i64* %array_size461
  %result462 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array458)
  %union_storage463 = alloca %union.UnionType
  %cast_to_double_ptr464538 = bitcast %union.UnionType* %union_storage463 to double*
  %cast_to_int_ptr465 = bitcast double* %cast_to_double_ptr464538 to i64*
  store i64 %result462, i64* %cast_to_int_ptr465
  ret i64 0
}
