...
@global_value5 = common global %union.UnionType zeroinitializer, align 8
@global_value6 = common global %union.UnionType zeroinitializer, align 8
...
entrypoint:
  ...
  store i64 -4222124650659838, i64* %union_to_int_ptr2
  %ivalue3 = alloca %union.UnionType
  %union_to_int_ptr4 = bitcast %union.UnionType* %ivalue3 to i64*
  store i64 -4222124650659837, i64* %union_to_int_ptr4
  %elems = alloca %union.UnionType*, i64 3
  %load_elem169 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %ivalue, %union.UnionType** %load_elem169
  %load_elem5 = getelementptr %union.UnionType** %elems, i64 1
  store %union.UnionType* %ivalue1, %union.UnionType** %load_elem5
  %load_elem6 = getelementptr %union.UnionType** %elems, i64 2
  store %union.UnionType* %ivalue3, %union.UnionType** %load_elem6
  ...
  %array_type170 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  ...
  %or7 = or i64 %or, 844424930131968
  %bitcast = bitcast %union.UnionType* %base_ptr to i64*
  store i64 %or7, i64* %bitcast
  %"$a" = alloca %Object
  %base_ptr8 = alloca %union.UnionType
  %union_ptr_to_int9 = ptrtoint %Object* %"$a" to i64
  ...
  %load_value = load %union.UnionType* %base_ptr8
  store %union.UnionType %load_value, %union.UnionType* @global_value
  %"$b" = alloca %Object
  %base_ptr13 = alloca %union.UnionType
  %union_ptr_to_int14 = ptrtoint %Object* %"$b" to i64
  %or15 = or i64 %union_ptr_to_int14, -4503599627370496
  %or16 = or i64 %or15, 1970324836974592
  %bitcast17 = bitcast %union.UnionType* %base_ptr13 to i64*
  store i64 %or16, i64* %bitcast17
  %load_value18 = load %union.UnionType* %base_ptr13
  store %union.UnionType %load_value18, %union.UnionType* @global_value1
  %"$c" = alloca %Object
  %base_ptr19 = alloca %union.UnionType
  %union_ptr_to_int20 = ptrtoint %Object* %"$c" to i64
  %or21 = or i64 %union_ptr_to_int20, -4503599627370496
  %or22 = or i64 %or21, 1970324836974592
  %bitcast23 = bitcast %union.UnionType* %base_ptr19 to i64*
  store i64 %or22, i64* %bitcast23
  %load_value24 = load %union.UnionType* %base_ptr19
  store %union.UnionType %load_value24, %union.UnionType* @global_value2
  %bitcast25 = bitcast %union.UnionType* %base_ptr to i64*
  %load_ivalue = load i64* %bitcast25
  ...
  %Array_get26 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr, i64 1)
  %body27 = getelementptr inbounds %Object* %"$b", i32 0, i32 1
  %elem28 = load %union.UnionType* %Array_get26
  store %union.UnionType %elem28, %union.UnionType* %body27
  %Array_get29 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr, i64 2)
  %body30 = getelementptr inbounds %Object* %"$c", i32 0, i32 1
  %elem31 = load %union.UnionType* %Array_get29
  store %union.UnionType %elem31, %union.UnionType* %body30
  %args = alloca %union.UnionType*
  %load_ivalue32 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor33 = xor i64 %load_ivalue32, -2533274790395904
  %int_to_ptr34 = inttoptr i64 %xor33 to %Object*
  %object_body = getelementptr inbounds %Object* %int_to_ptr34, i32 0, i32 1
  %get_idx171 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body, %union.UnionType** %get_idx171
  %array = alloca %ArrayObject
  %array_type35172 = bitcast %ArrayObject* %array to i32*
  %array_list36 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 1
  %array_size37 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 2
  store i32 3, i32* %array_type35172
  store %union.UnionType** %args, %union.UnionType*** %array_list36
  ...
  %cast_to_double_ptr173 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr173 to i64*
  store i64 %result, i64* %cast_to_int_ptr
  %args38 = alloca %union.UnionType*
  %load_ivalue39 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor40 = xor i64 %load_ivalue39, -2533274790395904
  %int_to_ptr41 = inttoptr i64 %xor40 to %Object*
  %object_body42 = getelementptr inbounds %Object* %int_to_ptr41, i32 0, i32 1
  %get_idx43174 = bitcast %union.UnionType** %args38 to %union.UnionType**
  store %union.UnionType* %object_body42, %union.UnionType** %get_idx43174
  %array44 = alloca %ArrayObject
  %array_type45175 = bitcast %ArrayObject* %array44 to i32*
  %array_list46 = getelementptr inbounds %ArrayObject* %array44, i32 0, i32 1
  %array_size47 = getelementptr inbounds %ArrayObject* %array44, i32 0, i32 2
  store i32 3, i32* %array_type45175
  store %union.UnionType** %args38, %union.UnionType*** %array_list46
  store i64 1, i64* %array_size47
  %result48 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array44)
  %union_storage49 = alloca %union.UnionType
  %cast_to_double_ptr50176 = bitcast %union.UnionType* %union_storage49 to double*
  %cast_to_int_ptr51 = bitcast double* %cast_to_double_ptr50176 to i64*
  store i64 %result48, i64* %cast_to_int_ptr51
  %args52 = alloca %union.UnionType*
  %load_ivalue53 = load i64* bitcast (%union.UnionType* @global_value2 to i64*)
  ...
  %get_idx57177 = bitcast %union.UnionType** %args52 to %union.UnionType**
  store %union.UnionType* %object_body56, %union.UnionType** %get_idx57177
  %array58 = alloca %ArrayObject
  %array_type59178 = bitcast %ArrayObject* %array58 to i32*
  %array_list60 = getelementptr inbounds %ArrayObject* %array58, i32 0, i32 1
  %array_size61 = getelementptr inbounds %ArrayObject* %array58, i32 0, i32 2
  store i32 3, i32* %array_type59178
  store %union.UnionType** %args52, %union.UnionType*** %array_list60
  store i64 1, i64* %array_size61
  %result62 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array58)
  %union_storage63 = alloca %union.UnionType
  %cast_to_double_ptr64179 = bitcast %union.UnionType* %union_storage63 to double*
  %cast_to_int_ptr65 = bitcast double* %cast_to_double_ptr64179 to i64*
  store i64 %result62, i64* %cast_to_int_ptr65
  %ivalue66 = alloca %union.UnionType
  %union_to_int_ptr67 = bitcast %union.UnionType* %ivalue66 to i64*
  store i64 -4222124650659836, i64* %union_to_int_ptr67
  %ivalue68 = alloca %union.UnionType
  %union_to_int_ptr69 = bitcast %union.UnionType* %ivalue68 to i64*
  store i64 -4222124650659835, i64* %union_to_int_ptr69
  %ivalue70 = alloca %union.UnionType
  %union_to_int_ptr71 = bitcast %union.UnionType* %ivalue70 to i64*
  store i64 -4222124650659834, i64* %union_to_int_ptr71
  %elems72 = alloca %union.UnionType*, i64 3
  %load_elem73180 = bitcast %union.UnionType** %elems72 to %union.UnionType**
  store %union.UnionType* %ivalue66, %union.UnionType** %load_elem73180
  %load_elem74 = getelementptr %union.UnionType** %elems72, i64 1
  store %union.UnionType* %ivalue68, %union.UnionType** %load_elem74
  %load_elem75 = getelementptr %union.UnionType** %elems72, i64 2
  store %union.UnionType* %ivalue70, %union.UnionType** %load_elem75
  %fetched_object76 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr77 = bitcast %Object* %fetched_object76 to %ArrayObject*
  %array_type78181 = bitcast %ArrayObject* %cast_to_array_ptr77 to i32*
  %array_list79 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr77, i32 0, i32 1
  %array_size80 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr77, i32 0, i32 2
  store i32 3, i32* %array_type78181
  store %union.UnionType** %elems72, %union.UnionType*** %array_list79
  store i64 3, i64* %array_size80
  %base_ptr81 = alloca %union.UnionType
  %union_ptr_to_int82 = ptrtoint %ArrayObject* %cast_to_array_ptr77 to i64
  %or83 = or i64 %union_ptr_to_int82, -4503599627370496
  %or84 = or i64 %or83, 844424930131968
  %bitcast85 = bitcast %union.UnionType* %base_ptr81 to i64*
  store i64 %or84, i64* %bitcast85
  %load_value86 = load %union.UnionType* %base_ptr81
  store %union.UnionType %load_value86, %union.UnionType* @global_value3
  %args87 = alloca %union.UnionType*
  %get_idx88182 = bitcast %union.UnionType** %args87 to %union.UnionType**
  store %union.UnionType* @global_value3, %union.UnionType** %get_idx88182
  %array89 = alloca %ArrayObject
  %array_type90183 = bitcast %ArrayObject* %array89 to i32*
  %array_list91 = getelementptr inbounds %ArrayObject* %array89, i32 0, i32 1
  %array_size92 = getelementptr inbounds %ArrayObject* %array89, i32 0, i32 2
  store i32 3, i32* %array_type90183
  store %union.UnionType** %args87, %union.UnionType*** %array_list91
  store i64 1, i64* %array_size92
  %result93 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array89)
  %union_storage94 = alloca %union.UnionType
  %cast_to_double_ptr95184 = bitcast %union.UnionType* %union_storage94 to double*
  %cast_to_int_ptr96 = bitcast double* %cast_to_double_ptr95184 to i64*
  store i64 %result93, i64* %cast_to_int_ptr96
  %"$d" = alloca %Object
  %base_ptr97 = alloca %union.UnionType
  %union_ptr_to_int98 = ptrtoint %Object* %"$d" to i64
  %or99 = or i64 %union_ptr_to_int98, -4503599627370496
  %or100 = or i64 %or99, 1970324836974592
  %bitcast101 = bitcast %union.UnionType* %base_ptr97 to i64*
  store i64 %or100, i64* %bitcast101
  %load_value102 = load %union.UnionType* %base_ptr97
  store %union.UnionType %load_value102, %union.UnionType* @global_value4
  %"$e" = alloca %Object
  %base_ptr103 = alloca %union.UnionType
  %union_ptr_to_int104 = ptrtoint %Object* %"$e" to i64
  %or105 = or i64 %union_ptr_to_int104, -4503599627370496
  %or106 = or i64 %or105, 1970324836974592
  %bitcast107 = bitcast %union.UnionType* %base_ptr103 to i64*
  store i64 %or106, i64* %bitcast107
  %load_value108 = load %union.UnionType* %base_ptr103
  store %union.UnionType %load_value108, %union.UnionType* @global_value5
  %"$f" = alloca %Object
  %base_ptr109 = alloca %union.UnionType
  %union_ptr_to_int110 = ptrtoint %Object* %"$f" to i64
  %or111 = or i64 %union_ptr_to_int110, -4503599627370496
  %or112 = or i64 %or111, 1970324836974592
  %bitcast113 = bitcast %union.UnionType* %base_ptr109 to i64*
  store i64 %or112, i64* %bitcast113
  %load_value114 = load %union.UnionType* %base_ptr109
  store %union.UnionType %load_value114, %union.UnionType* @global_value6
  %load_ivalue115 = load i64* bitcast (%union.UnionType* @global_value3 to i64*)
  %xor116 = xor i64 %load_ivalue115, -3659174697238528
  %int_to_ptr117 = inttoptr i64 %xor116 to %ArrayObject*
  %Array_get118 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr117, i64 0)
  %body119 = getelementptr inbounds %Object* %"$d", i32 0, i32 1
  %elem120 = load %union.UnionType* %Array_get118
  store %union.UnionType %elem120, %union.UnionType* %body119
  %Array_get121 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr117, i64 1)
  %body122 = getelementptr inbounds %Object* %"$e", i32 0, i32 1
  %elem123 = load %union.UnionType* %Array_get121
  store %union.UnionType %elem123, %union.UnionType* %body122
  %Array_get124 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr117, i64 2)
  %body125 = getelementptr inbounds %Object* %"$f", i32 0, i32 1
  %elem126 = load %union.UnionType* %Array_get124
  store %union.UnionType %elem126, %union.UnionType* %body125
  %args127 = alloca %union.UnionType*
  %load_ivalue128 = load i64* bitcast (%union.UnionType* @global_value4 to i64*)
  %xor129 = xor i64 %load_ivalue128, -2533274790395904
  %int_to_ptr130 = inttoptr i64 %xor129 to %Object*
  %object_body131 = getelementptr inbounds %Object* %int_to_ptr130, i32 0, i32 1
  %get_idx132185 = bitcast %union.UnionType** %args127 to %union.UnionType**
  store %union.UnionType* %object_body131, %union.UnionType** %get_idx132185
  %array133 = alloca %ArrayObject
  %array_type134186 = bitcast %ArrayObject* %array133 to i32*
  %array_list135 = getelementptr inbounds %ArrayObject* %array133, i32 0, i32 1
  %array_size136 = getelementptr inbounds %ArrayObject* %array133, i32 0, i32 2
  store i32 3, i32* %array_type134186
  store %union.UnionType** %args127, %union.UnionType*** %array_list135
  store i64 1, i64* %array_size136
  %result137 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array133)
  %union_storage138 = alloca %union.UnionType
  %cast_to_double_ptr139187 = bitcast %union.UnionType* %union_storage138 to double*
  %cast_to_int_ptr140 = bitcast double* %cast_to_double_ptr139187 to i64*
  store i64 %result137, i64* %cast_to_int_ptr140
  %args141 = alloca %union.UnionType*
  %load_ivalue142 = load i64* bitcast (%union.UnionType* @global_value5 to i64*)
  %xor143 = xor i64 %load_ivalue142, -2533274790395904
  %int_to_ptr144 = inttoptr i64 %xor143 to %Object*
  %object_body145 = getelementptr inbounds %Object* %int_to_ptr144, i32 0, i32 1
  %get_idx146188 = bitcast %union.UnionType** %args141 to %union.UnionType**
  store %union.UnionType* %object_body145, %union.UnionType** %get_idx146188
  %array147 = alloca %ArrayObject
  %array_type148189 = bitcast %ArrayObject* %array147 to i32*
  %array_list149 = getelementptr inbounds %ArrayObject* %array147, i32 0, i32 1
  %array_size150 = getelementptr inbounds %ArrayObject* %array147, i32 0, i32 2
  store i32 3, i32* %array_type148189
  store %union.UnionType** %args141, %union.UnionType*** %array_list149
  store i64 1, i64* %array_size150
  %result151 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array147)
  %union_storage152 = alloca %union.UnionType
  %cast_to_double_ptr153190 = bitcast %union.UnionType* %union_storage152 to double*
  %cast_to_int_ptr154 = bitcast double* %cast_to_double_ptr153190 to i64*
  store i64 %result151, i64* %cast_to_int_ptr154
  %args155 = alloca %union.UnionType*
  %load_ivalue156 = load i64* bitcast (%union.UnionType* @global_value6 to i64*)
  %xor157 = xor i64 %load_ivalue156, -2533274790395904
  %int_to_ptr158 = inttoptr i64 %xor157 to %Object*
  %object_body159 = getelementptr inbounds %Object* %int_to_ptr158, i32 0, i32 1
  %get_idx160191 = bitcast %union.UnionType** %args155 to %union.UnionType**
  store %union.UnionType* %object_body159, %union.UnionType** %get_idx160191
  %array161 = alloca %ArrayObject
  %array_type162192 = bitcast %ArrayObject* %array161 to i32*
  %array_list163 = getelementptr inbounds %ArrayObject* %array161, i32 0, i32 1
  %array_size164 = getelementptr inbounds %ArrayObject* %array161, i32 0, i32 2
  store i32 3, i32* %array_type162192
  store %union.UnionType** %args155, %union.UnionType*** %array_list163
  store i64 1, i64* %array_size164
  %result165 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array161)
  %union_storage166 = alloca %union.UnionType
  %cast_to_double_ptr167193 = bitcast %union.UnionType* %union_storage166 to double*
  %cast_to_int_ptr168 = bitcast double* %cast_to_double_ptr167193 to i64*
  store i64 %result165, i64* %cast_to_int_ptr168
  ret i64 0
}
