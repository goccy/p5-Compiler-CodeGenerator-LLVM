...
define i64 @main(...) #7 {
entrypoint:
  %retval.i329 = alloca %union.UnionType, align 8
  %retval.i = alloca %union.UnionType, align 8
  ...
  %cast_to_double_ptr290 = bitcast %union.UnionType* %union_storage to double*
  %cast_to_int_ptr = bitcast double* %cast_to_double_ptr290 to i64*
  ...
  %cast_to_double_ptr5291 = bitcast %union.UnionType* %union_storage4 to double*
  %cast_to_int_ptr6 = bitcast double* %cast_to_double_ptr5291 to i64*
  store i64 %string, i64* %cast_to_int_ptr6
  %elems = alloca %union.UnionType*
  %load_elem292 = bitcast %union.UnionType** %elems to %union.UnionType**
  store %union.UnionType* %union_storage4, %union.UnionType** %load_elem292
  ...
  %array_type293 = bitcast %ArrayObject* %cast_to_array_ptr to i32*
  ...
  %bitcast12 = bitcast %union.UnionType* %base_ptr7 to i64*
  %load_ivalue13 = load i64* %bitcast12
  %xor14 = xor i64 %load_ivalue13, -3659174697238528
  %int_to_ptr15 = inttoptr i64 %xor14 to %ArrayObject*
  %hash = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr15)
  %union_storage16 = alloca %union.UnionType
  %cast_to_double_ptr17294 = bitcast %union.UnionType* %union_storage16 to double*
  %cast_to_int_ptr18 = bitcast double* %cast_to_double_ptr17294 to i64*
  store i64 %hash, i64* %cast_to_int_ptr18
  %fetched_object19 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr = bitcast %Object* %fetched_object19 to %HashRef*
  %hash_ref_type295 = bitcast %HashRef* %cast_to_hash_ref_ptr to i32*
  %hash_ref_body = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr, i32 0, i32 1
  store i32 6, i32* %hash_ref_type295
  %load_hash_body = load %union.UnionType* %union_storage16
  store %union.UnionType %load_hash_body, %union.UnionType* %hash_ref_body
  %base_ptr20 = alloca %union.UnionType
  %union_ptr_to_int21 = ptrtoint %HashRef* %cast_to_hash_ref_ptr to i64
  %or22 = or i64 %union_ptr_to_int21, -4503599627370496
  %or23 = or i64 %or22, 1688849860263936
  %bitcast24 = bitcast %union.UnionType* %base_ptr20 to i64*
  store i64 %or23, i64* %bitcast24
  %bitcast25 = bitcast %union.UnionType* %base_ptr20 to i64*
  %load_ivalue26 = load i64* %bitcast25
  %xor27 = xor i64 %load_ivalue26, -2814749767106560
  %int_to_ptr28 = inttoptr i64 %xor27 to %HashRef*
  %hashref_body = getelementptr inbounds %HashRef* %int_to_ptr28, i32 0, i32 1
  %bitcast29 = bitcast %union.UnionType* %hashref_body to i64*
  ...
  %keys = getelementptr inbounds %HashObject* %int_to_ptr32, i32 0, i32 2
  %load_keys = load i8*** %keys
  %zero_at_keys296 = bitcast i8** %load_keys to i8**
  %load_key = load i8** %zero_at_keys296
  %bitcast33 = bitcast i8* %load_key to %StringObject*
  %HashRef_get = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* %object_body3, %StringObject* %bitcast33)
  %string34 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @1, i32 0, i32 0))
  %union_storage35 = alloca %union.UnionType
  %cast_to_double_ptr36297 = bitcast %union.UnionType* %union_storage35 to double*
  %cast_to_int_ptr37 = bitcast double* %cast_to_double_ptr36297 to i64*
  store i64 %string34, i64* %cast_to_int_ptr37
  %elems38 = alloca %union.UnionType*
  %load_elem39298 = bitcast %union.UnionType** %elems38 to %union.UnionType**
  store %union.UnionType* %union_storage35, %union.UnionType** %load_elem39298
  %fetched_object40 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr41 = bitcast %Object* %fetched_object40 to %ArrayObject*
  %array_type42299 = bitcast %ArrayObject* %cast_to_array_ptr41 to i32*
  %array_list43 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr41, i32 0, i32 1
  %array_size44 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr41, i32 0, i32 2
  store i32 3, i32* %array_type42299
  store %union.UnionType** %elems38, %union.UnionType*** %array_list43
  store i64 1, i64* %array_size44
  %base_ptr45 = alloca %union.UnionType
  %union_ptr_to_int46 = ptrtoint %ArrayObject* %cast_to_array_ptr41 to i64
  %or47 = or i64 %union_ptr_to_int46, -4503599627370496
  %or48 = or i64 %or47, 844424930131968
  %bitcast49 = bitcast %union.UnionType* %base_ptr45 to i64*
  store i64 %or48, i64* %bitcast49
  %bitcast50 = bitcast %union.UnionType* %base_ptr45 to i64*
  %load_ivalue51 = load i64* %bitcast50
  %xor52 = xor i64 %load_ivalue51, -3659174697238528
  %int_to_ptr53 = inttoptr i64 %xor52 to %ArrayObject*
  %hash54 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr53)
  %union_storage55 = alloca %union.UnionType
  %cast_to_double_ptr56300 = bitcast %union.UnionType* %union_storage55 to double*
  %cast_to_int_ptr57 = bitcast double* %cast_to_double_ptr56300 to i64*
  store i64 %hash54, i64* %cast_to_int_ptr57
  %fetched_object58 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr59 = bitcast %Object* %fetched_object58 to %HashRef*
  %hash_ref_type60301 = bitcast %HashRef* %cast_to_hash_ref_ptr59 to i32*
  %hash_ref_body61 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr59, i32 0, i32 1
  store i32 6, i32* %hash_ref_type60301
  %load_hash_body62 = load %union.UnionType* %union_storage55
  store %union.UnionType %load_hash_body62, %union.UnionType* %hash_ref_body61
  %base_ptr63 = alloca %union.UnionType
  %union_ptr_to_int64 = ptrtoint %HashRef* %cast_to_hash_ref_ptr59 to i64
  %or65 = or i64 %union_ptr_to_int64, -4503599627370496
  %or66 = or i64 %or65, 1688849860263936
  %bitcast67 = bitcast %union.UnionType* %base_ptr63 to i64*
  store i64 %or66, i64* %bitcast67
  %bitcast68 = bitcast %union.UnionType* %base_ptr63 to i64*
  %load_ivalue69 = load i64* %bitcast68
  %xor70 = xor i64 %load_ivalue69, -2814749767106560
  %int_to_ptr71 = inttoptr i64 %xor70 to %HashRef*
  %hashref_body72 = getelementptr inbounds %HashRef* %int_to_ptr71, i32 0, i32 1
  %bitcast73 = bitcast %union.UnionType* %hashref_body72 to i64*
  %load_ivalue74 = load i64* %bitcast73
  %xor75 = xor i64 %load_ivalue74, -3096224743817216
  %int_to_ptr76 = inttoptr i64 %xor75 to %HashObject*
  %keys77 = getelementptr inbounds %HashObject* %int_to_ptr76, i32 0, i32 2
  %load_keys78 = load i8*** %keys77
  %zero_at_keys79302 = bitcast i8** %load_keys78 to i8**
  %load_key80 = load i8** %zero_at_keys79302
  %bitcast81 = bitcast i8* %load_key80 to %StringObject*
  %HashRef_get82 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* %HashRef_get, %StringObject* %bitcast81)
  %string83 = call i64 @new_String(i8* getelementptr inbounds ([2 x i8]* @2, i32 0, i32 0))
  %union_storage84 = alloca %union.UnionType
  %cast_to_double_ptr85303 = bitcast %union.UnionType* %union_storage84 to double*
  %cast_to_int_ptr86 = bitcast double* %cast_to_double_ptr85303 to i64*
  store i64 %string83, i64* %cast_to_int_ptr86
  %elems87 = alloca %union.UnionType*
  %load_elem88304 = bitcast %union.UnionType** %elems87 to %union.UnionType**
  store %union.UnionType* %union_storage84, %union.UnionType** %load_elem88304
  %fetched_object89 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr90 = bitcast %Object* %fetched_object89 to %ArrayObject*
  %array_type91305 = bitcast %ArrayObject* %cast_to_array_ptr90 to i32*
  %array_list92 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr90, i32 0, i32 1
  %array_size93 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr90, i32 0, i32 2
  store i32 3, i32* %array_type91305
  store %union.UnionType** %elems87, %union.UnionType*** %array_list92
  store i64 1, i64* %array_size93
  %base_ptr94 = alloca %union.UnionType
  %union_ptr_to_int95 = ptrtoint %ArrayObject* %cast_to_array_ptr90 to i64
  %or96 = or i64 %union_ptr_to_int95, -4503599627370496
  %or97 = or i64 %or96, 844424930131968
  %bitcast98 = bitcast %union.UnionType* %base_ptr94 to i64*
  store i64 %or97, i64* %bitcast98
  %bitcast99 = bitcast %union.UnionType* %base_ptr94 to i64*
  %load_ivalue100 = load i64* %bitcast99
  %xor101 = xor i64 %load_ivalue100, -3659174697238528
  %int_to_ptr102 = inttoptr i64 %xor101 to %ArrayObject*
  %hash103 = call i64 bitcast (i64 (%struct._Array*)* @new_Hash to i64 (%ArrayObject*)*)(%ArrayObject* %int_to_ptr102)
  %union_storage104 = alloca %union.UnionType
  %cast_to_double_ptr105306 = bitcast %union.UnionType* %union_storage104 to double*
  %cast_to_int_ptr106 = bitcast double* %cast_to_double_ptr105306 to i64*
  store i64 %hash103, i64* %cast_to_int_ptr106
  %fetched_object107 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_hash_ref_ptr108 = bitcast %Object* %fetched_object107 to %HashRef*
  %hash_ref_type109307 = bitcast %HashRef* %cast_to_hash_ref_ptr108 to i32*
  %hash_ref_body110 = getelementptr inbounds %HashRef* %cast_to_hash_ref_ptr108, i32 0, i32 1
  store i32 6, i32* %hash_ref_type109307
  %load_hash_body111 = load %union.UnionType* %union_storage104
  store %union.UnionType %load_hash_body111, %union.UnionType* %hash_ref_body110
  %base_ptr112 = alloca %union.UnionType
  %union_ptr_to_int113 = ptrtoint %HashRef* %cast_to_hash_ref_ptr108 to i64
  %or114 = or i64 %union_ptr_to_int113, -4503599627370496
  %or115 = or i64 %or114, 1688849860263936
  %bitcast116 = bitcast %union.UnionType* %base_ptr112 to i64*
  store i64 %or115, i64* %bitcast116
  %bitcast117 = bitcast %union.UnionType* %base_ptr112 to i64*
  %load_ivalue118 = load i64* %bitcast117
  %xor119 = xor i64 %load_ivalue118, -2814749767106560
  %int_to_ptr120 = inttoptr i64 %xor119 to %HashRef*
  %hashref_body121 = getelementptr inbounds %HashRef* %int_to_ptr120, i32 0, i32 1
  %bitcast122 = bitcast %union.UnionType* %hashref_body121 to i64*
  %load_ivalue123 = load i64* %bitcast122
  %xor124 = xor i64 %load_ivalue123, -3096224743817216
  %int_to_ptr125 = inttoptr i64 %xor124 to %HashObject*
  %keys126 = getelementptr inbounds %HashObject* %int_to_ptr125, i32 0, i32 2
  %load_keys127 = load i8*** %keys126
  %zero_at_keys128308 = bitcast i8** %load_keys127 to i8**
  %load_key129 = load i8** %zero_at_keys128308
  %bitcast130 = bitcast i8* %load_key129 to %StringObject*
  %HashRef_get131 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, %struct._String*)* @HashRef_get to %union.UnionType* (%union.UnionType*, %StringObject*)*)(%union.UnionType* %HashRef_get82, %StringObject* %bitcast130)
  %args = alloca %union.UnionType*
  %load_ivalue132 = load i64* bitcast (%union.UnionType* @global_value to i64*)
  %xor133 = xor i64 %load_ivalue132, -2533274790395904
  %int_to_ptr134 = inttoptr i64 %xor133 to %Object*
  %object_body135 = getelementptr inbounds %Object* %int_to_ptr134, i32 0, i32 1
  %get_idx309 = bitcast %union.UnionType** %args to %union.UnionType**
  store %union.UnionType* %object_body135, %union.UnionType** %get_idx309
  %array = alloca %ArrayObject
  %array_type136310 = bitcast %ArrayObject* %array to i32*
  %array_list137 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 1
  %array_size138 = getelementptr inbounds %ArrayObject* %array, i32 0, i32 2
  store i32 3, i32* %array_type136310
  store %union.UnionType** %args, %union.UnionType*** %array_list137
  store i64 1, i64* %array_size138
  ...
  %cast_to_double_ptr140311 = bitcast %union.UnionType* %union_storage139 to double*
  %cast_to_int_ptr141 = bitcast double* %cast_to_double_ptr140311 to i64*
  store i64 %result, i64* %cast_to_int_ptr141
  %args142 = alloca %union.UnionType*
  %string143 = call i64 @new_String(i8* getelementptr inbounds ([1 x i8]* @3, i32 0, i32 0))
  %union_storage144 = alloca %union.UnionType
  %cast_to_double_ptr145312 = bitcast %union.UnionType* %union_storage144 to double*
  %cast_to_int_ptr146 = bitcast double* %cast_to_double_ptr145312 to i64*
  store i64 %string143, i64* %cast_to_int_ptr146
  %get_idx147313 = bitcast %union.UnionType** %args142 to %union.UnionType**
  store %union.UnionType* %union_storage144, %union.UnionType** %get_idx147313
  %array148 = alloca %ArrayObject
  %array_type149314 = bitcast %ArrayObject* %array148 to i32*
  %array_list150 = getelementptr inbounds %ArrayObject* %array148, i32 0, i32 1
  %array_size151 = getelementptr inbounds %ArrayObject* %array148, i32 0, i32 2
  store i32 3, i32* %array_type149314
  store %union.UnionType** %args142, %union.UnionType*** %array_list150
  store i64 1, i64* %array_size151
  %result152 = call i64 bitcast (i64 (%struct._Array*)* @say to i64 (%ArrayObject*)*)(%ArrayObject* %array148)
  %union_storage153 = alloca %union.UnionType
  %cast_to_double_ptr154315 = bitcast %union.UnionType* %union_storage153 to double*
  %cast_to_int_ptr155 = bitcast double* %cast_to_double_ptr154315 to i64*
  store i64 %result152, i64* %cast_to_int_ptr155
  %5 = bitcast %union.UnionType* %retval.i329 to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %5) #3
  %6 = bitcast %union.UnionType* %retval.i329 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* bitcast (%union.UnionType* @undef to i8*), i64 8, i32 8, i1 false) #3
  %coerce.dive1.i330 = bitcast %union.UnionType* %retval.i329 to double*
  %7 = bitcast double* %coerce.dive1.i330 to i64*
  %8 = load i64* %7, align 1
  %9 = bitcast %union.UnionType* %retval.i329 to i8*
  call void @llvm.lifetime.end(i64 -1, i8* %9) #3
  %union_storage156 = alloca %union.UnionType
  %cast_to_double_ptr157316 = bitcast %union.UnionType* %union_storage156 to double*
  %cast_to_int_ptr158 = bitcast double* %cast_to_double_ptr157316 to i64*
  store i64 %8, i64* %cast_to_int_ptr158
  %"$b" = alloca %Object
  %object_body159 = getelementptr inbounds %Object* %"$b", i32 0, i32 1
  %load_value160 = load %union.UnionType* %union_storage156
  store %union.UnionType %load_value160, %union.UnionType* %object_body159
  %base_ptr161 = alloca %union.UnionType
  %union_ptr_to_int162 = ptrtoint %Object* %"$b" to i64
  %or163 = or i64 %union_ptr_to_int162, -4503599627370496
  %or164 = or i64 %or163, 1970324836974592
  %bitcast165 = bitcast %union.UnionType* %base_ptr161 to i64*
  store i64 %or164, i64* %bitcast165
  %load_value166 = load %union.UnionType* %base_ptr161
  store %union.UnionType %load_value166, %union.UnionType* @global_value1
  %load_ivalue167 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  %xor168 = xor i64 %load_ivalue167, -2533274790395904
  %int_to_ptr169 = inttoptr i64 %xor168 to %Object*
  %object_body170 = getelementptr inbounds %Object* %int_to_ptr169, i32 0, i32 1
  ...
  %elems171 = alloca %union.UnionType*
  %load_elem172317 = bitcast %union.UnionType** %elems171 to %union.UnionType**
  store %union.UnionType* %ivalue, %union.UnionType** %load_elem172317
  %fetched_object173 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr174 = bitcast %Object* %fetched_object173 to %ArrayObject*
  %array_type175318 = bitcast %ArrayObject* %cast_to_array_ptr174 to i32*
  %array_list176 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr174, i32 0, i32 1
  %array_size177 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr174, i32 0, i32 2
  store i32 3, i32* %array_type175318
  store %union.UnionType** %elems171, %union.UnionType*** %array_list176
  store i64 1, i64* %array_size177
  %base_ptr178 = alloca %union.UnionType
  %union_ptr_to_int179 = ptrtoint %ArrayObject* %cast_to_array_ptr174 to i64
  %or180 = or i64 %union_ptr_to_int179, -4503599627370496
  %or181 = or i64 %or180, 844424930131968
  %bitcast182 = bitcast %union.UnionType* %base_ptr178 to i64*
  store i64 %or181, i64* %bitcast182
  %fetched_object183 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr = bitcast %Object* %fetched_object183 to %ArrayRef*
  %array_ref_type319 = bitcast %ArrayRef* %cast_to_array_ref_ptr to i32*
  %array_ref_body = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr, i32 0, i32 1
  store i32 4, i32* %array_ref_type319
  %load_array_body = load %union.UnionType* %base_ptr178
  store %union.UnionType %load_array_body, %union.UnionType* %array_ref_body
  %base_ptr184 = alloca %union.UnionType
  %union_ptr_to_int185 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr to i64
  %or186 = or i64 %union_ptr_to_int185, -4503599627370496
  %or187 = or i64 %or186, 1125899906842624
  %bitcast188 = bitcast %union.UnionType* %base_ptr184 to i64*
  store i64 %or187, i64* %bitcast188
  %bitcast189 = bitcast %union.UnionType* %base_ptr184 to i64*
  %load_ivalue190 = load i64* %bitcast189
  %xor191 = xor i64 %load_ivalue190, -3377699720527872
  %int_to_ptr192 = inttoptr i64 %xor191 to %ArrayRef*
  %arrayref_body = getelementptr inbounds %ArrayRef* %int_to_ptr192, i32 0, i32 1
  %bitcast193 = bitcast %union.UnionType* %arrayref_body to i64*
  %load_ivalue194 = load i64* %bitcast193
  %xor195 = xor i64 %load_ivalue194, -3659174697238528
  %int_to_ptr196 = inttoptr i64 %xor195 to %ArrayObject*
  %Array_get = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr196, i64 0)
  %union_to_int_ptr197 = bitcast %union.UnionType* %Array_get to i64*
  %dereference = load i64* %union_to_int_ptr197
  %trunc_int_cast = trunc i64 %dereference to i32
  %i32_to_i64_cast = sext i32 %trunc_int_cast to i64
  %ArrayRef_get = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* %object_body170, i64 %i32_to_i64_cast)
  %ivalue198 = alloca %union.UnionType
  %union_to_int_ptr199 = bitcast %union.UnionType* %ivalue198 to i64*
  store i64 -4222124650659839, i64* %union_to_int_ptr199
  %elems200 = alloca %union.UnionType*
  %load_elem201320 = bitcast %union.UnionType** %elems200 to %union.UnionType**
  store %union.UnionType* %ivalue198, %union.UnionType** %load_elem201320
  %fetched_object202 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr203 = bitcast %Object* %fetched_object202 to %ArrayObject*
  %array_type204321 = bitcast %ArrayObject* %cast_to_array_ptr203 to i32*
  %array_list205 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr203, i32 0, i32 1
  %array_size206 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr203, i32 0, i32 2
  store i32 3, i32* %array_type204321
  store %union.UnionType** %elems200, %union.UnionType*** %array_list205
  store i64 1, i64* %array_size206
  %base_ptr207 = alloca %union.UnionType
  %union_ptr_to_int208 = ptrtoint %ArrayObject* %cast_to_array_ptr203 to i64
  %or209 = or i64 %union_ptr_to_int208, -4503599627370496
  %or210 = or i64 %or209, 844424930131968
  %bitcast211 = bitcast %union.UnionType* %base_ptr207 to i64*
  store i64 %or210, i64* %bitcast211
  %fetched_object212 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr213 = bitcast %Object* %fetched_object212 to %ArrayRef*
  %array_ref_type214322 = bitcast %ArrayRef* %cast_to_array_ref_ptr213 to i32*
  %array_ref_body215 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr213, i32 0, i32 1
  store i32 4, i32* %array_ref_type214322
  %load_array_body216 = load %union.UnionType* %base_ptr207
  store %union.UnionType %load_array_body216, %union.UnionType* %array_ref_body215
  %base_ptr217 = alloca %union.UnionType
  %union_ptr_to_int218 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr213 to i64
  %or219 = or i64 %union_ptr_to_int218, -4503599627370496
  %or220 = or i64 %or219, 1125899906842624
  %bitcast221 = bitcast %union.UnionType* %base_ptr217 to i64*
  store i64 %or220, i64* %bitcast221
  %bitcast222 = bitcast %union.UnionType* %base_ptr217 to i64*
  %load_ivalue223 = load i64* %bitcast222
  %xor224 = xor i64 %load_ivalue223, -3377699720527872
  %int_to_ptr225 = inttoptr i64 %xor224 to %ArrayRef*
  %arrayref_body226 = getelementptr inbounds %ArrayRef* %int_to_ptr225, i32 0, i32 1
  %bitcast227 = bitcast %union.UnionType* %arrayref_body226 to i64*
  %load_ivalue228 = load i64* %bitcast227
  %xor229 = xor i64 %load_ivalue228, -3659174697238528
  %int_to_ptr230 = inttoptr i64 %xor229 to %ArrayObject*
  %Array_get231 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr230, i64 0)
  %union_to_int_ptr232 = bitcast %union.UnionType* %Array_get231 to i64*
  %dereference233 = load i64* %union_to_int_ptr232
  %trunc_int_cast234 = trunc i64 %dereference233 to i32
  %i32_to_i64_cast235 = sext i32 %trunc_int_cast234 to i64
  %ArrayRef_get236 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* %ArrayRef_get, i64 %i32_to_i64_cast235)
  %ivalue237 = alloca %union.UnionType
  %union_to_int_ptr238 = bitcast %union.UnionType* %ivalue237 to i64*
  store i64 -4222124650659838, i64* %union_to_int_ptr238
  %elems239 = alloca %union.UnionType*
  %load_elem240323 = bitcast %union.UnionType** %elems239 to %union.UnionType**
  store %union.UnionType* %ivalue237, %union.UnionType** %load_elem240323
  %fetched_object241 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ptr242 = bitcast %Object* %fetched_object241 to %ArrayObject*
  %array_type243324 = bitcast %ArrayObject* %cast_to_array_ptr242 to i32*
  %array_list244 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr242, i32 0, i32 1
  %array_size245 = getelementptr inbounds %ArrayObject* %cast_to_array_ptr242, i32 0, i32 2
  store i32 3, i32* %array_type243324
  store %union.UnionType** %elems239, %union.UnionType*** %array_list244
  store i64 1, i64* %array_size245
  %base_ptr246 = alloca %union.UnionType
  %union_ptr_to_int247 = ptrtoint %ArrayObject* %cast_to_array_ptr242 to i64
  %or248 = or i64 %union_ptr_to_int247, -4503599627370496
  %or249 = or i64 %or248, 844424930131968
  %bitcast250 = bitcast %union.UnionType* %base_ptr246 to i64*
  store i64 %or249, i64* %bitcast250
  %fetched_object251 = call %Object* bitcast (%struct._Object* ()* @fetch_object to %Object* ()*)()
  %cast_to_array_ref_ptr252 = bitcast %Object* %fetched_object251 to %ArrayRef*
  %array_ref_type253325 = bitcast %ArrayRef* %cast_to_array_ref_ptr252 to i32*
  %array_ref_body254 = getelementptr inbounds %ArrayRef* %cast_to_array_ref_ptr252, i32 0, i32 1
  store i32 4, i32* %array_ref_type253325
  %load_array_body255 = load %union.UnionType* %base_ptr246
  store %union.UnionType %load_array_body255, %union.UnionType* %array_ref_body254
  %base_ptr256 = alloca %union.UnionType
  %union_ptr_to_int257 = ptrtoint %ArrayRef* %cast_to_array_ref_ptr252 to i64
  %or258 = or i64 %union_ptr_to_int257, -4503599627370496
  %or259 = or i64 %or258, 1125899906842624
  %bitcast260 = bitcast %union.UnionType* %base_ptr256 to i64*
  store i64 %or259, i64* %bitcast260
  %bitcast261 = bitcast %union.UnionType* %base_ptr256 to i64*
  %load_ivalue262 = load i64* %bitcast261
  %xor263 = xor i64 %load_ivalue262, -3377699720527872
  %int_to_ptr264 = inttoptr i64 %xor263 to %ArrayRef*
  %arrayref_body265 = getelementptr inbounds %ArrayRef* %int_to_ptr264, i32 0, i32 1
  %bitcast266 = bitcast %union.UnionType* %arrayref_body265 to i64*
  %load_ivalue267 = load i64* %bitcast266
  %xor268 = xor i64 %load_ivalue267, -3659174697238528
  %int_to_ptr269 = inttoptr i64 %xor268 to %ArrayObject*
  %Array_get270 = call %union.UnionType* bitcast (%union.UnionType* (%struct._Array*, i32)* @Array_get to %union.UnionType* (%ArrayObject*, i64)*)(%ArrayObject* %int_to_ptr269, i64 0)
  %union_to_int_ptr271 = bitcast %union.UnionType* %Array_get270 to i64*
  %dereference272 = load i64* %union_to_int_ptr271
  %trunc_int_cast273 = trunc i64 %dereference272 to i32
  %i32_to_i64_cast274 = sext i32 %trunc_int_cast273 to i64
  %ArrayRef_get275 = call %union.UnionType* bitcast (%union.UnionType* (%union.UnionType*, i32)* @ArrayRef_get to %union.UnionType* (%union.UnionType*, i64)*)(%union.UnionType* %ArrayRef_get236, i64 %i32_to_i64_cast274)
  %args276 = alloca %union.UnionType*
  %load_ivalue277 = load i64* bitcast (%union.UnionType* @global_value1 to i64*)
  ...
  %get_idx281326 = bitcast %union.UnionType** %args276 to %union.UnionType**
  store %union.UnionType* %object_body280, %union.UnionType** %get_idx281326
  %array282 = alloca %ArrayObject
  %array_type283327 = bitcast %ArrayObject* %array282 to i32*
  ...
  store i32 3, i32* %array_type283327
  store %union.UnionType** %args276, %union.UnionType*** %array_list284
  store i64 1, i64* %array_size285
  %result286 = call i64 bitcast (i64 (%struct._Array*)* @Object_dumper to i64 (%ArrayObject*)*)(%ArrayObject* %array282)
  %union_storage287 = alloca %union.UnionType
  %cast_to_double_ptr288328 = bitcast %union.UnionType* %union_storage287 to double*
  %cast_to_int_ptr289 = bitcast double* %cast_to_double_ptr288328 to i64*
